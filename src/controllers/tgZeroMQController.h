...
#ifndef SRC_CONTROLLERS_TG_ZEROMQ_CONTROLLER_H
#define SRC_CONTROLLERS_TG_ZEROMQ_CONTROLLER_H

/**
 * @file tgZeroMQController.h
 * @brief Definition of the tgZeroMQController base class
 ...
 * tgBasicActuators.
 */
class tgZeroMQController : public tgBasicController
{
public:
	 ...
	 */
    tgZeroMQController(tgBasicActuator* controllable, double setPoint = 0.0);

    /**
     * The destructor. Sets m_controllable to NULL.
     */
    virtual ~tgZeroMQController();
