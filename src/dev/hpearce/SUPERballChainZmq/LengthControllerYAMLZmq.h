...
#ifndef HORIZONTAL_SPINE_CONTROLLER_ZMQ_H
#define HORIZONTAL_SPINE_CONTROLLER_ZMQ_H

/**
 * @file LengthControllerYAMLZmq.h
 * @brief Contains the definition of class LengthControllerYAMLZmq
 ...
 */
class LengthControllerYAMLZmq : public tgObserver<TensegrityModel>, public tgSubject<LengthControllerYAMLZmq>
{
public:
   ...
   */
  virtual ~LengthControllerYAMLZmq() { }
