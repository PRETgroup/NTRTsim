...
void Connection6Synapse74Run(Connection6Synapse74* me) {
    ...
    enum Connection6Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE74_L: // Intra-location logic for state l
