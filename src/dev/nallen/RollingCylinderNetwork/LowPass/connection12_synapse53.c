...
void Connection12Synapse53Run(Connection12Synapse53* me) {
    ...
    enum Connection12Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE53_L: // Intra-location logic for state l
