...
void Connection1Synapse28Run(Connection1Synapse28* me) {
    ...
    enum Connection1Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE28_L: // Intra-location logic for state l
