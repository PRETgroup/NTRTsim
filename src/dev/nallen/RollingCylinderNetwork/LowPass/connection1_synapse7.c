...
void Connection1Synapse7Run(Connection1Synapse7* me) {
    ...
    enum Connection1Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE7_L: // Intra-location logic for state l
