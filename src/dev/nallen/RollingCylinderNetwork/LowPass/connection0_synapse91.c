...
void Connection0Synapse91Run(Connection0Synapse91* me) {
    ...
    enum Connection0Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE91_L: // Intra-location logic for state l
