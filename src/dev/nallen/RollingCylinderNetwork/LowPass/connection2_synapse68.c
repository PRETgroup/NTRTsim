...
void Connection2Synapse68Run(Connection2Synapse68* me) {
    ...
    enum Connection2Synapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE68_L: // Intra-location logic for state l
