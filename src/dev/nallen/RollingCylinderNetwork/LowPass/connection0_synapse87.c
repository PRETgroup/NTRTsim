...
void Connection0Synapse87Run(Connection0Synapse87* me) {
    ...
    enum Connection0Synapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE87_L: // Intra-location logic for state l
