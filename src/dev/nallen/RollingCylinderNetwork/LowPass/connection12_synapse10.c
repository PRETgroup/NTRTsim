...
void Connection12Synapse10Run(Connection12Synapse10* me) {
    ...
    enum Connection12Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE10_L: // Intra-location logic for state l
