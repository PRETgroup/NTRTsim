...
void Connection2Synapse88Run(Connection2Synapse88* me) {
    ...
    enum Connection2Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE88_L: // Intra-location logic for state l
