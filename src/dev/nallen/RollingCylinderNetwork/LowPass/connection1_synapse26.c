...
void Connection1Synapse26Run(Connection1Synapse26* me) {
    ...
    enum Connection1Synapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE26_L: // Intra-location logic for state l
