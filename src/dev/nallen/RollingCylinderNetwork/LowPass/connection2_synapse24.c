...
void Connection2Synapse24Run(Connection2Synapse24* me) {
    ...
    enum Connection2Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE24_L: // Intra-location logic for state l
