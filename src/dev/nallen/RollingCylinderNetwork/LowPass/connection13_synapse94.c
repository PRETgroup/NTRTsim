...
void Connection13Synapse94Run(Connection13Synapse94* me) {
    ...
    enum Connection13Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE94_L: // Intra-location logic for state l
