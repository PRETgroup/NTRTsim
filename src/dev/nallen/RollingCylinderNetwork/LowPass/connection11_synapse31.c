...
void Connection11Synapse31Run(Connection11Synapse31* me) {
    ...
    enum Connection11Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE31_L: // Intra-location logic for state l
