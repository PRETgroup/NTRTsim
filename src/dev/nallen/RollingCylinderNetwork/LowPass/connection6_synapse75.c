...
void Connection6Synapse75Run(Connection6Synapse75* me) {
    ...
    enum Connection6Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE75_L: // Intra-location logic for state l
