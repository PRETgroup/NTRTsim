...
void Connection14Synapse93Run(Connection14Synapse93* me) {
    ...
    enum Connection14Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE93_L: // Intra-location logic for state l
