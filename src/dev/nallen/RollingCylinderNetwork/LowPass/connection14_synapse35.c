...
void Connection14Synapse35Run(Connection14Synapse35* me) {
    ...
    enum Connection14Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE35_L: // Intra-location logic for state l
