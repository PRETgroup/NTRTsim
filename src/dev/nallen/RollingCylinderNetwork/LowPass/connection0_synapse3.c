...
void Connection0Synapse3Run(Connection0Synapse3* me) {
    ...
    enum Connection0Synapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE3_L: // Intra-location logic for state l
