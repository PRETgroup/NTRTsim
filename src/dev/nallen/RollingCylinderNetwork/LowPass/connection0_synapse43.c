...
void Connection0Synapse43Run(Connection0Synapse43* me) {
    ...
    enum Connection0Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE43_L: // Intra-location logic for state l
