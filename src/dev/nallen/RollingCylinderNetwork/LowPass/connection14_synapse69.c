...
void Connection14Synapse69Run(Connection14Synapse69* me) {
    ...
    enum Connection14Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE69_L: // Intra-location logic for state l
