...
void Connection6Synapse94Run(Connection6Synapse94* me) {
    ...
    enum Connection6Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE94_L: // Intra-location logic for state l
