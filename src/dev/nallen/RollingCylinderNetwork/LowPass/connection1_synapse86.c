...
void Connection1Synapse86Run(Connection1Synapse86* me) {
    ...
    enum Connection1Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE86_L: // Intra-location logic for state l
