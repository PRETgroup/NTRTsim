...
void Connection2Synapse20Run(Connection2Synapse20* me) {
    ...
    enum Connection2Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE20_L: // Intra-location logic for state l
