...
void Connection11Synapse88Run(Connection11Synapse88* me) {
    ...
    enum Connection11Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE88_L: // Intra-location logic for state l
