...
void Connection1Synapse35Run(Connection1Synapse35* me) {
    ...
    enum Connection1Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE35_L: // Intra-location logic for state l
