...
void Connection13Synapse78Run(Connection13Synapse78* me) {
    ...
    enum Connection13Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE78_L: // Intra-location logic for state l
