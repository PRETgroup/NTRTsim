...
void Connection12Synapse28Run(Connection12Synapse28* me) {
    ...
    enum Connection12Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE28_L: // Intra-location logic for state l
