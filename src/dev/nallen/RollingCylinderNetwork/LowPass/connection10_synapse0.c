...
void Connection10Synapse0Run(Connection10Synapse0* me) {
    ...
    enum Connection10Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION10_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION10_SYNAPSE0_L: // Intra-location logic for state l
