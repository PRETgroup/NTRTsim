...
void Connection6Synapse40Run(Connection6Synapse40* me) {
    ...
    enum Connection6Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE40_L: // Intra-location logic for state l
