...
void Connection2Synapse52Run(Connection2Synapse52* me) {
    ...
    enum Connection2Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE52_L: // Intra-location logic for state l
