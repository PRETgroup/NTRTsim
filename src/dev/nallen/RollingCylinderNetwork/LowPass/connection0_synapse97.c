...
void Connection0Synapse97Run(Connection0Synapse97* me) {
    ...
    enum Connection0Synapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE97_L: // Intra-location logic for state l
