...
void Connection11Synapse0Run(Connection11Synapse0* me) {
    ...
    enum Connection11Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE0_L: // Intra-location logic for state l
