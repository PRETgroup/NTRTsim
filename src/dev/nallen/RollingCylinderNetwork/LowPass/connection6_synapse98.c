...
void Connection6Synapse98Run(Connection6Synapse98* me) {
    ...
    enum Connection6Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE98_L: // Intra-location logic for state l
