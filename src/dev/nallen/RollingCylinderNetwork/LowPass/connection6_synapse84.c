...
void Connection6Synapse84Run(Connection6Synapse84* me) {
    ...
    enum Connection6Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE84_L: // Intra-location logic for state l
