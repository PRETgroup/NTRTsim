...
void Connection13Synapse41Run(Connection13Synapse41* me) {
    ...
    enum Connection13Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE41_L: // Intra-location logic for state l
