...
void Connection12Synapse78Run(Connection12Synapse78* me) {
    ...
    enum Connection12Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE78_L: // Intra-location logic for state l
