...
void Connection13Synapse73Run(Connection13Synapse73* me) {
    ...
    enum Connection13Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE73_L: // Intra-location logic for state l
