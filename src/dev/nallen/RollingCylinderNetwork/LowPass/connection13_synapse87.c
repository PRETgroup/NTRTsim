...
void Connection13Synapse87Run(Connection13Synapse87* me) {
    ...
    enum Connection13Synapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE87_L: // Intra-location logic for state l
