...
void Connection0Synapse50Run(Connection0Synapse50* me) {
    ...
    enum Connection0Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE50_L: // Intra-location logic for state l
