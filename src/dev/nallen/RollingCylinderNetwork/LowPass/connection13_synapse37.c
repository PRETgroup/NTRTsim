...
void Connection13Synapse37Run(Connection13Synapse37* me) {
    ...
    enum Connection13Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE37_L: // Intra-location logic for state l
