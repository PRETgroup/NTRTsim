...
void Connection2Synapse69Run(Connection2Synapse69* me) {
    ...
    enum Connection2Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE69_L: // Intra-location logic for state l
