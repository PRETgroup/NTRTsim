...
void Connection6Synapse28Run(Connection6Synapse28* me) {
    ...
    enum Connection6Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE28_L: // Intra-location logic for state l
