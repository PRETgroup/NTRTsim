...
void Connection0Synapse14Run(Connection0Synapse14* me) {
    ...
    enum Connection0Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE14_L: // Intra-location logic for state l
