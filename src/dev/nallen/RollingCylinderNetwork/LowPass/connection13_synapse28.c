...
void Connection13Synapse28Run(Connection13Synapse28* me) {
    ...
    enum Connection13Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE28_L: // Intra-location logic for state l
