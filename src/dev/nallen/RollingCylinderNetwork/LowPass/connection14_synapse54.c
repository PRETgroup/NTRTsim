...
void Connection14Synapse54Run(Connection14Synapse54* me) {
    ...
    enum Connection14Synapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE54_L: // Intra-location logic for state l
