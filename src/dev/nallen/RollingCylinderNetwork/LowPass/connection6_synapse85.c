...
void Connection6Synapse85Run(Connection6Synapse85* me) {
    ...
    enum Connection6Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE85_L: // Intra-location logic for state l
