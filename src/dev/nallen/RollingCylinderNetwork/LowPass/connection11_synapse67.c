...
void Connection11Synapse67Run(Connection11Synapse67* me) {
    ...
    enum Connection11Synapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE67_L: // Intra-location logic for state l
