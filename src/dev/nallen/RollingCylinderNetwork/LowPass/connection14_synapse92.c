...
void Connection14Synapse92Run(Connection14Synapse92* me) {
    ...
    enum Connection14Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE92_L: // Intra-location logic for state l
