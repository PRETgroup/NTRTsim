...
void Connection12Synapse66Run(Connection12Synapse66* me) {
    ...
    enum Connection12Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE66_L: // Intra-location logic for state l
