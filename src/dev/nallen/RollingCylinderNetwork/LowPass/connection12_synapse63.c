...
void Connection12Synapse63Run(Connection12Synapse63* me) {
    ...
    enum Connection12Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE63_L: // Intra-location logic for state l
