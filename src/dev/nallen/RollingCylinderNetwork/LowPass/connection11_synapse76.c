...
void Connection11Synapse76Run(Connection11Synapse76* me) {
    ...
    enum Connection11Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE76_L: // Intra-location logic for state l
