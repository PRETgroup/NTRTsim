...
void Connection2Synapse93Run(Connection2Synapse93* me) {
    ...
    enum Connection2Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE93_L: // Intra-location logic for state l
