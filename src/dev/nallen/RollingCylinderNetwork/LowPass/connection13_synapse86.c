...
void Connection13Synapse86Run(Connection13Synapse86* me) {
    ...
    enum Connection13Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE86_L: // Intra-location logic for state l
