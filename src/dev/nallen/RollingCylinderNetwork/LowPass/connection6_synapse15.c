...
void Connection6Synapse15Run(Connection6Synapse15* me) {
    ...
    enum Connection6Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE15_L: // Intra-location logic for state l
