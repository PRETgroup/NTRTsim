...
void Connection2Synapse15Run(Connection2Synapse15* me) {
    ...
    enum Connection2Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE15_L: // Intra-location logic for state l
