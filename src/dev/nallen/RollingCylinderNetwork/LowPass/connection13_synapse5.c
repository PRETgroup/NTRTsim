...
void Connection13Synapse5Run(Connection13Synapse5* me) {
    ...
    enum Connection13Synapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE5_L: // Intra-location logic for state l
