...
void Connection2Synapse59Run(Connection2Synapse59* me) {
    ...
    enum Connection2Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE59_L: // Intra-location logic for state l
