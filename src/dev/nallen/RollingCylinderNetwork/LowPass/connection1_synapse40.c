...
void Connection1Synapse40Run(Connection1Synapse40* me) {
    ...
    enum Connection1Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE40_L: // Intra-location logic for state l
