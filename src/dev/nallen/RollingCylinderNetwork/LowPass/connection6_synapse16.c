...
void Connection6Synapse16Run(Connection6Synapse16* me) {
    ...
    enum Connection6Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE16_L: // Intra-location logic for state l
