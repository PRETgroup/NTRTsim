...
void Connection12Synapse90Run(Connection12Synapse90* me) {
    ...
    enum Connection12Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE90_L: // Intra-location logic for state l
