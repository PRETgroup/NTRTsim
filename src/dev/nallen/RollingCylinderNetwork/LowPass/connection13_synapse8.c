...
void Connection13Synapse8Run(Connection13Synapse8* me) {
    ...
    enum Connection13Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE8_L: // Intra-location logic for state l
