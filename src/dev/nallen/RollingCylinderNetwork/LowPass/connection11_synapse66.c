...
void Connection11Synapse66Run(Connection11Synapse66* me) {
    ...
    enum Connection11Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE66_L: // Intra-location logic for state l
