...
void Connection13Synapse38Run(Connection13Synapse38* me) {
    ...
    enum Connection13Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE38_L: // Intra-location logic for state l
