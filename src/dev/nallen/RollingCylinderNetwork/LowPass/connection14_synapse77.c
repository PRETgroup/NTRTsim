...
void Connection14Synapse77Run(Connection14Synapse77* me) {
    ...
    enum Connection14Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE77_L: // Intra-location logic for state l
