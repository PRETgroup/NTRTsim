...
void Connection1Synapse17Run(Connection1Synapse17* me) {
    ...
    enum Connection1Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE17_L: // Intra-location logic for state l
