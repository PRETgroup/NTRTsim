...
void Connection12Synapse31Run(Connection12Synapse31* me) {
    ...
    enum Connection12Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE31_L: // Intra-location logic for state l
