...
void Connection12Synapse56Run(Connection12Synapse56* me) {
    ...
    enum Connection12Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE56_L: // Intra-location logic for state l
