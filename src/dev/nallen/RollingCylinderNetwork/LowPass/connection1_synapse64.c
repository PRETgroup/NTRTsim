...
void Connection1Synapse64Run(Connection1Synapse64* me) {
    ...
    enum Connection1Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE64_L: // Intra-location logic for state l
