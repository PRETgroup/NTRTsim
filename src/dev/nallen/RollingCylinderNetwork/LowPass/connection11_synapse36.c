...
void Connection11Synapse36Run(Connection11Synapse36* me) {
    ...
    enum Connection11Synapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE36_L: // Intra-location logic for state l
