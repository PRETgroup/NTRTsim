...
void Connection13Synapse11Run(Connection13Synapse11* me) {
    ...
    enum Connection13Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE11_L: // Intra-location logic for state l
