...
void Connection11Synapse55Run(Connection11Synapse55* me) {
    ...
    enum Connection11Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE55_L: // Intra-location logic for state l
