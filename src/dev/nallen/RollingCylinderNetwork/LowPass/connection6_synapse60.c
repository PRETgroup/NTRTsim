...
void Connection6Synapse60Run(Connection6Synapse60* me) {
    ...
    enum Connection6Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE60_L: // Intra-location logic for state l
