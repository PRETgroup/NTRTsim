...
void Connection14Synapse73Run(Connection14Synapse73* me) {
    ...
    enum Connection14Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE73_L: // Intra-location logic for state l
