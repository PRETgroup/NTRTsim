...
void Connection11Synapse83Run(Connection11Synapse83* me) {
    ...
    enum Connection11Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE83_L: // Intra-location logic for state l
