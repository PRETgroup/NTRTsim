...
void Connection6Synapse88Run(Connection6Synapse88* me) {
    ...
    enum Connection6Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE88_L: // Intra-location logic for state l
