...
void Connection6Synapse59Run(Connection6Synapse59* me) {
    ...
    enum Connection6Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE59_L: // Intra-location logic for state l
