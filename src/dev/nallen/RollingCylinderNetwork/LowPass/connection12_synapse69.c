...
void Connection12Synapse69Run(Connection12Synapse69* me) {
    ...
    enum Connection12Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE69_L: // Intra-location logic for state l
