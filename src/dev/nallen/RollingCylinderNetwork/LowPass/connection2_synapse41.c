...
void Connection2Synapse41Run(Connection2Synapse41* me) {
    ...
    enum Connection2Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE41_L: // Intra-location logic for state l
