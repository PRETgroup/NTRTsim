...
void Connection2Synapse10Run(Connection2Synapse10* me) {
    ...
    enum Connection2Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE10_L: // Intra-location logic for state l
