...
void Connection2Synapse47Run(Connection2Synapse47* me) {
    ...
    enum Connection2Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE47_L: // Intra-location logic for state l
