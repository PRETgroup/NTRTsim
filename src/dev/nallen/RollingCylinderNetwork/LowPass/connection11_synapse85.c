...
void Connection11Synapse85Run(Connection11Synapse85* me) {
    ...
    enum Connection11Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE85_L: // Intra-location logic for state l
