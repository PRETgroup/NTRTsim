...
void Connection0Synapse22Run(Connection0Synapse22* me) {
    ...
    enum Connection0Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE22_L: // Intra-location logic for state l
