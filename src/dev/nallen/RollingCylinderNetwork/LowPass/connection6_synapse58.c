...
void Connection6Synapse58Run(Connection6Synapse58* me) {
    ...
    enum Connection6Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE58_L: // Intra-location logic for state l
