...
void Connection13Synapse15Run(Connection13Synapse15* me) {
    ...
    enum Connection13Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE15_L: // Intra-location logic for state l
