...
void Connection6Synapse41Run(Connection6Synapse41* me) {
    ...
    enum Connection6Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE41_L: // Intra-location logic for state l
