...
void Connection14Synapse11Run(Connection14Synapse11* me) {
    ...
    enum Connection14Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE11_L: // Intra-location logic for state l
