...
void Connection11Synapse44Run(Connection11Synapse44* me) {
    ...
    enum Connection11Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE44_L: // Intra-location logic for state l
