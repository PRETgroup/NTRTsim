...
void Connection6Synapse45Run(Connection6Synapse45* me) {
    ...
    enum Connection6Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE45_L: // Intra-location logic for state l
