...
void Connection6Synapse9Run(Connection6Synapse9* me) {
    ...
    enum Connection6Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE9_L: // Intra-location logic for state l
