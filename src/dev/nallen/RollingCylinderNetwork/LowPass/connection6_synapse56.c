...
void Connection6Synapse56Run(Connection6Synapse56* me) {
    ...
    enum Connection6Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE56_L: // Intra-location logic for state l
