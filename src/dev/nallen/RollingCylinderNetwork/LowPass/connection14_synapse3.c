...
void Connection14Synapse3Run(Connection14Synapse3* me) {
    ...
    enum Connection14Synapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE3_L: // Intra-location logic for state l
