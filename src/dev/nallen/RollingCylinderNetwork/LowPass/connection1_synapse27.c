...
void Connection1Synapse27Run(Connection1Synapse27* me) {
    ...
    enum Connection1Synapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE27_L: // Intra-location logic for state l
