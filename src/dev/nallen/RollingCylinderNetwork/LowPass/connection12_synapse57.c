...
void Connection12Synapse57Run(Connection12Synapse57* me) {
    ...
    enum Connection12Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE57_L: // Intra-location logic for state l
