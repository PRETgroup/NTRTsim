...
void Connection2Synapse45Run(Connection2Synapse45* me) {
    ...
    enum Connection2Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE45_L: // Intra-location logic for state l
