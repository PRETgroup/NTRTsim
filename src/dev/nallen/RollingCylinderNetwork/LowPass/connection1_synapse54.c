...
void Connection1Synapse54Run(Connection1Synapse54* me) {
    ...
    enum Connection1Synapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE54_L: // Intra-location logic for state l
