...
void Connection2Synapse8Run(Connection2Synapse8* me) {
    ...
    enum Connection2Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE8_L: // Intra-location logic for state l
