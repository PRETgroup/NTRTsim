...
void Connection6Synapse76Run(Connection6Synapse76* me) {
    ...
    enum Connection6Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE76_L: // Intra-location logic for state l
