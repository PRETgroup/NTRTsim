...
void Connection11Synapse56Run(Connection11Synapse56* me) {
    ...
    enum Connection11Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE56_L: // Intra-location logic for state l
