...
void Connection6Synapse99Run(Connection6Synapse99* me) {
    ...
    enum Connection6Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE99_L: // Intra-location logic for state l
