...
void Connection12Synapse83Run(Connection12Synapse83* me) {
    ...
    enum Connection12Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE83_L: // Intra-location logic for state l
