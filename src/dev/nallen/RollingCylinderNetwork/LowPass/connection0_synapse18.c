...
void Connection0Synapse18Run(Connection0Synapse18* me) {
    ...
    enum Connection0Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE18_L: // Intra-location logic for state l
