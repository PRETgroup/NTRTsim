...
void Connection1Synapse18Run(Connection1Synapse18* me) {
    ...
    enum Connection1Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE18_L: // Intra-location logic for state l
