...
void Connection6Synapse66Run(Connection6Synapse66* me) {
    ...
    enum Connection6Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE66_L: // Intra-location logic for state l
