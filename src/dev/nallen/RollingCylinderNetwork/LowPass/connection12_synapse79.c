...
void Connection12Synapse79Run(Connection12Synapse79* me) {
    ...
    enum Connection12Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE79_L: // Intra-location logic for state l
