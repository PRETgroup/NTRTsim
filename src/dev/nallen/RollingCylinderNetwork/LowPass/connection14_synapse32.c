...
void Connection14Synapse32Run(Connection14Synapse32* me) {
    ...
    enum Connection14Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE32_L: // Intra-location logic for state l
