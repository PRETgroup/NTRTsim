...
void Connection0Synapse25Run(Connection0Synapse25* me) {
    ...
    enum Connection0Synapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE25_L: // Intra-location logic for state l
