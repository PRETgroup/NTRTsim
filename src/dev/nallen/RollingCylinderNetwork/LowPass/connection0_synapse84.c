...
void Connection0Synapse84Run(Connection0Synapse84* me) {
    ...
    enum Connection0Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE84_L: // Intra-location logic for state l
