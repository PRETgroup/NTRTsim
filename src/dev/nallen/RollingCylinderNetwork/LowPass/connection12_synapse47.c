...
void Connection12Synapse47Run(Connection12Synapse47* me) {
    ...
    enum Connection12Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE47_L: // Intra-location logic for state l
