...
void Connection0Synapse10Run(Connection0Synapse10* me) {
    ...
    enum Connection0Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE10_L: // Intra-location logic for state l
