...
void Connection11Synapse2Run(Connection11Synapse2* me) {
    ...
    enum Connection11Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE2_L: // Intra-location logic for state l
