...
void Connection6Synapse72Run(Connection6Synapse72* me) {
    ...
    enum Connection6Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE72_L: // Intra-location logic for state l
