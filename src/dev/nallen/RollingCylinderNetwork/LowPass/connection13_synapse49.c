...
void Connection13Synapse49Run(Connection13Synapse49* me) {
    ...
    enum Connection13Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE49_L: // Intra-location logic for state l
