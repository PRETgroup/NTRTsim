...
void Connection0Synapse45Run(Connection0Synapse45* me) {
    ...
    enum Connection0Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE45_L: // Intra-location logic for state l
