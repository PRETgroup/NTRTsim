...
void Connection1Synapse51Run(Connection1Synapse51* me) {
    ...
    enum Connection1Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE51_L: // Intra-location logic for state l
