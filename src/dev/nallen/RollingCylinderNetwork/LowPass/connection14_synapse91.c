...
void Connection14Synapse91Run(Connection14Synapse91* me) {
    ...
    enum Connection14Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE91_L: // Intra-location logic for state l
