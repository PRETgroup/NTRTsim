...
void Connection13Synapse61Run(Connection13Synapse61* me) {
    ...
    enum Connection13Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE61_L: // Intra-location logic for state l
