...
void Connection11Synapse79Run(Connection11Synapse79* me) {
    ...
    enum Connection11Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE79_L: // Intra-location logic for state l
