...
void Connection4Synapse0Run(Connection4Synapse0* me) {
    ...
    enum Connection4Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION4_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION4_SYNAPSE0_L: // Intra-location logic for state l
