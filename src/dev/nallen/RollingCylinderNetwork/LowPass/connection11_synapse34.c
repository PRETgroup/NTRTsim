...
void Connection11Synapse34Run(Connection11Synapse34* me) {
    ...
    enum Connection11Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE34_L: // Intra-location logic for state l
