...
void Connection11Synapse32Run(Connection11Synapse32* me) {
    ...
    enum Connection11Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE32_L: // Intra-location logic for state l
