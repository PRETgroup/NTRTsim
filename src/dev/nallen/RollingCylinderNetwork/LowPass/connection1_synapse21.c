...
void Connection1Synapse21Run(Connection1Synapse21* me) {
    ...
    enum Connection1Synapse21States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE21_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE21_L: // Intra-location logic for state l
