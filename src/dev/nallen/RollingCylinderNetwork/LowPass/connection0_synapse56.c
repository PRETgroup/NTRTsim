...
void Connection0Synapse56Run(Connection0Synapse56* me) {
    ...
    enum Connection0Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE56_L: // Intra-location logic for state l
