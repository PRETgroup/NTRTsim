...
void Connection1Synapse60Run(Connection1Synapse60* me) {
    ...
    enum Connection1Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE60_L: // Intra-location logic for state l
