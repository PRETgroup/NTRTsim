...
void Connection1Synapse94Run(Connection1Synapse94* me) {
    ...
    enum Connection1Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE94_L: // Intra-location logic for state l
