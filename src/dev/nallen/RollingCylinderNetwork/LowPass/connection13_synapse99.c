...
void Connection13Synapse99Run(Connection13Synapse99* me) {
    ...
    enum Connection13Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE99_L: // Intra-location logic for state l
