...
void Connection14Synapse30Run(Connection14Synapse30* me) {
    ...
    enum Connection14Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE30_L: // Intra-location logic for state l
