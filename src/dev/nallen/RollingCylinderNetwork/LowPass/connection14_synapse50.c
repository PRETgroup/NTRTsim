...
void Connection14Synapse50Run(Connection14Synapse50* me) {
    ...
    enum Connection14Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE50_L: // Intra-location logic for state l
