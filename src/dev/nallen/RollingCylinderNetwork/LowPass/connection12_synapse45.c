...
void Connection12Synapse45Run(Connection12Synapse45* me) {
    ...
    enum Connection12Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE45_L: // Intra-location logic for state l
