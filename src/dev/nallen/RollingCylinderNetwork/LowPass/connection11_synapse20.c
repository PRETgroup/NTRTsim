...
void Connection11Synapse20Run(Connection11Synapse20* me) {
    ...
    enum Connection11Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE20_L: // Intra-location logic for state l
