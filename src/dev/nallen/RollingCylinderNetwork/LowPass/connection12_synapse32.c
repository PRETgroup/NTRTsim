...
void Connection12Synapse32Run(Connection12Synapse32* me) {
    ...
    enum Connection12Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE32_L: // Intra-location logic for state l
