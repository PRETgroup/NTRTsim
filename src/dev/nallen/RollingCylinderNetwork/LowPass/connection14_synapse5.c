...
void Connection14Synapse5Run(Connection14Synapse5* me) {
    ...
    enum Connection14Synapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE5_L: // Intra-location logic for state l
