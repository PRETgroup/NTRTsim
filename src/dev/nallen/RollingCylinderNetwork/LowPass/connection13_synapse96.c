...
void Connection13Synapse96Run(Connection13Synapse96* me) {
    ...
    enum Connection13Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE96_L: // Intra-location logic for state l
