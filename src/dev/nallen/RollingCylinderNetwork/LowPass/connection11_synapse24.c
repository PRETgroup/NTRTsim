...
void Connection11Synapse24Run(Connection11Synapse24* me) {
    ...
    enum Connection11Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE24_L: // Intra-location logic for state l
