...
void Connection11Synapse12Run(Connection11Synapse12* me) {
    ...
    enum Connection11Synapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE12_L: // Intra-location logic for state l
