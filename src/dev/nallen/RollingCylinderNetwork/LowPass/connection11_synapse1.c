...
void Connection11Synapse1Run(Connection11Synapse1* me) {
    ...
    enum Connection11Synapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE1_L: // Intra-location logic for state l
