...
void Connection12Synapse41Run(Connection12Synapse41* me) {
    ...
    enum Connection12Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE41_L: // Intra-location logic for state l
