...
void Connection0Synapse86Run(Connection0Synapse86* me) {
    ...
    enum Connection0Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE86_L: // Intra-location logic for state l
