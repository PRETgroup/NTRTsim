...
void Connection6Synapse13Run(Connection6Synapse13* me) {
    ...
    enum Connection6Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE13_L: // Intra-location logic for state l
