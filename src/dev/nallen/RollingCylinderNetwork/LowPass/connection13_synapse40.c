...
void Connection13Synapse40Run(Connection13Synapse40* me) {
    ...
    enum Connection13Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE40_L: // Intra-location logic for state l
