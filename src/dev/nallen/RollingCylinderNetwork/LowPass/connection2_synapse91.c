...
void Connection2Synapse91Run(Connection2Synapse91* me) {
    ...
    enum Connection2Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE91_L: // Intra-location logic for state l
