...
void Connection2Synapse38Run(Connection2Synapse38* me) {
    ...
    enum Connection2Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE38_L: // Intra-location logic for state l
