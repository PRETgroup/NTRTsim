...
void Connection13Synapse68Run(Connection13Synapse68* me) {
    ...
    enum Connection13Synapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE68_L: // Intra-location logic for state l
