...
void Connection11Synapse27Run(Connection11Synapse27* me) {
    ...
    enum Connection11Synapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE27_L: // Intra-location logic for state l
