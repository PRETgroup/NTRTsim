...
void Connection0Synapse44Run(Connection0Synapse44* me) {
    ...
    enum Connection0Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE44_L: // Intra-location logic for state l
