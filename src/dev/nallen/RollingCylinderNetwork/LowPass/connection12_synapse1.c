...
void Connection12Synapse1Run(Connection12Synapse1* me) {
    ...
    enum Connection12Synapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE1_L: // Intra-location logic for state l
