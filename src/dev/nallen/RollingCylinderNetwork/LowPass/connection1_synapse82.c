...
void Connection1Synapse82Run(Connection1Synapse82* me) {
    ...
    enum Connection1Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE82_L: // Intra-location logic for state l
