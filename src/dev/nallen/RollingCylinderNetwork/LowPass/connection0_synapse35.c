...
void Connection0Synapse35Run(Connection0Synapse35* me) {
    ...
    enum Connection0Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE35_L: // Intra-location logic for state l
