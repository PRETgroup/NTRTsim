...
void Connection14Synapse17Run(Connection14Synapse17* me) {
    ...
    enum Connection14Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE17_L: // Intra-location logic for state l
