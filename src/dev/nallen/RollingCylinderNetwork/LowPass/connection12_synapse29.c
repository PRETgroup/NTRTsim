...
void Connection12Synapse29Run(Connection12Synapse29* me) {
    ...
    enum Connection12Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE29_L: // Intra-location logic for state l
