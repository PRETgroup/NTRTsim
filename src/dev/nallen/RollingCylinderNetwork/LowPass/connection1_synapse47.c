...
void Connection1Synapse47Run(Connection1Synapse47* me) {
    ...
    enum Connection1Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE47_L: // Intra-location logic for state l
