...
void Connection0Synapse67Run(Connection0Synapse67* me) {
    ...
    enum Connection0Synapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE67_L: // Intra-location logic for state l
