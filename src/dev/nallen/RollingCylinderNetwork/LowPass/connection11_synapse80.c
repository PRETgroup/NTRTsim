...
void Connection11Synapse80Run(Connection11Synapse80* me) {
    ...
    enum Connection11Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE80_L: // Intra-location logic for state l
