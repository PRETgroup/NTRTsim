...
void Connection11Synapse28Run(Connection11Synapse28* me) {
    ...
    enum Connection11Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE28_L: // Intra-location logic for state l
