...
void Connection0Synapse26Run(Connection0Synapse26* me) {
    ...
    enum Connection0Synapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE26_L: // Intra-location logic for state l
