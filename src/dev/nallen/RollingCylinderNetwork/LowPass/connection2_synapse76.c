...
void Connection2Synapse76Run(Connection2Synapse76* me) {
    ...
    enum Connection2Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE76_L: // Intra-location logic for state l
