...
void Connection12Synapse65Run(Connection12Synapse65* me) {
    ...
    enum Connection12Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE65_L: // Intra-location logic for state l
