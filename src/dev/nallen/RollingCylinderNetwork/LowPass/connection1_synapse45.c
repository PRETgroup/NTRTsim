...
void Connection1Synapse45Run(Connection1Synapse45* me) {
    ...
    enum Connection1Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE45_L: // Intra-location logic for state l
