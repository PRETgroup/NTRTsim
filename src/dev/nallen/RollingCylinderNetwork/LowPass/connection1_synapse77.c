...
void Connection1Synapse77Run(Connection1Synapse77* me) {
    ...
    enum Connection1Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE77_L: // Intra-location logic for state l
