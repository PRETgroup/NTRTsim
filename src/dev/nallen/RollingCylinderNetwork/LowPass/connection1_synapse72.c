...
void Connection1Synapse72Run(Connection1Synapse72* me) {
    ...
    enum Connection1Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE72_L: // Intra-location logic for state l
