...
void Connection12Synapse33Run(Connection12Synapse33* me) {
    ...
    enum Connection12Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE33_L: // Intra-location logic for state l
