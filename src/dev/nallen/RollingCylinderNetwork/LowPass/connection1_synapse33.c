...
void Connection1Synapse33Run(Connection1Synapse33* me) {
    ...
    enum Connection1Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE33_L: // Intra-location logic for state l
