...
void Connection12Synapse86Run(Connection12Synapse86* me) {
    ...
    enum Connection12Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE86_L: // Intra-location logic for state l
