...
void Connection2Synapse40Run(Connection2Synapse40* me) {
    ...
    enum Connection2Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE40_L: // Intra-location logic for state l
