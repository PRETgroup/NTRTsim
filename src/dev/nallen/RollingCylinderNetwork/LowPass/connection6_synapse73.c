...
void Connection6Synapse73Run(Connection6Synapse73* me) {
    ...
    enum Connection6Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE73_L: // Intra-location logic for state l
