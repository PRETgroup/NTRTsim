...
void Connection13Synapse44Run(Connection13Synapse44* me) {
    ...
    enum Connection13Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE44_L: // Intra-location logic for state l
