...
void Connection11Synapse11Run(Connection11Synapse11* me) {
    ...
    enum Connection11Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE11_L: // Intra-location logic for state l
