...
void Connection6Synapse18Run(Connection6Synapse18* me) {
    ...
    enum Connection6Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE18_L: // Intra-location logic for state l
