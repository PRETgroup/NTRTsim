...
void Connection6Synapse68Run(Connection6Synapse68* me) {
    ...
    enum Connection6Synapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE68_L: // Intra-location logic for state l
