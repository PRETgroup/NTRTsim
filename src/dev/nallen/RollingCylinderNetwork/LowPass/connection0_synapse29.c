...
void Connection0Synapse29Run(Connection0Synapse29* me) {
    ...
    enum Connection0Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE29_L: // Intra-location logic for state l
