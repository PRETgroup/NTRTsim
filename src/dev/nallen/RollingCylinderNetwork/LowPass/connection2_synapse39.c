...
void Connection2Synapse39Run(Connection2Synapse39* me) {
    ...
    enum Connection2Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE39_L: // Intra-location logic for state l
