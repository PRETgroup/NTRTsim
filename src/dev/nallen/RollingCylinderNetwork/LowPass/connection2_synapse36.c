...
void Connection2Synapse36Run(Connection2Synapse36* me) {
    ...
    enum Connection2Synapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE36_L: // Intra-location logic for state l
