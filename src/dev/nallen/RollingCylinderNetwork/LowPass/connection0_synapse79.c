...
void Connection0Synapse79Run(Connection0Synapse79* me) {
    ...
    enum Connection0Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE79_L: // Intra-location logic for state l
