...
void Connection0Synapse34Run(Connection0Synapse34* me) {
    ...
    enum Connection0Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE34_L: // Intra-location logic for state l
