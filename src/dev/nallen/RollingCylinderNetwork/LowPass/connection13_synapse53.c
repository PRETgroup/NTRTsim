...
void Connection13Synapse53Run(Connection13Synapse53* me) {
    ...
    enum Connection13Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE53_L: // Intra-location logic for state l
