...
void Connection11Synapse81Run(Connection11Synapse81* me) {
    ...
    enum Connection11Synapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE81_L: // Intra-location logic for state l
