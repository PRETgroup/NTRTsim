...
void Connection13Synapse83Run(Connection13Synapse83* me) {
    ...
    enum Connection13Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE83_L: // Intra-location logic for state l
