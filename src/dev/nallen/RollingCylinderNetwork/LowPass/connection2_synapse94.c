...
void Connection2Synapse94Run(Connection2Synapse94* me) {
    ...
    enum Connection2Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE94_L: // Intra-location logic for state l
