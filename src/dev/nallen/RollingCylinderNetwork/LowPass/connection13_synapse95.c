...
void Connection13Synapse95Run(Connection13Synapse95* me) {
    ...
    enum Connection13Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE95_L: // Intra-location logic for state l
