...
void Connection1Synapse49Run(Connection1Synapse49* me) {
    ...
    enum Connection1Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE49_L: // Intra-location logic for state l
