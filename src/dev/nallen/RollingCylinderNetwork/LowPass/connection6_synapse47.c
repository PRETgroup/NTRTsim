...
void Connection6Synapse47Run(Connection6Synapse47* me) {
    ...
    enum Connection6Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE47_L: // Intra-location logic for state l
