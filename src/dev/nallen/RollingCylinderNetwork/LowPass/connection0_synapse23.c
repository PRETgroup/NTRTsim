...
void Connection0Synapse23Run(Connection0Synapse23* me) {
    ...
    enum Connection0Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE23_L: // Intra-location logic for state l
