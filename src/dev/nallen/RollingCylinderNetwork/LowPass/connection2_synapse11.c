...
void Connection2Synapse11Run(Connection2Synapse11* me) {
    ...
    enum Connection2Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE11_L: // Intra-location logic for state l
