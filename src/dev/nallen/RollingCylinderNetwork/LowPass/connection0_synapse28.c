...
void Connection0Synapse28Run(Connection0Synapse28* me) {
    ...
    enum Connection0Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE28_L: // Intra-location logic for state l
