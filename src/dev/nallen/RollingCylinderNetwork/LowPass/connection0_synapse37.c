...
void Connection0Synapse37Run(Connection0Synapse37* me) {
    ...
    enum Connection0Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE37_L: // Intra-location logic for state l
