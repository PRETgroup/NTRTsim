...
void Connection14Synapse13Run(Connection14Synapse13* me) {
    ...
    enum Connection14Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE13_L: // Intra-location logic for state l
