...
void Connection6Synapse14Run(Connection6Synapse14* me) {
    ...
    enum Connection6Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE14_L: // Intra-location logic for state l
