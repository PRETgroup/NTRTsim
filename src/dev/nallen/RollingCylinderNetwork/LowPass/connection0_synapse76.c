...
void Connection0Synapse76Run(Connection0Synapse76* me) {
    ...
    enum Connection0Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE76_L: // Intra-location logic for state l
