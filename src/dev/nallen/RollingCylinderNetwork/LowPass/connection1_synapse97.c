...
void Connection1Synapse97Run(Connection1Synapse97* me) {
    ...
    enum Connection1Synapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE97_L: // Intra-location logic for state l
