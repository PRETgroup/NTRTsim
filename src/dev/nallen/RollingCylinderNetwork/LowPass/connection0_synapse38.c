...
void Connection0Synapse38Run(Connection0Synapse38* me) {
    ...
    enum Connection0Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE38_L: // Intra-location logic for state l
