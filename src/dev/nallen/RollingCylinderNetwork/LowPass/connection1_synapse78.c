...
void Connection1Synapse78Run(Connection1Synapse78* me) {
    ...
    enum Connection1Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE78_L: // Intra-location logic for state l
