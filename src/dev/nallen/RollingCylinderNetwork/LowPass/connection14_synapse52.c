...
void Connection14Synapse52Run(Connection14Synapse52* me) {
    ...
    enum Connection14Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE52_L: // Intra-location logic for state l
