...
void Connection13Synapse2Run(Connection13Synapse2* me) {
    ...
    enum Connection13Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE2_L: // Intra-location logic for state l
