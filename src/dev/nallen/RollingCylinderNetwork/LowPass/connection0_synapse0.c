...
void Connection0Synapse0Run(Connection0Synapse0* me) {
    ...
    enum Connection0Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE0_L: // Intra-location logic for state l
