...
void Connection13Synapse52Run(Connection13Synapse52* me) {
    ...
    enum Connection13Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE52_L: // Intra-location logic for state l
