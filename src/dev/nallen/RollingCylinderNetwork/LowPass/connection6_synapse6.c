...
void Connection6Synapse6Run(Connection6Synapse6* me) {
    ...
    enum Connection6Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE6_L: // Intra-location logic for state l
