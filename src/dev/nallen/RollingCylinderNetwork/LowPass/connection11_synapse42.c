...
void Connection11Synapse42Run(Connection11Synapse42* me) {
    ...
    enum Connection11Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE42_L: // Intra-location logic for state l
