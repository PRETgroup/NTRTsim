...
void Connection1Synapse63Run(Connection1Synapse63* me) {
    ...
    enum Connection1Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE63_L: // Intra-location logic for state l
