...
void Connection11Synapse65Run(Connection11Synapse65* me) {
    ...
    enum Connection11Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE65_L: // Intra-location logic for state l
