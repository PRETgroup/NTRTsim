...
void Connection12Synapse4Run(Connection12Synapse4* me) {
    ...
    enum Connection12Synapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE4_L: // Intra-location logic for state l
