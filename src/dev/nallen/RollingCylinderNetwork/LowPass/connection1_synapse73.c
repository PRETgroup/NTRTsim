...
void Connection1Synapse73Run(Connection1Synapse73* me) {
    ...
    enum Connection1Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE73_L: // Intra-location logic for state l
