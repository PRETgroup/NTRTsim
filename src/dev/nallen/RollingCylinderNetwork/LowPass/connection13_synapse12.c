...
void Connection13Synapse12Run(Connection13Synapse12* me) {
    ...
    enum Connection13Synapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE12_L: // Intra-location logic for state l
