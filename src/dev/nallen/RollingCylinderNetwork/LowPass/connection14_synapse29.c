...
void Connection14Synapse29Run(Connection14Synapse29* me) {
    ...
    enum Connection14Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE29_L: // Intra-location logic for state l
