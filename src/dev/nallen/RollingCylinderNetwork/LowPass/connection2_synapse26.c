...
void Connection2Synapse26Run(Connection2Synapse26* me) {
    ...
    enum Connection2Synapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE26_L: // Intra-location logic for state l
