...
void Connection12Synapse51Run(Connection12Synapse51* me) {
    ...
    enum Connection12Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE51_L: // Intra-location logic for state l
