...
void Connection12Synapse71Run(Connection12Synapse71* me) {
    ...
    enum Connection12Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE71_L: // Intra-location logic for state l
