...
void Connection0Synapse9Run(Connection0Synapse9* me) {
    ...
    enum Connection0Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE9_L: // Intra-location logic for state l
