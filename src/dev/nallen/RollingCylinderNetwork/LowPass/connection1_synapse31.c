...
void Connection1Synapse31Run(Connection1Synapse31* me) {
    ...
    enum Connection1Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE31_L: // Intra-location logic for state l
