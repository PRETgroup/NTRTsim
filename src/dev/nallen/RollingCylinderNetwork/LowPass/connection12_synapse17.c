...
void Connection12Synapse17Run(Connection12Synapse17* me) {
    ...
    enum Connection12Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE17_L: // Intra-location logic for state l
