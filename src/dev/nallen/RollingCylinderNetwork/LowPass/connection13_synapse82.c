...
void Connection13Synapse82Run(Connection13Synapse82* me) {
    ...
    enum Connection13Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE82_L: // Intra-location logic for state l
