...
void Connection0Synapse88Run(Connection0Synapse88* me) {
    ...
    enum Connection0Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE88_L: // Intra-location logic for state l
