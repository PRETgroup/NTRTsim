...
void Connection0Synapse62Run(Connection0Synapse62* me) {
    ...
    enum Connection0Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE62_L: // Intra-location logic for state l
