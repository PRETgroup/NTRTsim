...
void Connection6Synapse62Run(Connection6Synapse62* me) {
    ...
    enum Connection6Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE62_L: // Intra-location logic for state l
