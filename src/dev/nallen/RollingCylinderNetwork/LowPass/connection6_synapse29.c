...
void Connection6Synapse29Run(Connection6Synapse29* me) {
    ...
    enum Connection6Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE29_L: // Intra-location logic for state l
