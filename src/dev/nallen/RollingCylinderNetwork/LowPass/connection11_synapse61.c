...
void Connection11Synapse61Run(Connection11Synapse61* me) {
    ...
    enum Connection11Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE61_L: // Intra-location logic for state l
