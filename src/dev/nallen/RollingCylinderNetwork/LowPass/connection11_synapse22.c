...
void Connection11Synapse22Run(Connection11Synapse22* me) {
    ...
    enum Connection11Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE22_L: // Intra-location logic for state l
