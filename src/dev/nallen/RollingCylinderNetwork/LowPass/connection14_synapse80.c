...
void Connection14Synapse80Run(Connection14Synapse80* me) {
    ...
    enum Connection14Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE80_L: // Intra-location logic for state l
