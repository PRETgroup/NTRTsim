...
void Connection1Synapse30Run(Connection1Synapse30* me) {
    ...
    enum Connection1Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE30_L: // Intra-location logic for state l
