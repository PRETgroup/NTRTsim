...
void Connection0Synapse42Run(Connection0Synapse42* me) {
    ...
    enum Connection0Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE42_L: // Intra-location logic for state l
