...
void Connection6Synapse93Run(Connection6Synapse93* me) {
    ...
    enum Connection6Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE93_L: // Intra-location logic for state l
