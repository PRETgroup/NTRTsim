...
void Connection14Synapse75Run(Connection14Synapse75* me) {
    ...
    enum Connection14Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE75_L: // Intra-location logic for state l
