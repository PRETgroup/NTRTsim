...
void Connection2Synapse18Run(Connection2Synapse18* me) {
    ...
    enum Connection2Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE18_L: // Intra-location logic for state l
