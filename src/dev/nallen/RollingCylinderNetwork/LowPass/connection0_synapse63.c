...
void Connection0Synapse63Run(Connection0Synapse63* me) {
    ...
    enum Connection0Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE63_L: // Intra-location logic for state l
