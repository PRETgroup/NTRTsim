...
void Connection1Synapse59Run(Connection1Synapse59* me) {
    ...
    enum Connection1Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE59_L: // Intra-location logic for state l
