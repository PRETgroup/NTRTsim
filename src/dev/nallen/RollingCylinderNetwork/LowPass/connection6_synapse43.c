...
void Connection6Synapse43Run(Connection6Synapse43* me) {
    ...
    enum Connection6Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE43_L: // Intra-location logic for state l
