...
void Connection1Synapse39Run(Connection1Synapse39* me) {
    ...
    enum Connection1Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE39_L: // Intra-location logic for state l
