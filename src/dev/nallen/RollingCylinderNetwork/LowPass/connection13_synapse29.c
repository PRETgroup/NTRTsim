...
void Connection13Synapse29Run(Connection13Synapse29* me) {
    ...
    enum Connection13Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE29_L: // Intra-location logic for state l
