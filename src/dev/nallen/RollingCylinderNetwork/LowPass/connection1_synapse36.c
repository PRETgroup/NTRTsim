...
void Connection1Synapse36Run(Connection1Synapse36* me) {
    ...
    enum Connection1Synapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE36_L: // Intra-location logic for state l
