...
void Connection11Synapse94Run(Connection11Synapse94* me) {
    ...
    enum Connection11Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE94_L: // Intra-location logic for state l
