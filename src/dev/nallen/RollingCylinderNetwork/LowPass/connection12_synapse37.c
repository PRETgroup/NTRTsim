...
void Connection12Synapse37Run(Connection12Synapse37* me) {
    ...
    enum Connection12Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE37_L: // Intra-location logic for state l
