...
void Connection0Synapse94Run(Connection0Synapse94* me) {
    ...
    enum Connection0Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE94_L: // Intra-location logic for state l
