...
void Connection6Synapse46Run(Connection6Synapse46* me) {
    ...
    enum Connection6Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE46_L: // Intra-location logic for state l
