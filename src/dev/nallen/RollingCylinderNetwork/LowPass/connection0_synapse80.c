...
void Connection0Synapse80Run(Connection0Synapse80* me) {
    ...
    enum Connection0Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE80_L: // Intra-location logic for state l
