...
void Connection12Synapse18Run(Connection12Synapse18* me) {
    ...
    enum Connection12Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE18_L: // Intra-location logic for state l
