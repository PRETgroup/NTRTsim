...
void Connection0Synapse59Run(Connection0Synapse59* me) {
    ...
    enum Connection0Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE59_L: // Intra-location logic for state l
