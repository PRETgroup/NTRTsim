...
void Connection13Synapse6Run(Connection13Synapse6* me) {
    ...
    enum Connection13Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE6_L: // Intra-location logic for state l
