...
void Connection2Synapse97Run(Connection2Synapse97* me) {
    ...
    enum Connection2Synapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE97_L: // Intra-location logic for state l
