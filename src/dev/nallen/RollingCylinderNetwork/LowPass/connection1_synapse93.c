...
void Connection1Synapse93Run(Connection1Synapse93* me) {
    ...
    enum Connection1Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE93_L: // Intra-location logic for state l
