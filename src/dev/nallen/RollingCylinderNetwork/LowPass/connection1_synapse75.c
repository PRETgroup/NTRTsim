...
void Connection1Synapse75Run(Connection1Synapse75* me) {
    ...
    enum Connection1Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE75_L: // Intra-location logic for state l
