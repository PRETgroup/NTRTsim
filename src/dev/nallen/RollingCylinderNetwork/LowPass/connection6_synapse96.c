...
void Connection6Synapse96Run(Connection6Synapse96* me) {
    ...
    enum Connection6Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE96_L: // Intra-location logic for state l
