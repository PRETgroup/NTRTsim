...
void Connection2Synapse37Run(Connection2Synapse37* me) {
    ...
    enum Connection2Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE37_L: // Intra-location logic for state l
