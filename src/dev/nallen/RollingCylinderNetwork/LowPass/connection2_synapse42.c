...
void Connection2Synapse42Run(Connection2Synapse42* me) {
    ...
    enum Connection2Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE42_L: // Intra-location logic for state l
