...
void Connection2Synapse55Run(Connection2Synapse55* me) {
    ...
    enum Connection2Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE55_L: // Intra-location logic for state l
