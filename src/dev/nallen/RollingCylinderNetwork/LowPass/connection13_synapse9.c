...
void Connection13Synapse9Run(Connection13Synapse9* me) {
    ...
    enum Connection13Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE9_L: // Intra-location logic for state l
