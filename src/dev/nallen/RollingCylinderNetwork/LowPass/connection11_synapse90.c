...
void Connection11Synapse90Run(Connection11Synapse90* me) {
    ...
    enum Connection11Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE90_L: // Intra-location logic for state l
