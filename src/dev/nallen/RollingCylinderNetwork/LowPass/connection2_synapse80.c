...
void Connection2Synapse80Run(Connection2Synapse80* me) {
    ...
    enum Connection2Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE80_L: // Intra-location logic for state l
