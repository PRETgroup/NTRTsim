...
void Connection13Synapse34Run(Connection13Synapse34* me) {
    ...
    enum Connection13Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE34_L: // Intra-location logic for state l
