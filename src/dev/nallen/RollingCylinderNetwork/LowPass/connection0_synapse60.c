...
void Connection0Synapse60Run(Connection0Synapse60* me) {
    ...
    enum Connection0Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE60_L: // Intra-location logic for state l
