...
void Connection1Synapse69Run(Connection1Synapse69* me) {
    ...
    enum Connection1Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE69_L: // Intra-location logic for state l
