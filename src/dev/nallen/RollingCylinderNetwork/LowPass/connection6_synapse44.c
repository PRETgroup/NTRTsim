...
void Connection6Synapse44Run(Connection6Synapse44* me) {
    ...
    enum Connection6Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE44_L: // Intra-location logic for state l
