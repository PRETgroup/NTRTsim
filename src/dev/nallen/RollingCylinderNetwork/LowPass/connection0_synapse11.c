...
void Connection0Synapse11Run(Connection0Synapse11* me) {
    ...
    enum Connection0Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE11_L: // Intra-location logic for state l
