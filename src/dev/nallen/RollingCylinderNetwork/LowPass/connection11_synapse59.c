...
void Connection11Synapse59Run(Connection11Synapse59* me) {
    ...
    enum Connection11Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE59_L: // Intra-location logic for state l
