...
void Connection6Synapse19Run(Connection6Synapse19* me) {
    ...
    enum Connection6Synapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE19_L: // Intra-location logic for state l
