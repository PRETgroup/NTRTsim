...
void Connection2Synapse83Run(Connection2Synapse83* me) {
    ...
    enum Connection2Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE83_L: // Intra-location logic for state l
