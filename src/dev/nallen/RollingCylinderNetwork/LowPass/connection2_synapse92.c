...
void Connection2Synapse92Run(Connection2Synapse92* me) {
    ...
    enum Connection2Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE92_L: // Intra-location logic for state l
