...
void Connection13Synapse16Run(Connection13Synapse16* me) {
    ...
    enum Connection13Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE16_L: // Intra-location logic for state l
