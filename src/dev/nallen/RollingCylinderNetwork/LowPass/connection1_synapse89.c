...
void Connection1Synapse89Run(Connection1Synapse89* me) {
    ...
    enum Connection1Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE89_L: // Intra-location logic for state l
