...
void Connection2Synapse77Run(Connection2Synapse77* me) {
    ...
    enum Connection2Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE77_L: // Intra-location logic for state l
