...
void Connection0Synapse98Run(Connection0Synapse98* me) {
    ...
    enum Connection0Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE98_L: // Intra-location logic for state l
