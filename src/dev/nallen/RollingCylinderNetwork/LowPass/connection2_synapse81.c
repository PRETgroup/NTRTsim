...
void Connection2Synapse81Run(Connection2Synapse81* me) {
    ...
    enum Connection2Synapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE81_L: // Intra-location logic for state l
