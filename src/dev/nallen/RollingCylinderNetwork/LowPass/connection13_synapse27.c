...
void Connection13Synapse27Run(Connection13Synapse27* me) {
    ...
    enum Connection13Synapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE27_L: // Intra-location logic for state l
