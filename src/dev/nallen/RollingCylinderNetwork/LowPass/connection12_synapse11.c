...
void Connection12Synapse11Run(Connection12Synapse11* me) {
    ...
    enum Connection12Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE11_L: // Intra-location logic for state l
