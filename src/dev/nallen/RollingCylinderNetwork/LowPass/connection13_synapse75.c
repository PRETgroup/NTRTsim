...
void Connection13Synapse75Run(Connection13Synapse75* me) {
    ...
    enum Connection13Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE75_L: // Intra-location logic for state l
