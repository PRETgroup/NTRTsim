...
void Connection0Synapse19Run(Connection0Synapse19* me) {
    ...
    enum Connection0Synapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE19_L: // Intra-location logic for state l
