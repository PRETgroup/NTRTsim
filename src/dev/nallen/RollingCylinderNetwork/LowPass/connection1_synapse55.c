...
void Connection1Synapse55Run(Connection1Synapse55* me) {
    ...
    enum Connection1Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE55_L: // Intra-location logic for state l
