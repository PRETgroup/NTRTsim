...
void Connection13Synapse21Run(Connection13Synapse21* me) {
    ...
    enum Connection13Synapse21States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE21_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE21_L: // Intra-location logic for state l
