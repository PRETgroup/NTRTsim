...
void Connection1Synapse74Run(Connection1Synapse74* me) {
    ...
    enum Connection1Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE74_L: // Intra-location logic for state l
