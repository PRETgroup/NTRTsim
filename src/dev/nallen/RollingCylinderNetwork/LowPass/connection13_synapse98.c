...
void Connection13Synapse98Run(Connection13Synapse98* me) {
    ...
    enum Connection13Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE98_L: // Intra-location logic for state l
