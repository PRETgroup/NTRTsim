...
void Connection6Synapse42Run(Connection6Synapse42* me) {
    ...
    enum Connection6Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE42_L: // Intra-location logic for state l
