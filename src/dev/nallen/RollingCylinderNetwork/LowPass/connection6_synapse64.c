...
void Connection6Synapse64Run(Connection6Synapse64* me) {
    ...
    enum Connection6Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE64_L: // Intra-location logic for state l
