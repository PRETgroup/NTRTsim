...
void Connection13Synapse48Run(Connection13Synapse48* me) {
    ...
    enum Connection13Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE48_L: // Intra-location logic for state l
