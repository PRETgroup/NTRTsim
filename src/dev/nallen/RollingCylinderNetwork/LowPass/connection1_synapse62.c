...
void Connection1Synapse62Run(Connection1Synapse62* me) {
    ...
    enum Connection1Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE62_L: // Intra-location logic for state l
