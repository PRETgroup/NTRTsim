...
void Connection12Synapse40Run(Connection12Synapse40* me) {
    ...
    enum Connection12Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE40_L: // Intra-location logic for state l
