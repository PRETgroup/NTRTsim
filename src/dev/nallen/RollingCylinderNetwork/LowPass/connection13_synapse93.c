...
void Connection13Synapse93Run(Connection13Synapse93* me) {
    ...
    enum Connection13Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE93_L: // Intra-location logic for state l
