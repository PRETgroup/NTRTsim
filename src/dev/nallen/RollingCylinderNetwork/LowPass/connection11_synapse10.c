...
void Connection11Synapse10Run(Connection11Synapse10* me) {
    ...
    enum Connection11Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE10_L: // Intra-location logic for state l
