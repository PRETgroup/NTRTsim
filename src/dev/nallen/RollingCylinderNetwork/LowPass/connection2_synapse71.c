...
void Connection2Synapse71Run(Connection2Synapse71* me) {
    ...
    enum Connection2Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE71_L: // Intra-location logic for state l
