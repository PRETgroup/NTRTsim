...
void Connection6Synapse49Run(Connection6Synapse49* me) {
    ...
    enum Connection6Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE49_L: // Intra-location logic for state l
