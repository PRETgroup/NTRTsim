...
void Connection14Synapse37Run(Connection14Synapse37* me) {
    ...
    enum Connection14Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE37_L: // Intra-location logic for state l
