...
void Connection2Synapse12Run(Connection2Synapse12* me) {
    ...
    enum Connection2Synapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE12_L: // Intra-location logic for state l
