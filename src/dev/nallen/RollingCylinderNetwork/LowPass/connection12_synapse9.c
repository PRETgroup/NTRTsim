...
void Connection12Synapse9Run(Connection12Synapse9* me) {
    ...
    enum Connection12Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE9_L: // Intra-location logic for state l
