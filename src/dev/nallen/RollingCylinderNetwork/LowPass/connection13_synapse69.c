...
void Connection13Synapse69Run(Connection13Synapse69* me) {
    ...
    enum Connection13Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE69_L: // Intra-location logic for state l
