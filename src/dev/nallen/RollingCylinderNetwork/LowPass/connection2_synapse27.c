...
void Connection2Synapse27Run(Connection2Synapse27* me) {
    ...
    enum Connection2Synapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE27_L: // Intra-location logic for state l
