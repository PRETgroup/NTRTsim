...
void Connection0Synapse95Run(Connection0Synapse95* me) {
    ...
    enum Connection0Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE95_L: // Intra-location logic for state l
