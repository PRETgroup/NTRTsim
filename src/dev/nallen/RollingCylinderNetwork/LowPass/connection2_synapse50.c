...
void Connection2Synapse50Run(Connection2Synapse50* me) {
    ...
    enum Connection2Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE50_L: // Intra-location logic for state l
