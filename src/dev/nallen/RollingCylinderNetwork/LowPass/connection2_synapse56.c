...
void Connection2Synapse56Run(Connection2Synapse56* me) {
    ...
    enum Connection2Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE56_L: // Intra-location logic for state l
