...
void Connection1Synapse46Run(Connection1Synapse46* me) {
    ...
    enum Connection1Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE46_L: // Intra-location logic for state l
