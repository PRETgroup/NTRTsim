...
void Connection2Synapse31Run(Connection2Synapse31* me) {
    ...
    enum Connection2Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE31_L: // Intra-location logic for state l
