...
void Connection6Synapse7Run(Connection6Synapse7* me) {
    ...
    enum Connection6Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE7_L: // Intra-location logic for state l
