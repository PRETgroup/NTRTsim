...
void Connection6Synapse1Run(Connection6Synapse1* me) {
    ...
    enum Connection6Synapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE1_L: // Intra-location logic for state l
