...
void Connection1Synapse37Run(Connection1Synapse37* me) {
    ...
    enum Connection1Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE37_L: // Intra-location logic for state l
