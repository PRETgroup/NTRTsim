...
void Connection11Synapse45Run(Connection11Synapse45* me) {
    ...
    enum Connection11Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE45_L: // Intra-location logic for state l
