...
void Connection13Synapse31Run(Connection13Synapse31* me) {
    ...
    enum Connection13Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE31_L: // Intra-location logic for state l
