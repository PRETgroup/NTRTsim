...
void Connection13Synapse65Run(Connection13Synapse65* me) {
    ...
    enum Connection13Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE65_L: // Intra-location logic for state l
