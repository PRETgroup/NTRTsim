...
void Connection11Synapse26Run(Connection11Synapse26* me) {
    ...
    enum Connection11Synapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE26_L: // Intra-location logic for state l
