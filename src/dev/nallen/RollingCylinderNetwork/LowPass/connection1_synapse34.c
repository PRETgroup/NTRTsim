...
void Connection1Synapse34Run(Connection1Synapse34* me) {
    ...
    enum Connection1Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE34_L: // Intra-location logic for state l
