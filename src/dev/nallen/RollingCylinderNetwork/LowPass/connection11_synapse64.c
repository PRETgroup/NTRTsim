...
void Connection11Synapse64Run(Connection11Synapse64* me) {
    ...
    enum Connection11Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE64_L: // Intra-location logic for state l
