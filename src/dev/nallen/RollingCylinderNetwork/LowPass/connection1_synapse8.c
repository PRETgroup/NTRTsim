...
void Connection1Synapse8Run(Connection1Synapse8* me) {
    ...
    enum Connection1Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE8_L: // Intra-location logic for state l
