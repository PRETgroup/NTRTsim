...
void Connection2Synapse43Run(Connection2Synapse43* me) {
    ...
    enum Connection2Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE43_L: // Intra-location logic for state l
