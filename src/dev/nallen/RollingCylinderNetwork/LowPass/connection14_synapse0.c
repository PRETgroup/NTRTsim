...
void Connection14Synapse0Run(Connection14Synapse0* me) {
    ...
    enum Connection14Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE0_L: // Intra-location logic for state l
