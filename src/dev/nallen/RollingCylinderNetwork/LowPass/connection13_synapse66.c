...
void Connection13Synapse66Run(Connection13Synapse66* me) {
    ...
    enum Connection13Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE66_L: // Intra-location logic for state l
