...
void Connection13Synapse76Run(Connection13Synapse76* me) {
    ...
    enum Connection13Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE76_L: // Intra-location logic for state l
