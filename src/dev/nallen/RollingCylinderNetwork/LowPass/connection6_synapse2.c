...
void Connection6Synapse2Run(Connection6Synapse2* me) {
    ...
    enum Connection6Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE2_L: // Intra-location logic for state l
