...
void Connection12Synapse99Run(Connection12Synapse99* me) {
    ...
    enum Connection12Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE99_L: // Intra-location logic for state l
