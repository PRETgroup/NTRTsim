...
void Connection12Synapse55Run(Connection12Synapse55* me) {
    ...
    enum Connection12Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE55_L: // Intra-location logic for state l
