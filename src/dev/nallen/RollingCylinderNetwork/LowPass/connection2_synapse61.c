...
void Connection2Synapse61Run(Connection2Synapse61* me) {
    ...
    enum Connection2Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE61_L: // Intra-location logic for state l
