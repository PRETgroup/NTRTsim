...
void Connection14Synapse25Run(Connection14Synapse25* me) {
    ...
    enum Connection14Synapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE25_L: // Intra-location logic for state l
