...
void Connection2Synapse17Run(Connection2Synapse17* me) {
    ...
    enum Connection2Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE17_L: // Intra-location logic for state l
