...
void Connection14Synapse24Run(Connection14Synapse24* me) {
    ...
    enum Connection14Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE24_L: // Intra-location logic for state l
