...
void Connection11Synapse75Run(Connection11Synapse75* me) {
    ...
    enum Connection11Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE75_L: // Intra-location logic for state l
