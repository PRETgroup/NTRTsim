...
void Connection2Synapse32Run(Connection2Synapse32* me) {
    ...
    enum Connection2Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE32_L: // Intra-location logic for state l
