...
void Connection14Synapse64Run(Connection14Synapse64* me) {
    ...
    enum Connection14Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE64_L: // Intra-location logic for state l
