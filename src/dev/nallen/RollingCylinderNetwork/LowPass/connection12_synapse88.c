...
void Connection12Synapse88Run(Connection12Synapse88* me) {
    ...
    enum Connection12Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE88_L: // Intra-location logic for state l
