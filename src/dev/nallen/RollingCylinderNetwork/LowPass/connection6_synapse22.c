...
void Connection6Synapse22Run(Connection6Synapse22* me) {
    ...
    enum Connection6Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE22_L: // Intra-location logic for state l
