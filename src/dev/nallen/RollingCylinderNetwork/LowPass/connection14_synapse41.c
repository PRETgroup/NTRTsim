...
void Connection14Synapse41Run(Connection14Synapse41* me) {
    ...
    enum Connection14Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE41_L: // Intra-location logic for state l
