...
void Connection6Synapse71Run(Connection6Synapse71* me) {
    ...
    enum Connection6Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE71_L: // Intra-location logic for state l
