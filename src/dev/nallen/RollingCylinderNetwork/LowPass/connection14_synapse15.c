...
void Connection14Synapse15Run(Connection14Synapse15* me) {
    ...
    enum Connection14Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE15_L: // Intra-location logic for state l
