...
void Connection0Synapse75Run(Connection0Synapse75* me) {
    ...
    enum Connection0Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE75_L: // Intra-location logic for state l
