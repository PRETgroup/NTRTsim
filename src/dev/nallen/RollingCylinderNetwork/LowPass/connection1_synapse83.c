...
void Connection1Synapse83Run(Connection1Synapse83* me) {
    ...
    enum Connection1Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE83_L: // Intra-location logic for state l
