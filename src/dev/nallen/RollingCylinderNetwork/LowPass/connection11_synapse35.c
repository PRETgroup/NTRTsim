...
void Connection11Synapse35Run(Connection11Synapse35* me) {
    ...
    enum Connection11Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE35_L: // Intra-location logic for state l
