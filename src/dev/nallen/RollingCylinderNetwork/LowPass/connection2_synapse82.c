...
void Connection2Synapse82Run(Connection2Synapse82* me) {
    ...
    enum Connection2Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE82_L: // Intra-location logic for state l
