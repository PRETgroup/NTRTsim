...
void Connection13Synapse45Run(Connection13Synapse45* me) {
    ...
    enum Connection13Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE45_L: // Intra-location logic for state l
