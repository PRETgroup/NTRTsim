...
void Connection6Synapse65Run(Connection6Synapse65* me) {
    ...
    enum Connection6Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE65_L: // Intra-location logic for state l
