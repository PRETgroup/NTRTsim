...
void Connection14Synapse94Run(Connection14Synapse94* me) {
    ...
    enum Connection14Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE94_L: // Intra-location logic for state l
