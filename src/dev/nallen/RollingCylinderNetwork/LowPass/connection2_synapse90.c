...
void Connection2Synapse90Run(Connection2Synapse90* me) {
    ...
    enum Connection2Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE90_L: // Intra-location logic for state l
