...
void Connection12Synapse44Run(Connection12Synapse44* me) {
    ...
    enum Connection12Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE44_L: // Intra-location logic for state l
