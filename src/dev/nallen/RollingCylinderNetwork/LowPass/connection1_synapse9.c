...
void Connection1Synapse9Run(Connection1Synapse9* me) {
    ...
    enum Connection1Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE9_L: // Intra-location logic for state l
