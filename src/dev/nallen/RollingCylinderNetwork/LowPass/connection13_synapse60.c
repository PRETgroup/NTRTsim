...
void Connection13Synapse60Run(Connection13Synapse60* me) {
    ...
    enum Connection13Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE60_L: // Intra-location logic for state l
