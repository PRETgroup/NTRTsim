...
void Connection12Synapse64Run(Connection12Synapse64* me) {
    ...
    enum Connection12Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE64_L: // Intra-location logic for state l
