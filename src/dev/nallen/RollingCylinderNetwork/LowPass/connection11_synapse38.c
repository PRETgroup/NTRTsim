...
void Connection11Synapse38Run(Connection11Synapse38* me) {
    ...
    enum Connection11Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE38_L: // Intra-location logic for state l
