...
void Connection6Synapse17Run(Connection6Synapse17* me) {
    ...
    enum Connection6Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE17_L: // Intra-location logic for state l
