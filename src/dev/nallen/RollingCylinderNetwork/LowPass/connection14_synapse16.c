...
void Connection14Synapse16Run(Connection14Synapse16* me) {
    ...
    enum Connection14Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE16_L: // Intra-location logic for state l
