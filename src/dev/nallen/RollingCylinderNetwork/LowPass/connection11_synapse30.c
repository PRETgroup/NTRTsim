...
void Connection11Synapse30Run(Connection11Synapse30* me) {
    ...
    enum Connection11Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE30_L: // Intra-location logic for state l
