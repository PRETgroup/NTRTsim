...
void Connection6Synapse87Run(Connection6Synapse87* me) {
    ...
    enum Connection6Synapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE87_L: // Intra-location logic for state l
