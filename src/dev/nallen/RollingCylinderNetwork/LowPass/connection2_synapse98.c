...
void Connection2Synapse98Run(Connection2Synapse98* me) {
    ...
    enum Connection2Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE98_L: // Intra-location logic for state l
