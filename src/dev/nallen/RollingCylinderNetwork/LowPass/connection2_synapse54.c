...
void Connection2Synapse54Run(Connection2Synapse54* me) {
    ...
    enum Connection2Synapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE54_L: // Intra-location logic for state l
