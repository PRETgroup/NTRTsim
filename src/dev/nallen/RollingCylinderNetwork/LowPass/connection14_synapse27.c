...
void Connection14Synapse27Run(Connection14Synapse27* me) {
    ...
    enum Connection14Synapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE27_L: // Intra-location logic for state l
