...
void Connection0Synapse48Run(Connection0Synapse48* me) {
    ...
    enum Connection0Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE48_L: // Intra-location logic for state l
