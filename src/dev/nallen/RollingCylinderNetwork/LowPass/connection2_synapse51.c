...
void Connection2Synapse51Run(Connection2Synapse51* me) {
    ...
    enum Connection2Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE51_L: // Intra-location logic for state l
