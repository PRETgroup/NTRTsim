...
void Connection1Synapse90Run(Connection1Synapse90* me) {
    ...
    enum Connection1Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE90_L: // Intra-location logic for state l
