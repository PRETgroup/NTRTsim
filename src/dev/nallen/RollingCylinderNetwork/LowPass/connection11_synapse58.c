...
void Connection11Synapse58Run(Connection11Synapse58* me) {
    ...
    enum Connection11Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE58_L: // Intra-location logic for state l
