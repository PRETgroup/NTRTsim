...
void Connection12Synapse76Run(Connection12Synapse76* me) {
    ...
    enum Connection12Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE76_L: // Intra-location logic for state l
