...
void Connection6Synapse82Run(Connection6Synapse82* me) {
    ...
    enum Connection6Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE82_L: // Intra-location logic for state l
