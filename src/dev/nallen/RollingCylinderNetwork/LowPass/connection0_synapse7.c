...
void Connection0Synapse7Run(Connection0Synapse7* me) {
    ...
    enum Connection0Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE7_L: // Intra-location logic for state l
