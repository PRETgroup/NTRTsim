...
void Connection11Synapse21Run(Connection11Synapse21* me) {
    ...
    enum Connection11Synapse21States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE21_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE21_L: // Intra-location logic for state l
