...
void Connection1Synapse91Run(Connection1Synapse91* me) {
    ...
    enum Connection1Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE91_L: // Intra-location logic for state l
