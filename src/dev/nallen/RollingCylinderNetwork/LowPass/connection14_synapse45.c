...
void Connection14Synapse45Run(Connection14Synapse45* me) {
    ...
    enum Connection14Synapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE45_L: // Intra-location logic for state l
