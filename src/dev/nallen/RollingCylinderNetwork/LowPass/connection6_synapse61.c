...
void Connection6Synapse61Run(Connection6Synapse61* me) {
    ...
    enum Connection6Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE61_L: // Intra-location logic for state l
