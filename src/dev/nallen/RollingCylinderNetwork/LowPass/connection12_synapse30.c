...
void Connection12Synapse30Run(Connection12Synapse30* me) {
    ...
    enum Connection12Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE30_L: // Intra-location logic for state l
