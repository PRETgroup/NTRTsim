...
void Connection1Synapse44Run(Connection1Synapse44* me) {
    ...
    enum Connection1Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE44_L: // Intra-location logic for state l
