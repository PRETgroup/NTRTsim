...
void Connection13Synapse24Run(Connection13Synapse24* me) {
    ...
    enum Connection13Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE24_L: // Intra-location logic for state l
