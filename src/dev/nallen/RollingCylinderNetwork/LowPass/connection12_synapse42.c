...
void Connection12Synapse42Run(Connection12Synapse42* me) {
    ...
    enum Connection12Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE42_L: // Intra-location logic for state l
