...
void Connection2Synapse57Run(Connection2Synapse57* me) {
    ...
    enum Connection2Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE57_L: // Intra-location logic for state l
