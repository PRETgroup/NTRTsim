...
void Connection0Synapse83Run(Connection0Synapse83* me) {
    ...
    enum Connection0Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE83_L: // Intra-location logic for state l
