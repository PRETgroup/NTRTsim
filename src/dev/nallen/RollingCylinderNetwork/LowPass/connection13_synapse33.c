...
void Connection13Synapse33Run(Connection13Synapse33* me) {
    ...
    enum Connection13Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE33_L: // Intra-location logic for state l
