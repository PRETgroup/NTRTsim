...
void Connection6Synapse57Run(Connection6Synapse57* me) {
    ...
    enum Connection6Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE57_L: // Intra-location logic for state l
