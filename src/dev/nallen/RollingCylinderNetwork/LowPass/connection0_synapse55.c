...
void Connection0Synapse55Run(Connection0Synapse55* me) {
    ...
    enum Connection0Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE55_L: // Intra-location logic for state l
