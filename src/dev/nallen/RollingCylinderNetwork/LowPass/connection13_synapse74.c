...
void Connection13Synapse74Run(Connection13Synapse74* me) {
    ...
    enum Connection13Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE74_L: // Intra-location logic for state l
