...
void Connection1Synapse4Run(Connection1Synapse4* me) {
    ...
    enum Connection1Synapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE4_L: // Intra-location logic for state l
