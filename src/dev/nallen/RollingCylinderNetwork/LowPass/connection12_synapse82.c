...
void Connection12Synapse82Run(Connection12Synapse82* me) {
    ...
    enum Connection12Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE82_L: // Intra-location logic for state l
