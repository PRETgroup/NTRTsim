...
void Connection13Synapse36Run(Connection13Synapse36* me) {
    ...
    enum Connection13Synapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE36_L: // Intra-location logic for state l
