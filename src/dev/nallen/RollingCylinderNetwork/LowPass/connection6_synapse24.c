...
void Connection6Synapse24Run(Connection6Synapse24* me) {
    ...
    enum Connection6Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE24_L: // Intra-location logic for state l
