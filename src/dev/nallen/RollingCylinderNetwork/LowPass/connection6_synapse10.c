...
void Connection6Synapse10Run(Connection6Synapse10* me) {
    ...
    enum Connection6Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE10_L: // Intra-location logic for state l
