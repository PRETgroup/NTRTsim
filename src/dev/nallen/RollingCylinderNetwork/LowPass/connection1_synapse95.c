...
void Connection1Synapse95Run(Connection1Synapse95* me) {
    ...
    enum Connection1Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE95_L: // Intra-location logic for state l
