...
void Connection12Synapse23Run(Connection12Synapse23* me) {
    ...
    enum Connection12Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE23_L: // Intra-location logic for state l
