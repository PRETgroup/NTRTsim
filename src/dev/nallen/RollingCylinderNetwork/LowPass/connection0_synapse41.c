...
void Connection0Synapse41Run(Connection0Synapse41* me) {
    ...
    enum Connection0Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE41_L: // Intra-location logic for state l
