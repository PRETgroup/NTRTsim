...
void Connection1Synapse22Run(Connection1Synapse22* me) {
    ...
    enum Connection1Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE22_L: // Intra-location logic for state l
