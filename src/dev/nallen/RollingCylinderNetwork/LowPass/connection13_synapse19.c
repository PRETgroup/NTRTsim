...
void Connection13Synapse19Run(Connection13Synapse19* me) {
    ...
    enum Connection13Synapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE19_L: // Intra-location logic for state l
