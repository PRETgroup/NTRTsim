...
void Connection13Synapse20Run(Connection13Synapse20* me) {
    ...
    enum Connection13Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE20_L: // Intra-location logic for state l
