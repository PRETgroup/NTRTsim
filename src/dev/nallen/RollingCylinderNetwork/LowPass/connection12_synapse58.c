...
void Connection12Synapse58Run(Connection12Synapse58* me) {
    ...
    enum Connection12Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE58_L: // Intra-location logic for state l
