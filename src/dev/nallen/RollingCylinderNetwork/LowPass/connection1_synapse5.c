...
void Connection1Synapse5Run(Connection1Synapse5* me) {
    ...
    enum Connection1Synapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE5_L: // Intra-location logic for state l
