...
void Connection0Synapse46Run(Connection0Synapse46* me) {
    ...
    enum Connection0Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE46_L: // Intra-location logic for state l
