...
void Connection14Synapse2Run(Connection14Synapse2* me) {
    ...
    enum Connection14Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE2_L: // Intra-location logic for state l
