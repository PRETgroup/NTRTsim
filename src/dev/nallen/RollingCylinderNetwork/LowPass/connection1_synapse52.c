...
void Connection1Synapse52Run(Connection1Synapse52* me) {
    ...
    enum Connection1Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE52_L: // Intra-location logic for state l
