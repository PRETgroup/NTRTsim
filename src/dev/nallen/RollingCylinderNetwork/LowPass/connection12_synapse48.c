...
void Connection12Synapse48Run(Connection12Synapse48* me) {
    ...
    enum Connection12Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE48_L: // Intra-location logic for state l
