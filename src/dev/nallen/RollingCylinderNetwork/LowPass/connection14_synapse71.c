...
void Connection14Synapse71Run(Connection14Synapse71* me) {
    ...
    enum Connection14Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE71_L: // Intra-location logic for state l
