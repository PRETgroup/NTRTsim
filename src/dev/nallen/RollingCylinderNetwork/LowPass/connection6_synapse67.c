...
void Connection6Synapse67Run(Connection6Synapse67* me) {
    ...
    enum Connection6Synapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE67_L: // Intra-location logic for state l
