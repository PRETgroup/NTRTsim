...
void Connection0Synapse12Run(Connection0Synapse12* me) {
    ...
    enum Connection0Synapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE12_L: // Intra-location logic for state l
