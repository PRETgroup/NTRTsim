...
void Connection11Synapse87Run(Connection11Synapse87* me) {
    ...
    enum Connection11Synapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE87_L: // Intra-location logic for state l
