...
void Connection1Synapse58Run(Connection1Synapse58* me) {
    ...
    enum Connection1Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE58_L: // Intra-location logic for state l
