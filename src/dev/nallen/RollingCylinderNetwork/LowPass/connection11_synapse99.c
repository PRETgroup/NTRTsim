...
void Connection11Synapse99Run(Connection11Synapse99* me) {
    ...
    enum Connection11Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE99_L: // Intra-location logic for state l
