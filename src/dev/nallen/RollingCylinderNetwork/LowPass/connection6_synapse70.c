...
void Connection6Synapse70Run(Connection6Synapse70* me) {
    ...
    enum Connection6Synapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE70_L: // Intra-location logic for state l
