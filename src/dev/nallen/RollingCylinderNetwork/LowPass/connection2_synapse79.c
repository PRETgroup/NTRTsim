...
void Connection2Synapse79Run(Connection2Synapse79* me) {
    ...
    enum Connection2Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE79_L: // Intra-location logic for state l
