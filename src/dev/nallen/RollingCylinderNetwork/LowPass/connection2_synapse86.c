...
void Connection2Synapse86Run(Connection2Synapse86* me) {
    ...
    enum Connection2Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE86_L: // Intra-location logic for state l
