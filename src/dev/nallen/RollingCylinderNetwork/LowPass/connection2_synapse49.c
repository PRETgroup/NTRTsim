...
void Connection2Synapse49Run(Connection2Synapse49* me) {
    ...
    enum Connection2Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE49_L: // Intra-location logic for state l
