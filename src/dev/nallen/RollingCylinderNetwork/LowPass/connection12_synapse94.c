...
void Connection12Synapse94Run(Connection12Synapse94* me) {
    ...
    enum Connection12Synapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE94_L: // Intra-location logic for state l
