...
void Connection0Synapse99Run(Connection0Synapse99* me) {
    ...
    enum Connection0Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE99_L: // Intra-location logic for state l
