...
void Connection2Synapse25Run(Connection2Synapse25* me) {
    ...
    enum Connection2Synapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE25_L: // Intra-location logic for state l
