...
void Connection14Synapse78Run(Connection14Synapse78* me) {
    ...
    enum Connection14Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE78_L: // Intra-location logic for state l
