...
void Connection11Synapse50Run(Connection11Synapse50* me) {
    ...
    enum Connection11Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE50_L: // Intra-location logic for state l
