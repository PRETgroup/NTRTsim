...
void Connection2Synapse34Run(Connection2Synapse34* me) {
    ...
    enum Connection2Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE34_L: // Intra-location logic for state l
