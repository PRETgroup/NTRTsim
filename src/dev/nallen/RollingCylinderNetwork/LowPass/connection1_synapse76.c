...
void Connection1Synapse76Run(Connection1Synapse76* me) {
    ...
    enum Connection1Synapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE76_L: // Intra-location logic for state l
