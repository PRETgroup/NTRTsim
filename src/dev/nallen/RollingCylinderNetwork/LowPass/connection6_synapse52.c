...
void Connection6Synapse52Run(Connection6Synapse52* me) {
    ...
    enum Connection6Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE52_L: // Intra-location logic for state l
