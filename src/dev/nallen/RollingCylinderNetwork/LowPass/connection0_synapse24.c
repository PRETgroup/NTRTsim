...
void Connection0Synapse24Run(Connection0Synapse24* me) {
    ...
    enum Connection0Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE24_L: // Intra-location logic for state l
