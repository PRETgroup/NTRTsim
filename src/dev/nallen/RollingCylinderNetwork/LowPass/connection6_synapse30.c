...
void Connection6Synapse30Run(Connection6Synapse30* me) {
    ...
    enum Connection6Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE30_L: // Intra-location logic for state l
