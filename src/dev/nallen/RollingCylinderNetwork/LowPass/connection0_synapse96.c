...
void Connection0Synapse96Run(Connection0Synapse96* me) {
    ...
    enum Connection0Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE96_L: // Intra-location logic for state l
