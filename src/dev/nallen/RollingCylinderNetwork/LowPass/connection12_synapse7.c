...
void Connection12Synapse7Run(Connection12Synapse7* me) {
    ...
    enum Connection12Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE7_L: // Intra-location logic for state l
