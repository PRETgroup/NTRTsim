...
void Connection0Synapse72Run(Connection0Synapse72* me) {
    ...
    enum Connection0Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE72_L: // Intra-location logic for state l
