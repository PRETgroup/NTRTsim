...
void Connection13Synapse51Run(Connection13Synapse51* me) {
    ...
    enum Connection13Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE51_L: // Intra-location logic for state l
