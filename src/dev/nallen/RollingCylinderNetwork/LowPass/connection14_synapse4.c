...
void Connection14Synapse4Run(Connection14Synapse4* me) {
    ...
    enum Connection14Synapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE4_L: // Intra-location logic for state l
