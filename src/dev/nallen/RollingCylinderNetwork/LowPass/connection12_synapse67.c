...
void Connection12Synapse67Run(Connection12Synapse67* me) {
    ...
    enum Connection12Synapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE67_L: // Intra-location logic for state l
