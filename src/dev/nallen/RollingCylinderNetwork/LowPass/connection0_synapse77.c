...
void Connection0Synapse77Run(Connection0Synapse77* me) {
    ...
    enum Connection0Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE77_L: // Intra-location logic for state l
