...
void Connection0Synapse65Run(Connection0Synapse65* me) {
    ...
    enum Connection0Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE65_L: // Intra-location logic for state l
