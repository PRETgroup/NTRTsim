...
void Connection11Synapse8Run(Connection11Synapse8* me) {
    ...
    enum Connection11Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE8_L: // Intra-location logic for state l
