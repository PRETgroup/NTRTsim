...
void Connection13Synapse63Run(Connection13Synapse63* me) {
    ...
    enum Connection13Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE63_L: // Intra-location logic for state l
