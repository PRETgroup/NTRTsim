...
void Connection0Synapse15Run(Connection0Synapse15* me) {
    ...
    enum Connection0Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE15_L: // Intra-location logic for state l
