...
void Connection12Synapse24Run(Connection12Synapse24* me) {
    ...
    enum Connection12Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE24_L: // Intra-location logic for state l
