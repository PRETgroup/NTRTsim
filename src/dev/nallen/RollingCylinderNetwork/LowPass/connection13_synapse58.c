...
void Connection13Synapse58Run(Connection13Synapse58* me) {
    ...
    enum Connection13Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE58_L: // Intra-location logic for state l
