...
void Connection11Synapse54Run(Connection11Synapse54* me) {
    ...
    enum Connection11Synapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE54_L: // Intra-location logic for state l
