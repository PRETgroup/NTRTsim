...
void Connection0Synapse40Run(Connection0Synapse40* me) {
    ...
    enum Connection0Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE40_L: // Intra-location logic for state l
