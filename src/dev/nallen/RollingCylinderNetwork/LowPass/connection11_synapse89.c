...
void Connection11Synapse89Run(Connection11Synapse89* me) {
    ...
    enum Connection11Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE89_L: // Intra-location logic for state l
