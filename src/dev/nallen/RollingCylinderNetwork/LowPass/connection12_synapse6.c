...
void Connection12Synapse6Run(Connection12Synapse6* me) {
    ...
    enum Connection12Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE6_L: // Intra-location logic for state l
