...
void Connection6Synapse54Run(Connection6Synapse54* me) {
    ...
    enum Connection6Synapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE54_L: // Intra-location logic for state l
