...
void Connection12Synapse62Run(Connection12Synapse62* me) {
    ...
    enum Connection12Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE62_L: // Intra-location logic for state l
