...
void Connection2Synapse7Run(Connection2Synapse7* me) {
    ...
    enum Connection2Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE7_L: // Intra-location logic for state l
