...
void Connection11Synapse29Run(Connection11Synapse29* me) {
    ...
    enum Connection11Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE29_L: // Intra-location logic for state l
