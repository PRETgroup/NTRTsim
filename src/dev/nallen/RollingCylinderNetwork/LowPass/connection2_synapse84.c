...
void Connection2Synapse84Run(Connection2Synapse84* me) {
    ...
    enum Connection2Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE84_L: // Intra-location logic for state l
