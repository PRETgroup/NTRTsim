...
void Connection13Synapse88Run(Connection13Synapse88* me) {
    ...
    enum Connection13Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE88_L: // Intra-location logic for state l
