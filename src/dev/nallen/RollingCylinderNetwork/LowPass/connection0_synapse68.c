...
void Connection0Synapse68Run(Connection0Synapse68* me) {
    ...
    enum Connection0Synapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE68_L: // Intra-location logic for state l
