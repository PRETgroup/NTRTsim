...
void Connection6Synapse27Run(Connection6Synapse27* me) {
    ...
    enum Connection6Synapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE27_L: // Intra-location logic for state l
