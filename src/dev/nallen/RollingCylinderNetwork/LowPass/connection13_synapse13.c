...
void Connection13Synapse13Run(Connection13Synapse13* me) {
    ...
    enum Connection13Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE13_L: // Intra-location logic for state l
