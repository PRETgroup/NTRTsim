...
void Connection11Synapse3Run(Connection11Synapse3* me) {
    ...
    enum Connection11Synapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE3_L: // Intra-location logic for state l
