...
void Connection1Synapse67Run(Connection1Synapse67* me) {
    ...
    enum Connection1Synapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE67_L: // Intra-location logic for state l
