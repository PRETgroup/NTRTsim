...
void Connection0Synapse93Run(Connection0Synapse93* me) {
    ...
    enum Connection0Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE93_L: // Intra-location logic for state l
