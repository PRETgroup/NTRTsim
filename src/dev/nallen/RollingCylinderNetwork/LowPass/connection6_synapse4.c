...
void Connection6Synapse4Run(Connection6Synapse4* me) {
    ...
    enum Connection6Synapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE4_L: // Intra-location logic for state l
