...
void Connection2Synapse60Run(Connection2Synapse60* me) {
    ...
    enum Connection2Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE60_L: // Intra-location logic for state l
