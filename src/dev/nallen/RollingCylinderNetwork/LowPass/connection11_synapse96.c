...
void Connection11Synapse96Run(Connection11Synapse96* me) {
    ...
    enum Connection11Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE96_L: // Intra-location logic for state l
