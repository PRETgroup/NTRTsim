...
void Connection6Synapse34Run(Connection6Synapse34* me) {
    ...
    enum Connection6Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE34_L: // Intra-location logic for state l
