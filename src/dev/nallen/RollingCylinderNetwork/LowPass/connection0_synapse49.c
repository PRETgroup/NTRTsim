...
void Connection0Synapse49Run(Connection0Synapse49* me) {
    ...
    enum Connection0Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE49_L: // Intra-location logic for state l
