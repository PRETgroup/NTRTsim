...
void Connection2Synapse64Run(Connection2Synapse64* me) {
    ...
    enum Connection2Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE64_L: // Intra-location logic for state l
