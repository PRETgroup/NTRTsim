...
void Connection0Synapse13Run(Connection0Synapse13* me) {
    ...
    enum Connection0Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE13_L: // Intra-location logic for state l
