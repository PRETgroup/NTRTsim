...
void Connection12Synapse75Run(Connection12Synapse75* me) {
    ...
    enum Connection12Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE75_L: // Intra-location logic for state l
