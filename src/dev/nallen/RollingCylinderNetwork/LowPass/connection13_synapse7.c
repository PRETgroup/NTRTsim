...
void Connection13Synapse7Run(Connection13Synapse7* me) {
    ...
    enum Connection13Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE7_L: // Intra-location logic for state l
