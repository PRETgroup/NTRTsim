...
void Connection14Synapse61Run(Connection14Synapse61* me) {
    ...
    enum Connection14Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE61_L: // Intra-location logic for state l
