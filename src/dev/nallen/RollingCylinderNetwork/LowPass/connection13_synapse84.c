...
void Connection13Synapse84Run(Connection13Synapse84* me) {
    ...
    enum Connection13Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE84_L: // Intra-location logic for state l
