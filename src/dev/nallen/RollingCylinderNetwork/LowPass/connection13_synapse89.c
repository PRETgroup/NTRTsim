...
void Connection13Synapse89Run(Connection13Synapse89* me) {
    ...
    enum Connection13Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE89_L: // Intra-location logic for state l
