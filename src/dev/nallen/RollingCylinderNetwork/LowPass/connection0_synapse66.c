...
void Connection0Synapse66Run(Connection0Synapse66* me) {
    ...
    enum Connection0Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE66_L: // Intra-location logic for state l
