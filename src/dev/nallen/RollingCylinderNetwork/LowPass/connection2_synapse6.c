...
void Connection2Synapse6Run(Connection2Synapse6* me) {
    ...
    enum Connection2Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE6_L: // Intra-location logic for state l
