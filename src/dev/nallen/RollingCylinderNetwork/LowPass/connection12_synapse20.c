...
void Connection12Synapse20Run(Connection12Synapse20* me) {
    ...
    enum Connection12Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE20_L: // Intra-location logic for state l
