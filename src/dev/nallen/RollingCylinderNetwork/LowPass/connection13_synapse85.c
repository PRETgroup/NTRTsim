...
void Connection13Synapse85Run(Connection13Synapse85* me) {
    ...
    enum Connection13Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE85_L: // Intra-location logic for state l
