...
void Connection6Synapse53Run(Connection6Synapse53* me) {
    ...
    enum Connection6Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE53_L: // Intra-location logic for state l
