...
void Connection2Synapse96Run(Connection2Synapse96* me) {
    ...
    enum Connection2Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE96_L: // Intra-location logic for state l
