...
void Connection0Synapse32Run(Connection0Synapse32* me) {
    ...
    enum Connection0Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE32_L: // Intra-location logic for state l
