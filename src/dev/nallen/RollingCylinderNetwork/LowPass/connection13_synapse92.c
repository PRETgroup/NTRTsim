...
void Connection13Synapse92Run(Connection13Synapse92* me) {
    ...
    enum Connection13Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE92_L: // Intra-location logic for state l
