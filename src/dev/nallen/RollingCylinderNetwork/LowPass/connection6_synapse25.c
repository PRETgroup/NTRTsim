...
void Connection6Synapse25Run(Connection6Synapse25* me) {
    ...
    enum Connection6Synapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE25_L: // Intra-location logic for state l
