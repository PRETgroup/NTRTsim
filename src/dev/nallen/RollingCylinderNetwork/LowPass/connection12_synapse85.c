...
void Connection12Synapse85Run(Connection12Synapse85* me) {
    ...
    enum Connection12Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE85_L: // Intra-location logic for state l
