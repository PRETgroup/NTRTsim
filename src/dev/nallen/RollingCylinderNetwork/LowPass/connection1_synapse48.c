...
void Connection1Synapse48Run(Connection1Synapse48* me) {
    ...
    enum Connection1Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE48_L: // Intra-location logic for state l
