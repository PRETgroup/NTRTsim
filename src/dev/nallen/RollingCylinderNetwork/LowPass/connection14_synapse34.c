...
void Connection14Synapse34Run(Connection14Synapse34* me) {
    ...
    enum Connection14Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE34_L: // Intra-location logic for state l
