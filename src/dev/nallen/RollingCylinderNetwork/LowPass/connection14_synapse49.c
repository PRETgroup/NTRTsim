...
void Connection14Synapse49Run(Connection14Synapse49* me) {
    ...
    enum Connection14Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE49_L: // Intra-location logic for state l
