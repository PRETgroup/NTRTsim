...
void Connection0Synapse39Run(Connection0Synapse39* me) {
    ...
    enum Connection0Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE39_L: // Intra-location logic for state l
