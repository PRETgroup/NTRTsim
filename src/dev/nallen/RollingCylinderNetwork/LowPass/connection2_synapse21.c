...
void Connection2Synapse21Run(Connection2Synapse21* me) {
    ...
    enum Connection2Synapse21States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE21_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE21_L: // Intra-location logic for state l
