...
void Connection13Synapse90Run(Connection13Synapse90* me) {
    ...
    enum Connection13Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE90_L: // Intra-location logic for state l
