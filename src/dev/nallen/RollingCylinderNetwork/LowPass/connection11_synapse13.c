...
void Connection11Synapse13Run(Connection11Synapse13* me) {
    ...
    enum Connection11Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE13_L: // Intra-location logic for state l
