...
void Connection6Synapse31Run(Connection6Synapse31* me) {
    ...
    enum Connection6Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE31_L: // Intra-location logic for state l
