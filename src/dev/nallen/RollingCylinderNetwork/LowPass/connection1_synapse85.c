...
void Connection1Synapse85Run(Connection1Synapse85* me) {
    ...
    enum Connection1Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE85_L: // Intra-location logic for state l
