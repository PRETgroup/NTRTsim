...
void Connection13Synapse71Run(Connection13Synapse71* me) {
    ...
    enum Connection13Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE71_L: // Intra-location logic for state l
