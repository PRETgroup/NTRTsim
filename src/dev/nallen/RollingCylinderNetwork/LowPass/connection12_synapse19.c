...
void Connection12Synapse19Run(Connection12Synapse19* me) {
    ...
    enum Connection12Synapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE19_L: // Intra-location logic for state l
