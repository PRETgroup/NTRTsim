...
void Connection12Synapse5Run(Connection12Synapse5* me) {
    ...
    enum Connection12Synapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE5_L: // Intra-location logic for state l
