...
void Connection1Synapse6Run(Connection1Synapse6* me) {
    ...
    enum Connection1Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE6_L: // Intra-location logic for state l
