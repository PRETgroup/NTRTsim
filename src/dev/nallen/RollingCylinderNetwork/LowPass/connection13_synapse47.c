...
void Connection13Synapse47Run(Connection13Synapse47* me) {
    ...
    enum Connection13Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE47_L: // Intra-location logic for state l
