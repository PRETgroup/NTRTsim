...
void Connection2Synapse62Run(Connection2Synapse62* me) {
    ...
    enum Connection2Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE62_L: // Intra-location logic for state l
