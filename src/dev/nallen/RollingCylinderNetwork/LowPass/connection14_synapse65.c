...
void Connection14Synapse65Run(Connection14Synapse65* me) {
    ...
    enum Connection14Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE65_L: // Intra-location logic for state l
