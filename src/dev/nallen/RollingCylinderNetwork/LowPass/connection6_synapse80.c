...
void Connection6Synapse80Run(Connection6Synapse80* me) {
    ...
    enum Connection6Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE80_L: // Intra-location logic for state l
