...
void Connection1Synapse92Run(Connection1Synapse92* me) {
    ...
    enum Connection1Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE92_L: // Intra-location logic for state l
