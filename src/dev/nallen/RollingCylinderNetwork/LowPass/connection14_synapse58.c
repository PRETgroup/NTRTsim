...
void Connection14Synapse58Run(Connection14Synapse58* me) {
    ...
    enum Connection14Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE58_L: // Intra-location logic for state l
