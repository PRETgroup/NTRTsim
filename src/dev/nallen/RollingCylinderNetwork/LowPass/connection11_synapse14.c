...
void Connection11Synapse14Run(Connection11Synapse14* me) {
    ...
    enum Connection11Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE14_L: // Intra-location logic for state l
