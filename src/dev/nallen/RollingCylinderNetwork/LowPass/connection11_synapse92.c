...
void Connection11Synapse92Run(Connection11Synapse92* me) {
    ...
    enum Connection11Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE92_L: // Intra-location logic for state l
