...
void Connection12Synapse91Run(Connection12Synapse91* me) {
    ...
    enum Connection12Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE91_L: // Intra-location logic for state l
