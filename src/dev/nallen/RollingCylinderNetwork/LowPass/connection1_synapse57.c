...
void Connection1Synapse57Run(Connection1Synapse57* me) {
    ...
    enum Connection1Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE57_L: // Intra-location logic for state l
