...
void Connection12Synapse98Run(Connection12Synapse98* me) {
    ...
    enum Connection12Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE98_L: // Intra-location logic for state l
