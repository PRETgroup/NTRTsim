...
void Connection2Synapse46Run(Connection2Synapse46* me) {
    ...
    enum Connection2Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE46_L: // Intra-location logic for state l
