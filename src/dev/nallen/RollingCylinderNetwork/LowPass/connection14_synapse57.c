...
void Connection14Synapse57Run(Connection14Synapse57* me) {
    ...
    enum Connection14Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE57_L: // Intra-location logic for state l
