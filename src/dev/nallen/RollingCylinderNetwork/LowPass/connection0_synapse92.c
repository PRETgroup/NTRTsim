...
void Connection0Synapse92Run(Connection0Synapse92* me) {
    ...
    enum Connection0Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE92_L: // Intra-location logic for state l
