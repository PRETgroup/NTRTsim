...
void Connection14Synapse96Run(Connection14Synapse96* me) {
    ...
    enum Connection14Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE96_L: // Intra-location logic for state l
