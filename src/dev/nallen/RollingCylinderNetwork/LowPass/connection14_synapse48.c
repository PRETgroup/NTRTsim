...
void Connection14Synapse48Run(Connection14Synapse48* me) {
    ...
    enum Connection14Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE48_L: // Intra-location logic for state l
