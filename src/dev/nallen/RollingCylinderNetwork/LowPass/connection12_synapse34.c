...
void Connection12Synapse34Run(Connection12Synapse34* me) {
    ...
    enum Connection12Synapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE34_L: // Intra-location logic for state l
