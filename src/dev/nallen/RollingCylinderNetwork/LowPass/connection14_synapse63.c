...
void Connection14Synapse63Run(Connection14Synapse63* me) {
    ...
    enum Connection14Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE63_L: // Intra-location logic for state l
