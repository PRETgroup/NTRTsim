...
void Connection0Synapse82Run(Connection0Synapse82* me) {
    ...
    enum Connection0Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE82_L: // Intra-location logic for state l
