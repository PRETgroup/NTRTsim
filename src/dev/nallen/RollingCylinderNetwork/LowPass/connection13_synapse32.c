...
void Connection13Synapse32Run(Connection13Synapse32* me) {
    ...
    enum Connection13Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE32_L: // Intra-location logic for state l
