...
void Connection14Synapse90Run(Connection14Synapse90* me) {
    ...
    enum Connection14Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE90_L: // Intra-location logic for state l
