...
void Connection14Synapse22Run(Connection14Synapse22* me) {
    ...
    enum Connection14Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE22_L: // Intra-location logic for state l
