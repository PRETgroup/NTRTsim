...
void Connection12Synapse84Run(Connection12Synapse84* me) {
    ...
    enum Connection12Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE84_L: // Intra-location logic for state l
