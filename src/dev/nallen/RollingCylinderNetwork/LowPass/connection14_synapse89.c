...
void Connection14Synapse89Run(Connection14Synapse89* me) {
    ...
    enum Connection14Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE89_L: // Intra-location logic for state l
