...
void Connection11Synapse33Run(Connection11Synapse33* me) {
    ...
    enum Connection11Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE33_L: // Intra-location logic for state l
