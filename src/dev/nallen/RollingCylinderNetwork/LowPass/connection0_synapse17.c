...
void Connection0Synapse17Run(Connection0Synapse17* me) {
    ...
    enum Connection0Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE17_L: // Intra-location logic for state l
