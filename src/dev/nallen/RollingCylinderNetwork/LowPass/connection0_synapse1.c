...
void Connection0Synapse1Run(Connection0Synapse1* me) {
    ...
    enum Connection0Synapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE1_L: // Intra-location logic for state l
