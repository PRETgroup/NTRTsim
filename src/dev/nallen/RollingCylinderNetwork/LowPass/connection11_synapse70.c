...
void Connection11Synapse70Run(Connection11Synapse70* me) {
    ...
    enum Connection11Synapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE70_L: // Intra-location logic for state l
