...
void Connection12Synapse35Run(Connection12Synapse35* me) {
    ...
    enum Connection12Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE35_L: // Intra-location logic for state l
