...
void Connection6Synapse77Run(Connection6Synapse77* me) {
    ...
    enum Connection6Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE77_L: // Intra-location logic for state l
