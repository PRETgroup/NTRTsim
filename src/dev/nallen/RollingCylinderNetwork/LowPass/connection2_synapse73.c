...
void Connection2Synapse73Run(Connection2Synapse73* me) {
    ...
    enum Connection2Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE73_L: // Intra-location logic for state l
