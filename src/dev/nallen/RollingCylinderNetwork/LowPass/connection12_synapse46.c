...
void Connection12Synapse46Run(Connection12Synapse46* me) {
    ...
    enum Connection12Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE46_L: // Intra-location logic for state l
