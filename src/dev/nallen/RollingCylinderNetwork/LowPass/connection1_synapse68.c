...
void Connection1Synapse68Run(Connection1Synapse68* me) {
    ...
    enum Connection1Synapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE68_L: // Intra-location logic for state l
