...
void Connection14Synapse86Run(Connection14Synapse86* me) {
    ...
    enum Connection14Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE86_L: // Intra-location logic for state l
