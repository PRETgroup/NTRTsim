...
void Connection6Synapse95Run(Connection6Synapse95* me) {
    ...
    enum Connection6Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE95_L: // Intra-location logic for state l
