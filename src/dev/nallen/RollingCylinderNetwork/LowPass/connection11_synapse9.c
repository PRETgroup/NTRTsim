...
void Connection11Synapse9Run(Connection11Synapse9* me) {
    ...
    enum Connection11Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE9_L: // Intra-location logic for state l
