...
void Connection2Synapse95Run(Connection2Synapse95* me) {
    ...
    enum Connection2Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE95_L: // Intra-location logic for state l
