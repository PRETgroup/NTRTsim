...
void Connection1Synapse0Run(Connection1Synapse0* me) {
    ...
    enum Connection1Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE0_L: // Intra-location logic for state l
