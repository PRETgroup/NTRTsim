...
void Connection14Synapse66Run(Connection14Synapse66* me) {
    ...
    enum Connection14Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE66_L: // Intra-location logic for state l
