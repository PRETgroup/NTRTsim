...
void Connection0Synapse89Run(Connection0Synapse89* me) {
    ...
    enum Connection0Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE89_L: // Intra-location logic for state l
