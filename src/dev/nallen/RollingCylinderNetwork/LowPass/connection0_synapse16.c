...
void Connection0Synapse16Run(Connection0Synapse16* me) {
    ...
    enum Connection0Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE16_L: // Intra-location logic for state l
