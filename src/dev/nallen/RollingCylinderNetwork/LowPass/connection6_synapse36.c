...
void Connection6Synapse36Run(Connection6Synapse36* me) {
    ...
    enum Connection6Synapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE36_L: // Intra-location logic for state l
