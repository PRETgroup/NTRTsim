...
void Connection13Synapse91Run(Connection13Synapse91* me) {
    ...
    enum Connection13Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE91_L: // Intra-location logic for state l
