...
void Connection13Synapse81Run(Connection13Synapse81* me) {
    ...
    enum Connection13Synapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE81_L: // Intra-location logic for state l
