...
void Connection14Synapse51Run(Connection14Synapse51* me) {
    ...
    enum Connection14Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE51_L: // Intra-location logic for state l
