...
void Connection1Synapse38Run(Connection1Synapse38* me) {
    ...
    enum Connection1Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE38_L: // Intra-location logic for state l
