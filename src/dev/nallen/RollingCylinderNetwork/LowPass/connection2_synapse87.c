...
void Connection2Synapse87Run(Connection2Synapse87* me) {
    ...
    enum Connection2Synapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE87_L: // Intra-location logic for state l
