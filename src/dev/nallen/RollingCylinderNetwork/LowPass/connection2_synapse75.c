...
void Connection2Synapse75Run(Connection2Synapse75* me) {
    ...
    enum Connection2Synapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE75_L: // Intra-location logic for state l
