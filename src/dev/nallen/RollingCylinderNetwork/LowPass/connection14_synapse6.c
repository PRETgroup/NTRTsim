...
void Connection14Synapse6Run(Connection14Synapse6* me) {
    ...
    enum Connection14Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE6_L: // Intra-location logic for state l
