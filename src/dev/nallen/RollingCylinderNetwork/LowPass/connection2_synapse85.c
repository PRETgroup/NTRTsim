...
void Connection2Synapse85Run(Connection2Synapse85* me) {
    ...
    enum Connection2Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE85_L: // Intra-location logic for state l
