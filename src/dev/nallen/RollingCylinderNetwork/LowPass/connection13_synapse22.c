...
void Connection13Synapse22Run(Connection13Synapse22* me) {
    ...
    enum Connection13Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE22_L: // Intra-location logic for state l
