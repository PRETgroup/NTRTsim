...
void Connection14Synapse60Run(Connection14Synapse60* me) {
    ...
    enum Connection14Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE60_L: // Intra-location logic for state l
