...
void Connection12Synapse59Run(Connection12Synapse59* me) {
    ...
    enum Connection12Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE59_L: // Intra-location logic for state l
