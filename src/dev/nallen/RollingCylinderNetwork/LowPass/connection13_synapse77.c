...
void Connection13Synapse77Run(Connection13Synapse77* me) {
    ...
    enum Connection13Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE77_L: // Intra-location logic for state l
