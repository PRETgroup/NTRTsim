...
void Connection13Synapse3Run(Connection13Synapse3* me) {
    ...
    enum Connection13Synapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE3_L: // Intra-location logic for state l
