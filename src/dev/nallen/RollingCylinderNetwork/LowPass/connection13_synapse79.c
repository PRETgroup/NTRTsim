...
void Connection13Synapse79Run(Connection13Synapse79* me) {
    ...
    enum Connection13Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE79_L: // Intra-location logic for state l
