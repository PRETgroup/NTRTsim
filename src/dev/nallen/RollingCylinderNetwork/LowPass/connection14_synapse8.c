...
void Connection14Synapse8Run(Connection14Synapse8* me) {
    ...
    enum Connection14Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE8_L: // Intra-location logic for state l
