...
void Connection12Synapse96Run(Connection12Synapse96* me) {
    ...
    enum Connection12Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE96_L: // Intra-location logic for state l
