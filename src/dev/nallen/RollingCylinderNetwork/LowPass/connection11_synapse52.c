...
void Connection11Synapse52Run(Connection11Synapse52* me) {
    ...
    enum Connection11Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE52_L: // Intra-location logic for state l
