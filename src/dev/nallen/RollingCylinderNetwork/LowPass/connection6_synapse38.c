...
void Connection6Synapse38Run(Connection6Synapse38* me) {
    ...
    enum Connection6Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE38_L: // Intra-location logic for state l
