...
void Connection11Synapse17Run(Connection11Synapse17* me) {
    ...
    enum Connection11Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE17_L: // Intra-location logic for state l
