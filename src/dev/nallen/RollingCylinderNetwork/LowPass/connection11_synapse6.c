...
void Connection11Synapse6Run(Connection11Synapse6* me) {
    ...
    enum Connection11Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE6_L: // Intra-location logic for state l
