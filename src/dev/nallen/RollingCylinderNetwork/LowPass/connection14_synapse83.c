...
void Connection14Synapse83Run(Connection14Synapse83* me) {
    ...
    enum Connection14Synapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE83_L: // Intra-location logic for state l
