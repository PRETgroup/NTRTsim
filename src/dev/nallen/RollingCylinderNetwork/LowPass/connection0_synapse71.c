...
void Connection0Synapse71Run(Connection0Synapse71* me) {
    ...
    enum Connection0Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE71_L: // Intra-location logic for state l
