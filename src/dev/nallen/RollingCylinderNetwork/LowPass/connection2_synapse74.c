...
void Connection2Synapse74Run(Connection2Synapse74* me) {
    ...
    enum Connection2Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE74_L: // Intra-location logic for state l
