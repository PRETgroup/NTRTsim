...
void Connection11Synapse16Run(Connection11Synapse16* me) {
    ...
    enum Connection11Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE16_L: // Intra-location logic for state l
