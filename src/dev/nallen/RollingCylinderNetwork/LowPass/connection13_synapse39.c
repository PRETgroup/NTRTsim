...
void Connection13Synapse39Run(Connection13Synapse39* me) {
    ...
    enum Connection13Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE39_L: // Intra-location logic for state l
