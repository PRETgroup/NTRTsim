...
void Connection0Synapse64Run(Connection0Synapse64* me) {
    ...
    enum Connection0Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE64_L: // Intra-location logic for state l
