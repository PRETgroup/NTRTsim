...
void Connection0Synapse90Run(Connection0Synapse90* me) {
    ...
    enum Connection0Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE90_L: // Intra-location logic for state l
