...
void Connection6Synapse90Run(Connection6Synapse90* me) {
    ...
    enum Connection6Synapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE90_L: // Intra-location logic for state l
