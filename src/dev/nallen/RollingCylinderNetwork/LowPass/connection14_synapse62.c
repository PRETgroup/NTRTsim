...
void Connection14Synapse62Run(Connection14Synapse62* me) {
    ...
    enum Connection14Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE62_L: // Intra-location logic for state l
