...
void Connection1Synapse56Run(Connection1Synapse56* me) {
    ...
    enum Connection1Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE56_L: // Intra-location logic for state l
