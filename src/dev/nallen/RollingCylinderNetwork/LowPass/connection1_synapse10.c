...
void Connection1Synapse10Run(Connection1Synapse10* me) {
    ...
    enum Connection1Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE10_L: // Intra-location logic for state l
