...
void Connection11Synapse82Run(Connection11Synapse82* me) {
    ...
    enum Connection11Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE82_L: // Intra-location logic for state l
