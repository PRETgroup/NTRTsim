...
void Connection12Synapse22Run(Connection12Synapse22* me) {
    ...
    enum Connection12Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE22_L: // Intra-location logic for state l
