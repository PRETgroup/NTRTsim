...
void Connection11Synapse60Run(Connection11Synapse60* me) {
    ...
    enum Connection11Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE60_L: // Intra-location logic for state l
