...
void Connection1Synapse14Run(Connection1Synapse14* me) {
    ...
    enum Connection1Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE14_L: // Intra-location logic for state l
