...
void Connection2Synapse78Run(Connection2Synapse78* me) {
    ...
    enum Connection2Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE78_L: // Intra-location logic for state l
