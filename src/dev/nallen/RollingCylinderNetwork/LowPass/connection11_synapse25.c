...
void Connection11Synapse25Run(Connection11Synapse25* me) {
    ...
    enum Connection11Synapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE25_L: // Intra-location logic for state l
