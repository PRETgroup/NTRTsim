...
void Connection14Synapse99Run(Connection14Synapse99* me) {
    ...
    enum Connection14Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE99_L: // Intra-location logic for state l
