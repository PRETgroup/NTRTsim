...
void Connection1Synapse43Run(Connection1Synapse43* me) {
    ...
    enum Connection1Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE43_L: // Intra-location logic for state l
