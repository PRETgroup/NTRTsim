...
void Connection2Synapse99Run(Connection2Synapse99* me) {
    ...
    enum Connection2Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE99_L: // Intra-location logic for state l
