...
void Connection2Synapse58Run(Connection2Synapse58* me) {
    ...
    enum Connection2Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE58_L: // Intra-location logic for state l
