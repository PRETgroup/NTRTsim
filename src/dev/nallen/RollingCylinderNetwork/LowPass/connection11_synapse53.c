...
void Connection11Synapse53Run(Connection11Synapse53* me) {
    ...
    enum Connection11Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE53_L: // Intra-location logic for state l
