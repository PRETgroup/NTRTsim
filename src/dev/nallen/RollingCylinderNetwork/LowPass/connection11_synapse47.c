...
void Connection11Synapse47Run(Connection11Synapse47* me) {
    ...
    enum Connection11Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE47_L: // Intra-location logic for state l
