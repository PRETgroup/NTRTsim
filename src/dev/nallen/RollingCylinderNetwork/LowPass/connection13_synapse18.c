...
void Connection13Synapse18Run(Connection13Synapse18* me) {
    ...
    enum Connection13Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE18_L: // Intra-location logic for state l
