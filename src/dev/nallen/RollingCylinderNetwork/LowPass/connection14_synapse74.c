...
void Connection14Synapse74Run(Connection14Synapse74* me) {
    ...
    enum Connection14Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE74_L: // Intra-location logic for state l
