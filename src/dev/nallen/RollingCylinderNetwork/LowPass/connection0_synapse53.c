...
void Connection0Synapse53Run(Connection0Synapse53* me) {
    ...
    enum Connection0Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE53_L: // Intra-location logic for state l
