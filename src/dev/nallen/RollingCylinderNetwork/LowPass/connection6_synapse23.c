...
void Connection6Synapse23Run(Connection6Synapse23* me) {
    ...
    enum Connection6Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE23_L: // Intra-location logic for state l
