...
void Connection14Synapse40Run(Connection14Synapse40* me) {
    ...
    enum Connection14Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE40_L: // Intra-location logic for state l
