...
void Connection0Synapse52Run(Connection0Synapse52* me) {
    ...
    enum Connection0Synapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE52_L: // Intra-location logic for state l
