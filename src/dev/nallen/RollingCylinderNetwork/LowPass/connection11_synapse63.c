...
void Connection11Synapse63Run(Connection11Synapse63* me) {
    ...
    enum Connection11Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE63_L: // Intra-location logic for state l
