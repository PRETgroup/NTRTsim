...
void Connection13Synapse26Run(Connection13Synapse26* me) {
    ...
    enum Connection13Synapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE26_L: // Intra-location logic for state l
