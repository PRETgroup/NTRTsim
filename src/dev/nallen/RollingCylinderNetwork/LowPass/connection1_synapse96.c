...
void Connection1Synapse96Run(Connection1Synapse96* me) {
    ...
    enum Connection1Synapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE96_L: // Intra-location logic for state l
