...
void Connection1Synapse20Run(Connection1Synapse20* me) {
    ...
    enum Connection1Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE20_L: // Intra-location logic for state l
