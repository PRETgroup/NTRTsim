...
void Connection12Synapse25Run(Connection12Synapse25* me) {
    ...
    enum Connection12Synapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE25_L: // Intra-location logic for state l
