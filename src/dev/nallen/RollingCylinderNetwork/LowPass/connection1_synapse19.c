...
void Connection1Synapse19Run(Connection1Synapse19* me) {
    ...
    enum Connection1Synapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE19_L: // Intra-location logic for state l
