...
void Connection1Synapse99Run(Connection1Synapse99* me) {
    ...
    enum Connection1Synapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE99_L: // Intra-location logic for state l
