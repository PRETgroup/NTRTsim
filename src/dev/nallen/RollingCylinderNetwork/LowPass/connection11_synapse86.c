...
void Connection11Synapse86Run(Connection11Synapse86* me) {
    ...
    enum Connection11Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE86_L: // Intra-location logic for state l
