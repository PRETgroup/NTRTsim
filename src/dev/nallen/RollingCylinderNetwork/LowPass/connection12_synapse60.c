...
void Connection12Synapse60Run(Connection12Synapse60* me) {
    ...
    enum Connection12Synapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE60_L: // Intra-location logic for state l
