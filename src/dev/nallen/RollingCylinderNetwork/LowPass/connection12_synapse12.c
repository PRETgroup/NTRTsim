...
void Connection12Synapse12Run(Connection12Synapse12* me) {
    ...
    enum Connection12Synapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE12_L: // Intra-location logic for state l
