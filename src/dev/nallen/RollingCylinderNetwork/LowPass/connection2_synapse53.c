...
void Connection2Synapse53Run(Connection2Synapse53* me) {
    ...
    enum Connection2Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE53_L: // Intra-location logic for state l
