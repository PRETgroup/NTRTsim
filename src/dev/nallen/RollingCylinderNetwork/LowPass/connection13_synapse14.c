...
void Connection13Synapse14Run(Connection13Synapse14* me) {
    ...
    enum Connection13Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE14_L: // Intra-location logic for state l
