...
void Connection2Synapse29Run(Connection2Synapse29* me) {
    ...
    enum Connection2Synapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE29_L: // Intra-location logic for state l
