...
void Connection0Synapse33Run(Connection0Synapse33* me) {
    ...
    enum Connection0Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE33_L: // Intra-location logic for state l
