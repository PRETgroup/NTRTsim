...
void Connection14Synapse56Run(Connection14Synapse56* me) {
    ...
    enum Connection14Synapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE56_L: // Intra-location logic for state l
