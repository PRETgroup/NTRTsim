...
void Connection12Synapse3Run(Connection12Synapse3* me) {
    ...
    enum Connection12Synapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE3_L: // Intra-location logic for state l
