...
void Connection13Synapse57Run(Connection13Synapse57* me) {
    ...
    enum Connection13Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE57_L: // Intra-location logic for state l
