...
void Connection8Synapse0Run(Connection8Synapse0* me) {
    ...
    enum Connection8Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION8_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION8_SYNAPSE0_L: // Intra-location logic for state l
