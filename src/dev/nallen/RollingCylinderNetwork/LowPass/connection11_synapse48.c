...
void Connection11Synapse48Run(Connection11Synapse48* me) {
    ...
    enum Connection11Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE48_L: // Intra-location logic for state l
