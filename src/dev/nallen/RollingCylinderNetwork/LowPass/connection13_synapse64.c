...
void Connection13Synapse64Run(Connection13Synapse64* me) {
    ...
    enum Connection13Synapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE64_L: // Intra-location logic for state l
