...
void Connection13Synapse42Run(Connection13Synapse42* me) {
    ...
    enum Connection13Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE42_L: // Intra-location logic for state l
