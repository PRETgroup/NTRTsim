...
void Connection6Synapse20Run(Connection6Synapse20* me) {
    ...
    enum Connection6Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE20_L: // Intra-location logic for state l
