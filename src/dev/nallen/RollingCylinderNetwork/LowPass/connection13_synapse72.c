...
void Connection13Synapse72Run(Connection13Synapse72* me) {
    ...
    enum Connection13Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE72_L: // Intra-location logic for state l
