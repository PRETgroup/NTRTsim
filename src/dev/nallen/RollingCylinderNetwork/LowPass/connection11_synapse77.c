...
void Connection11Synapse77Run(Connection11Synapse77* me) {
    ...
    enum Connection11Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE77_L: // Intra-location logic for state l
