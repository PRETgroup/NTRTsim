...
void Connection0Synapse61Run(Connection0Synapse61* me) {
    ...
    enum Connection0Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE61_L: // Intra-location logic for state l
