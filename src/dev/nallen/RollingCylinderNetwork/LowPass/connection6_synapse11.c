...
void Connection6Synapse11Run(Connection6Synapse11* me) {
    ...
    enum Connection6Synapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE11_L: // Intra-location logic for state l
