...
void Connection2Synapse48Run(Connection2Synapse48* me) {
    ...
    enum Connection2Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE48_L: // Intra-location logic for state l
