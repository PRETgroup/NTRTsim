...
void Connection11Synapse23Run(Connection11Synapse23* me) {
    ...
    enum Connection11Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE23_L: // Intra-location logic for state l
