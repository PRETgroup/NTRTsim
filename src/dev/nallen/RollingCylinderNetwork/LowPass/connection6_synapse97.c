...
void Connection6Synapse97Run(Connection6Synapse97* me) {
    ...
    enum Connection6Synapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE97_L: // Intra-location logic for state l
