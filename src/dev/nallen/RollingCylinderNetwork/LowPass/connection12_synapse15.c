...
void Connection12Synapse15Run(Connection12Synapse15* me) {
    ...
    enum Connection12Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE15_L: // Intra-location logic for state l
