...
void Connection14Synapse9Run(Connection14Synapse9* me) {
    ...
    enum Connection14Synapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE9_L: // Intra-location logic for state l
