...
void Connection6Synapse8Run(Connection6Synapse8* me) {
    ...
    enum Connection6Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE8_L: // Intra-location logic for state l
