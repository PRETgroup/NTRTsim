...
void Connection1Synapse16Run(Connection1Synapse16* me) {
    ...
    enum Connection1Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE16_L: // Intra-location logic for state l
