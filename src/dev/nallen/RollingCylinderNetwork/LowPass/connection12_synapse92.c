...
void Connection12Synapse92Run(Connection12Synapse92* me) {
    ...
    enum Connection12Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE92_L: // Intra-location logic for state l
