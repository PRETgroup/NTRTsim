...
void Connection1Synapse79Run(Connection1Synapse79* me) {
    ...
    enum Connection1Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE79_L: // Intra-location logic for state l
