...
void Connection1Synapse1Run(Connection1Synapse1* me) {
    ...
    enum Connection1Synapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE1_L: // Intra-location logic for state l
