...
void Connection0Synapse30Run(Connection0Synapse30* me) {
    ...
    enum Connection0Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE30_L: // Intra-location logic for state l
