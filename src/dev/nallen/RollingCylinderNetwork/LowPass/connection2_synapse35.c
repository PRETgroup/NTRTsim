...
void Connection2Synapse35Run(Connection2Synapse35* me) {
    ...
    enum Connection2Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE35_L: // Intra-location logic for state l
