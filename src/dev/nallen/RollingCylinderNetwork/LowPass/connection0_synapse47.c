...
void Connection0Synapse47Run(Connection0Synapse47* me) {
    ...
    enum Connection0Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE47_L: // Intra-location logic for state l
