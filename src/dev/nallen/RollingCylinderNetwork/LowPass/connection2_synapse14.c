...
void Connection2Synapse14Run(Connection2Synapse14* me) {
    ...
    enum Connection2Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE14_L: // Intra-location logic for state l
