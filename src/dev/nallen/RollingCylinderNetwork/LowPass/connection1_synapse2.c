...
void Connection1Synapse2Run(Connection1Synapse2* me) {
    ...
    enum Connection1Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE2_L: // Intra-location logic for state l
