...
void Connection2Synapse19Run(Connection2Synapse19* me) {
    ...
    enum Connection2Synapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE19_L: // Intra-location logic for state l
