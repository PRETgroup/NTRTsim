...
void Connection13Synapse4Run(Connection13Synapse4* me) {
    ...
    enum Connection13Synapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE4_L: // Intra-location logic for state l
