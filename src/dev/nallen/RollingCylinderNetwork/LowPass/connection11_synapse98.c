...
void Connection11Synapse98Run(Connection11Synapse98* me) {
    ...
    enum Connection11Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE98_L: // Intra-location logic for state l
