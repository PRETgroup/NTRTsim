...
void Connection2Synapse33Run(Connection2Synapse33* me) {
    ...
    enum Connection2Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE33_L: // Intra-location logic for state l
