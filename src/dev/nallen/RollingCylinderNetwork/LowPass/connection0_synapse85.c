...
void Connection0Synapse85Run(Connection0Synapse85* me) {
    ...
    enum Connection0Synapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE85_L: // Intra-location logic for state l
