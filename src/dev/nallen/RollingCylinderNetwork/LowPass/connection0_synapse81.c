...
void Connection0Synapse81Run(Connection0Synapse81* me) {
    ...
    enum Connection0Synapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE81_L: // Intra-location logic for state l
