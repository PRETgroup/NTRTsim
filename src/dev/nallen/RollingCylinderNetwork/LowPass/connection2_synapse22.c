...
void Connection2Synapse22Run(Connection2Synapse22* me) {
    ...
    enum Connection2Synapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE22_L: // Intra-location logic for state l
