...
void Connection12Synapse36Run(Connection12Synapse36* me) {
    ...
    enum Connection12Synapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE36_L: // Intra-location logic for state l
