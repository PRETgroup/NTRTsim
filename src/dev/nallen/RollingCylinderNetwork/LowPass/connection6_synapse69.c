...
void Connection6Synapse69Run(Connection6Synapse69* me) {
    ...
    enum Connection6Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE69_L: // Intra-location logic for state l
