...
void Connection2Synapse30Run(Connection2Synapse30* me) {
    ...
    enum Connection2Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE30_L: // Intra-location logic for state l
