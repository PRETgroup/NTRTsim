...
void Connection12Synapse77Run(Connection12Synapse77* me) {
    ...
    enum Connection12Synapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE77_L: // Intra-location logic for state l
