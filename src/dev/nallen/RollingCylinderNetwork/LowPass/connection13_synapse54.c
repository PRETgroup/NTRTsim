...
void Connection13Synapse54Run(Connection13Synapse54* me) {
    ...
    enum Connection13Synapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE54_L: // Intra-location logic for state l
