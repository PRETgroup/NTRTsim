...
void Connection1Synapse81Run(Connection1Synapse81* me) {
    ...
    enum Connection1Synapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE81_L: // Intra-location logic for state l
