...
void Connection13Synapse1Run(Connection13Synapse1* me) {
    ...
    enum Connection13Synapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE1_L: // Intra-location logic for state l
