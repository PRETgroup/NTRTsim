...
void Connection1Synapse61Run(Connection1Synapse61* me) {
    ...
    enum Connection1Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE61_L: // Intra-location logic for state l
