...
void Connection11Synapse7Run(Connection11Synapse7* me) {
    ...
    enum Connection11Synapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE7_L: // Intra-location logic for state l
