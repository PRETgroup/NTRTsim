...
void Connection11Synapse18Run(Connection11Synapse18* me) {
    ...
    enum Connection11Synapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE18_L: // Intra-location logic for state l
