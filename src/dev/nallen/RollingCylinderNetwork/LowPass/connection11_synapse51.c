...
void Connection11Synapse51Run(Connection11Synapse51* me) {
    ...
    enum Connection11Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE51_L: // Intra-location logic for state l
