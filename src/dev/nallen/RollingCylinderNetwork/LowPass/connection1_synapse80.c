...
void Connection1Synapse80Run(Connection1Synapse80* me) {
    ...
    enum Connection1Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE80_L: // Intra-location logic for state l
