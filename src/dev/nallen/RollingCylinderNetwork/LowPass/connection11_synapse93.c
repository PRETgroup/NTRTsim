...
void Connection11Synapse93Run(Connection11Synapse93* me) {
    ...
    enum Connection11Synapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE93_L: // Intra-location logic for state l
