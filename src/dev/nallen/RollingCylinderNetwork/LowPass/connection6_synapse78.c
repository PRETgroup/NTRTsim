...
void Connection6Synapse78Run(Connection6Synapse78* me) {
    ...
    enum Connection6Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE78_L: // Intra-location logic for state l
