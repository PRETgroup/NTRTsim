...
void Connection6Synapse92Run(Connection6Synapse92* me) {
    ...
    enum Connection6Synapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE92_L: // Intra-location logic for state l
