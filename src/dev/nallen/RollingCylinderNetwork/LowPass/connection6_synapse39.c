...
void Connection6Synapse39Run(Connection6Synapse39* me) {
    ...
    enum Connection6Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE39_L: // Intra-location logic for state l
