...
void Connection11Synapse72Run(Connection11Synapse72* me) {
    ...
    enum Connection11Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE72_L: // Intra-location logic for state l
