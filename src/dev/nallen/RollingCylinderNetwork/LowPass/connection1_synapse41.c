...
void Connection1Synapse41Run(Connection1Synapse41* me) {
    ...
    enum Connection1Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE41_L: // Intra-location logic for state l
