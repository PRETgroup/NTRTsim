...
void Connection1Synapse15Run(Connection1Synapse15* me) {
    ...
    enum Connection1Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE15_L: // Intra-location logic for state l
