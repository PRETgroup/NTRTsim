...
void Connection12Synapse68Run(Connection12Synapse68* me) {
    ...
    enum Connection12Synapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE68_L: // Intra-location logic for state l
