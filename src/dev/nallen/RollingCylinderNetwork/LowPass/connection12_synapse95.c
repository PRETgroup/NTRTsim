...
void Connection12Synapse95Run(Connection12Synapse95* me) {
    ...
    enum Connection12Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE95_L: // Intra-location logic for state l
