...
void Connection1Synapse98Run(Connection1Synapse98* me) {
    ...
    enum Connection1Synapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE98_L: // Intra-location logic for state l
