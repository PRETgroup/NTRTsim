...
void Connection14Synapse82Run(Connection14Synapse82* me) {
    ...
    enum Connection14Synapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE82_L: // Intra-location logic for state l
