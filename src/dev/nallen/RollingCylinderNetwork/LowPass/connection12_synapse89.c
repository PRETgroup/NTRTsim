...
void Connection12Synapse89Run(Connection12Synapse89* me) {
    ...
    enum Connection12Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE89_L: // Intra-location logic for state l
