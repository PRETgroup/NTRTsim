...
void Connection13Synapse46Run(Connection13Synapse46* me) {
    ...
    enum Connection13Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE46_L: // Intra-location logic for state l
