...
void Connection0Synapse21Run(Connection0Synapse21* me) {
    ...
    enum Connection0Synapse21States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE21_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE21_L: // Intra-location logic for state l
