...
void Connection11Synapse37Run(Connection11Synapse37* me) {
    ...
    enum Connection11Synapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE37_L: // Intra-location logic for state l
