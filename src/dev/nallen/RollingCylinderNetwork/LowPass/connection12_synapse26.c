...
void Connection12Synapse26Run(Connection12Synapse26* me) {
    ...
    enum Connection12Synapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE26_L: // Intra-location logic for state l
