...
void Connection12Synapse80Run(Connection12Synapse80* me) {
    ...
    enum Connection12Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE80_L: // Intra-location logic for state l
