...
void Connection14Synapse53Run(Connection14Synapse53* me) {
    ...
    enum Connection14Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE53_L: // Intra-location logic for state l
