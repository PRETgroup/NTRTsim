...
void Connection6Synapse33Run(Connection6Synapse33* me) {
    ...
    enum Connection6Synapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE33_L: // Intra-location logic for state l
