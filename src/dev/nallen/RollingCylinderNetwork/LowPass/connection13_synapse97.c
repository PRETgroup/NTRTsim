...
void Connection13Synapse97Run(Connection13Synapse97* me) {
    ...
    enum Connection13Synapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE97_L: // Intra-location logic for state l
