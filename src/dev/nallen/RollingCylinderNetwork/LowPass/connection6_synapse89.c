...
void Connection6Synapse89Run(Connection6Synapse89* me) {
    ...
    enum Connection6Synapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE89_L: // Intra-location logic for state l
