...
void Connection11Synapse40Run(Connection11Synapse40* me) {
    ...
    enum Connection11Synapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE40_L: // Intra-location logic for state l
