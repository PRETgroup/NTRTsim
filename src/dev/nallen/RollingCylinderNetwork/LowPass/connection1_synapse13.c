...
void Connection1Synapse13Run(Connection1Synapse13* me) {
    ...
    enum Connection1Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE13_L: // Intra-location logic for state l
