...
void Connection6Synapse50Run(Connection6Synapse50* me) {
    ...
    enum Connection6Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE50_L: // Intra-location logic for state l
