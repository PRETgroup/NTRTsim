...
void Connection0Synapse5Run(Connection0Synapse5* me) {
    ...
    enum Connection0Synapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE5_L: // Intra-location logic for state l
