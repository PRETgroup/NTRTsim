...
void Connection0Synapse74Run(Connection0Synapse74* me) {
    ...
    enum Connection0Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE74_L: // Intra-location logic for state l
