...
void Connection6Synapse91Run(Connection6Synapse91* me) {
    ...
    enum Connection6Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE91_L: // Intra-location logic for state l
