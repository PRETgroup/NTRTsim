...
void Connection0Synapse2Run(Connection0Synapse2* me) {
    ...
    enum Connection0Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE2_L: // Intra-location logic for state l
