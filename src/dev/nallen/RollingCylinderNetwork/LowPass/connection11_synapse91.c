...
void Connection11Synapse91Run(Connection11Synapse91* me) {
    ...
    enum Connection11Synapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE91_L: // Intra-location logic for state l
