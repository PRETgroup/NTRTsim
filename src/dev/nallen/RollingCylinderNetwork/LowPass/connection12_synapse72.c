...
void Connection12Synapse72Run(Connection12Synapse72* me) {
    ...
    enum Connection12Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE72_L: // Intra-location logic for state l
