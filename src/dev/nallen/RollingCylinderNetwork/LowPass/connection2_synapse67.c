...
void Connection2Synapse67Run(Connection2Synapse67* me) {
    ...
    enum Connection2Synapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE67_L: // Intra-location logic for state l
