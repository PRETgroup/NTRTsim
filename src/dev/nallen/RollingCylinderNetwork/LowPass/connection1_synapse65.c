...
void Connection1Synapse65Run(Connection1Synapse65* me) {
    ...
    enum Connection1Synapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE65_L: // Intra-location logic for state l
