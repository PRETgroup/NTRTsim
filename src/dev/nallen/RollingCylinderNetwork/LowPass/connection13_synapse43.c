...
void Connection13Synapse43Run(Connection13Synapse43* me) {
    ...
    enum Connection13Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE43_L: // Intra-location logic for state l
