...
void Connection13Synapse80Run(Connection13Synapse80* me) {
    ...
    enum Connection13Synapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE80_L: // Intra-location logic for state l
