...
void Connection1Synapse70Run(Connection1Synapse70* me) {
    ...
    enum Connection1Synapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE70_L: // Intra-location logic for state l
