...
void Connection6Synapse51Run(Connection6Synapse51* me) {
    ...
    enum Connection6Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE51_L: // Intra-location logic for state l
