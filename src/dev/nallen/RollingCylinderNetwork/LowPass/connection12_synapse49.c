...
void Connection12Synapse49Run(Connection12Synapse49* me) {
    ...
    enum Connection12Synapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE49_L: // Intra-location logic for state l
