...
void Connection13Synapse59Run(Connection13Synapse59* me) {
    ...
    enum Connection13Synapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE59_L: // Intra-location logic for state l
