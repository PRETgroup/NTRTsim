...
void Connection14Synapse47Run(Connection14Synapse47* me) {
    ...
    enum Connection14Synapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE47_L: // Intra-location logic for state l
