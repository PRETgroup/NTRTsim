...
void Connection11Synapse15Run(Connection11Synapse15* me) {
    ...
    enum Connection11Synapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE15_L: // Intra-location logic for state l
