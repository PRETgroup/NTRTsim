...
void Connection11Synapse69Run(Connection11Synapse69* me) {
    ...
    enum Connection11Synapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE69_L: // Intra-location logic for state l
