...
void Connection11Synapse5Run(Connection11Synapse5* me) {
    ...
    enum Connection11Synapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE5_L: // Intra-location logic for state l
