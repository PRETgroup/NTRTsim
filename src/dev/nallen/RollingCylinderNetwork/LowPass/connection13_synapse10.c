...
void Connection13Synapse10Run(Connection13Synapse10* me) {
    ...
    enum Connection13Synapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE10_L: // Intra-location logic for state l
