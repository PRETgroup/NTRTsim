...
void Connection13Synapse23Run(Connection13Synapse23* me) {
    ...
    enum Connection13Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE23_L: // Intra-location logic for state l
