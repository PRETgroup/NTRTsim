...
void Connection2Synapse44Run(Connection2Synapse44* me) {
    ...
    enum Connection2Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE44_L: // Intra-location logic for state l
