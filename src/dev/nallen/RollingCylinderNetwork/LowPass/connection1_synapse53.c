...
void Connection1Synapse53Run(Connection1Synapse53* me) {
    ...
    enum Connection1Synapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE53_L: // Intra-location logic for state l
