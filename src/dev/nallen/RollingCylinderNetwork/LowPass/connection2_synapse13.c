...
void Connection2Synapse13Run(Connection2Synapse13* me) {
    ...
    enum Connection2Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE13_L: // Intra-location logic for state l
