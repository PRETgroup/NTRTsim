...
void Connection6Synapse32Run(Connection6Synapse32* me) {
    ...
    enum Connection6Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE32_L: // Intra-location logic for state l
