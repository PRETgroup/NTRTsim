...
void Connection11Synapse84Run(Connection11Synapse84* me) {
    ...
    enum Connection11Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE84_L: // Intra-location logic for state l
