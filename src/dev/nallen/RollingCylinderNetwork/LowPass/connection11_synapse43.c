...
void Connection11Synapse43Run(Connection11Synapse43* me) {
    ...
    enum Connection11Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE43_L: // Intra-location logic for state l
