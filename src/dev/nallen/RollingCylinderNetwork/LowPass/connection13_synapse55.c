...
void Connection13Synapse55Run(Connection13Synapse55* me) {
    ...
    enum Connection13Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE55_L: // Intra-location logic for state l
