...
void Connection11Synapse57Run(Connection11Synapse57* me) {
    ...
    enum Connection11Synapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE57_L: // Intra-location logic for state l
