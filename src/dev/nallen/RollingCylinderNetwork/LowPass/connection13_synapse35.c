...
void Connection13Synapse35Run(Connection13Synapse35* me) {
    ...
    enum Connection13Synapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE35_L: // Intra-location logic for state l
