...
void Connection13Synapse50Run(Connection13Synapse50* me) {
    ...
    enum Connection13Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE50_L: // Intra-location logic for state l
