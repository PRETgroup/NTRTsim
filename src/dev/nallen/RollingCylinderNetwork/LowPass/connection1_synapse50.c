...
void Connection1Synapse50Run(Connection1Synapse50* me) {
    ...
    enum Connection1Synapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE50_L: // Intra-location logic for state l
