...
void Connection14Synapse72Run(Connection14Synapse72* me) {
    ...
    enum Connection14Synapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE72_L: // Intra-location logic for state l
