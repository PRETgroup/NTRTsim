...
void Connection12Synapse70Run(Connection12Synapse70* me) {
    ...
    enum Connection12Synapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE70_L: // Intra-location logic for state l
