...
void Connection12Synapse39Run(Connection12Synapse39* me) {
    ...
    enum Connection12Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE39_L: // Intra-location logic for state l
