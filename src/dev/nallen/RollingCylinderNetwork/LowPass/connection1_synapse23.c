...
void Connection1Synapse23Run(Connection1Synapse23* me) {
    ...
    enum Connection1Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE23_L: // Intra-location logic for state l
