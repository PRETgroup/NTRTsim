...
void Connection11Synapse41Run(Connection11Synapse41* me) {
    ...
    enum Connection11Synapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE41_L: // Intra-location logic for state l
