...
void Connection2Synapse63Run(Connection2Synapse63* me) {
    ...
    enum Connection2Synapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE63_L: // Intra-location logic for state l
