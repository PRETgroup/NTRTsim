...
void Connection2Synapse16Run(Connection2Synapse16* me) {
    ...
    enum Connection2Synapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE16_L: // Intra-location logic for state l
