...
void Connection6Synapse48Run(Connection6Synapse48* me) {
    ...
    enum Connection6Synapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE48_L: // Intra-location logic for state l
