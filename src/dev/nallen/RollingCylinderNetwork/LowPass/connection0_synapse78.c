...
void Connection0Synapse78Run(Connection0Synapse78* me) {
    ...
    enum Connection0Synapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE78_L: // Intra-location logic for state l
