...
void Connection12Synapse61Run(Connection12Synapse61* me) {
    ...
    enum Connection12Synapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE61_L: // Intra-location logic for state l
