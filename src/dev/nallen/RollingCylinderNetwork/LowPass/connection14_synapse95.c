...
void Connection14Synapse95Run(Connection14Synapse95* me) {
    ...
    enum Connection14Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE95_L: // Intra-location logic for state l
