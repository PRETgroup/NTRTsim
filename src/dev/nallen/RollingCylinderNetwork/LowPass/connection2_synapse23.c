...
void Connection2Synapse23Run(Connection2Synapse23* me) {
    ...
    enum Connection2Synapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE23_L: // Intra-location logic for state l
