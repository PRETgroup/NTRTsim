...
void Connection0Synapse58Run(Connection0Synapse58* me) {
    ...
    enum Connection0Synapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE58_L: // Intra-location logic for state l
