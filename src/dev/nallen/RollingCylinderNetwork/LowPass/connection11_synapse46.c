...
void Connection11Synapse46Run(Connection11Synapse46* me) {
    ...
    enum Connection11Synapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE46_L: // Intra-location logic for state l
