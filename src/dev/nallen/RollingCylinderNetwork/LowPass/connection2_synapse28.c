...
void Connection2Synapse28Run(Connection2Synapse28* me) {
    ...
    enum Connection2Synapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE28_L: // Intra-location logic for state l
