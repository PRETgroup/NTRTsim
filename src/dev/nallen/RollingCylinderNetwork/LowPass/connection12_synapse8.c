...
void Connection12Synapse8Run(Connection12Synapse8* me) {
    ...
    enum Connection12Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE8_L: // Intra-location logic for state l
