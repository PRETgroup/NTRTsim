...
void Connection1Synapse71Run(Connection1Synapse71* me) {
    ...
    enum Connection1Synapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE71_L: // Intra-location logic for state l
