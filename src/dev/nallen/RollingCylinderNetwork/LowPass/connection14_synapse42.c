...
void Connection14Synapse42Run(Connection14Synapse42* me) {
    ...
    enum Connection14Synapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE42_L: // Intra-location logic for state l
