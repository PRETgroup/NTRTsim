...
void Connection1Synapse32Run(Connection1Synapse32* me) {
    ...
    enum Connection1Synapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE32_L: // Intra-location logic for state l
