...
void Connection1Synapse88Run(Connection1Synapse88* me) {
    ...
    enum Connection1Synapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE88_L: // Intra-location logic for state l
