...
void Connection14Synapse44Run(Connection14Synapse44* me) {
    ...
    enum Connection14Synapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE44_L: // Intra-location logic for state l
