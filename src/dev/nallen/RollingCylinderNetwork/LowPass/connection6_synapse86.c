...
void Connection6Synapse86Run(Connection6Synapse86* me) {
    ...
    enum Connection6Synapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE86_L: // Intra-location logic for state l
