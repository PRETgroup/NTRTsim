...
void Connection14Synapse55Run(Connection14Synapse55* me) {
    ...
    enum Connection14Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE55_L: // Intra-location logic for state l
