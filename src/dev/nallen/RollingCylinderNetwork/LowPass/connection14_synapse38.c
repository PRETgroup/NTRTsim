...
void Connection14Synapse38Run(Connection14Synapse38* me) {
    ...
    enum Connection14Synapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE38_L: // Intra-location logic for state l
