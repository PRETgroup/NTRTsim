...
void Connection11Synapse62Run(Connection11Synapse62* me) {
    ...
    enum Connection11Synapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE62_L: // Intra-location logic for state l
