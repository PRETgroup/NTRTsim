...
void Connection12Synapse14Run(Connection12Synapse14* me) {
    ...
    enum Connection12Synapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE14_L: // Intra-location logic for state l
