...
void Connection0Synapse6Run(Connection0Synapse6* me) {
    ...
    enum Connection0Synapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE6_L: // Intra-location logic for state l
