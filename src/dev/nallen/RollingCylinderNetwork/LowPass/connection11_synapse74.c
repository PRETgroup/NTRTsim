...
void Connection11Synapse74Run(Connection11Synapse74* me) {
    ...
    enum Connection11Synapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE74_L: // Intra-location logic for state l
