...
void Connection0Synapse8Run(Connection0Synapse8* me) {
    ...
    enum Connection0Synapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE8_L: // Intra-location logic for state l
