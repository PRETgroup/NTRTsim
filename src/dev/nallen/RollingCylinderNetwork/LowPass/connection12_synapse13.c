...
void Connection12Synapse13Run(Connection12Synapse13* me) {
    ...
    enum Connection12Synapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE13_L: // Intra-location logic for state l
