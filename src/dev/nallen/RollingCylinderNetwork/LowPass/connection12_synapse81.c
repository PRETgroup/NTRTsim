...
void Connection12Synapse81Run(Connection12Synapse81* me) {
    ...
    enum Connection12Synapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE81_L: // Intra-location logic for state l
