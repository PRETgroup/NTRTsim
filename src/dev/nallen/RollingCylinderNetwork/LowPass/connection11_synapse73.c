...
void Connection11Synapse73Run(Connection11Synapse73* me) {
    ...
    enum Connection11Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE73_L: // Intra-location logic for state l
