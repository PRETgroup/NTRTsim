...
void Connection0Synapse70Run(Connection0Synapse70* me) {
    ...
    enum Connection0Synapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE70_L: // Intra-location logic for state l
