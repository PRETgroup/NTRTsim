...
void Connection1Synapse87Run(Connection1Synapse87* me) {
    ...
    enum Connection1Synapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE87_L: // Intra-location logic for state l
