...
void Connection1Synapse24Run(Connection1Synapse24* me) {
    ...
    enum Connection1Synapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE24_L: // Intra-location logic for state l
