...
void Connection0Synapse73Run(Connection0Synapse73* me) {
    ...
    enum Connection0Synapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE73_L: // Intra-location logic for state l
