...
void Connection0Synapse31Run(Connection0Synapse31* me) {
    ...
    enum Connection0Synapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE31_L: // Intra-location logic for state l
