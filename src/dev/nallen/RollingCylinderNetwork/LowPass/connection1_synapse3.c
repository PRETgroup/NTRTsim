...
void Connection1Synapse3Run(Connection1Synapse3* me) {
    ...
    enum Connection1Synapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION1_SYNAPSE3_L: // Intra-location logic for state l
