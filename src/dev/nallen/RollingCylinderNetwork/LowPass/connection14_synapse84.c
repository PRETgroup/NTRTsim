...
void Connection14Synapse84Run(Connection14Synapse84* me) {
    ...
    enum Connection14Synapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE84_L: // Intra-location logic for state l
