...
void Connection13Synapse17Run(Connection13Synapse17* me) {
    ...
    enum Connection13Synapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE17_L: // Intra-location logic for state l
