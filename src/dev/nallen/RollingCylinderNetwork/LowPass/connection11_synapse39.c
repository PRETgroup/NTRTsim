...
void Connection11Synapse39Run(Connection11Synapse39* me) {
    ...
    enum Connection11Synapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE39_L: // Intra-location logic for state l
