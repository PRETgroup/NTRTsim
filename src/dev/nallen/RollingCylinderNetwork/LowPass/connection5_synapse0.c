...
void Connection5Synapse0Run(Connection5Synapse0* me) {
    ...
    enum Connection5Synapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION5_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION5_SYNAPSE0_L: // Intra-location logic for state l
