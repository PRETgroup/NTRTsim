...
void Connection12Synapse2Run(Connection12Synapse2* me) {
    ...
    enum Connection12Synapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE2_L: // Intra-location logic for state l
