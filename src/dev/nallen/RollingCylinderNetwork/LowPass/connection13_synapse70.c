...
void Connection13Synapse70Run(Connection13Synapse70* me) {
    ...
    enum Connection13Synapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE70_L: // Intra-location logic for state l
