...
void Connection12Synapse97Run(Connection12Synapse97* me) {
    ...
    enum Connection12Synapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE97_L: // Intra-location logic for state l
