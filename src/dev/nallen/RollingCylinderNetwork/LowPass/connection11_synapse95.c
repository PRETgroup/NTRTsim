...
void Connection11Synapse95Run(Connection11Synapse95* me) {
    ...
    enum Connection11Synapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION11_SYNAPSE95_L: // Intra-location logic for state l
