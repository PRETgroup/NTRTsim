...
void Connection12Synapse43Run(Connection12Synapse43* me) {
    ...
    enum Connection12Synapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION12_SYNAPSE43_L: // Intra-location logic for state l
