...
void Connection2Synapse66Run(Connection2Synapse66* me) {
    ...
    enum Connection2Synapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION2_SYNAPSE66_L: // Intra-location logic for state l
