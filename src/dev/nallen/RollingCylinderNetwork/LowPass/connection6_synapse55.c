...
void Connection6Synapse55Run(Connection6Synapse55* me) {
    ...
    enum Connection6Synapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION6_SYNAPSE55_L: // Intra-location logic for state l
