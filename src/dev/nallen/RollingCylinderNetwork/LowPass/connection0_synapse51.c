...
void Connection0Synapse51Run(Connection0Synapse51* me) {
    ...
    enum Connection0Synapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE51_L: // Intra-location logic for state l
