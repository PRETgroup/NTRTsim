...
void Connection0Synapse20Run(Connection0Synapse20* me) {
    ...
    enum Connection0Synapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION0_SYNAPSE20_L: // Intra-location logic for state l
