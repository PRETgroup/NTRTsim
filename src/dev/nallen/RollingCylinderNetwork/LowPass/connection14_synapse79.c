...
void Connection14Synapse79Run(Connection14Synapse79* me) {
    ...
    enum Connection14Synapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION14_SYNAPSE79_L: // Intra-location logic for state l
