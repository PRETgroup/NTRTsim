...
void Connection13Synapse30Run(Connection13Synapse30* me) {
    ...
    enum Connection13Synapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case CONNECTION13_SYNAPSE30_L: // Intra-location logic for state l
