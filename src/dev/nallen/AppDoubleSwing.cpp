...
int main(int argc, char** argv)
{
    ...
    double rate = 4;
    double minLength = 2;
    double maxLength = 8.5;
    
    // Create the controller
    //CyclicController* const myController = new CyclicController(rate, minLength, maxLength);
    //PidController* const myController = new PidController(rate, minLength, maxLength);
    ...
    std::string log_filename = "~/Downloads/example_logfile";
    ...
    zmqInterface->addRodTagToSend("hanger_top");
    zmqInterface->addRodTagToSend("hanger_bottom");
