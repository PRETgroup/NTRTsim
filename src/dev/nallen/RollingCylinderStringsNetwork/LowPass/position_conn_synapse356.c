...
void PositionConnSynapse356Run(PositionConnSynapse356* me) {
    ...
    enum PositionConnSynapse356States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE356_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE356_L: // Intra-location logic for state l
