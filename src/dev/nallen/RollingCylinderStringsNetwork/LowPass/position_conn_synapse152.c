...
void PositionConnSynapse152Run(PositionConnSynapse152* me) {
    ...
    enum PositionConnSynapse152States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE152_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE152_L: // Intra-location logic for state l
