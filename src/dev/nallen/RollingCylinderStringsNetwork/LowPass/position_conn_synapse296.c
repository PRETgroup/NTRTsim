...
void PositionConnSynapse296Run(PositionConnSynapse296* me) {
    ...
    enum PositionConnSynapse296States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE296_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE296_L: // Intra-location logic for state l
