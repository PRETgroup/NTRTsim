...
void PositionConnSynapse245Run(PositionConnSynapse245* me) {
    ...
    enum PositionConnSynapse245States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE245_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE245_L: // Intra-location logic for state l
