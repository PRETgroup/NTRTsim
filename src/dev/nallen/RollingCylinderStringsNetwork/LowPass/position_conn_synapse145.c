...
void PositionConnSynapse145Run(PositionConnSynapse145* me) {
    ...
    enum PositionConnSynapse145States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE145_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE145_L: // Intra-location logic for state l
