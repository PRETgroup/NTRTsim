...
void PositionConnSynapse160Run(PositionConnSynapse160* me) {
    ...
    enum PositionConnSynapse160States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE160_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE160_L: // Intra-location logic for state l
