...
void PositionConnSynapse218Run(PositionConnSynapse218* me) {
    ...
    enum PositionConnSynapse218States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE218_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE218_L: // Intra-location logic for state l
