...
void PositionConnSynapse74Run(PositionConnSynapse74* me) {
    ...
    enum PositionConnSynapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE74_L: // Intra-location logic for state l
