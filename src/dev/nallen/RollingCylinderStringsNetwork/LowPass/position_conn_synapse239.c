...
void PositionConnSynapse239Run(PositionConnSynapse239* me) {
    ...
    enum PositionConnSynapse239States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE239_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE239_L: // Intra-location logic for state l
