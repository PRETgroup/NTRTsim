...
void PositionConnSynapse2Run(PositionConnSynapse2* me) {
    ...
    enum PositionConnSynapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE2_L: // Intra-location logic for state l
