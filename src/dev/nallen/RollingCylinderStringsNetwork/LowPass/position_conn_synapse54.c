...
void PositionConnSynapse54Run(PositionConnSynapse54* me) {
    ...
    enum PositionConnSynapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE54_L: // Intra-location logic for state l
