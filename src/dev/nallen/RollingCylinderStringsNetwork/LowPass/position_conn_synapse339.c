...
void PositionConnSynapse339Run(PositionConnSynapse339* me) {
    ...
    enum PositionConnSynapse339States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE339_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE339_L: // Intra-location logic for state l
