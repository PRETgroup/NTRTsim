...
void PositionConnSynapse254Run(PositionConnSynapse254* me) {
    ...
    enum PositionConnSynapse254States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE254_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE254_L: // Intra-location logic for state l
