...
void PositionConnSynapse207Run(PositionConnSynapse207* me) {
    ...
    enum PositionConnSynapse207States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE207_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE207_L: // Intra-location logic for state l
