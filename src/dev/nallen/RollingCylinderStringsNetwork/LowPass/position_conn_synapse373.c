...
void PositionConnSynapse373Run(PositionConnSynapse373* me) {
    ...
    enum PositionConnSynapse373States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE373_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE373_L: // Intra-location logic for state l
