...
void PositionConnSynapse21Run(PositionConnSynapse21* me) {
    ...
    enum PositionConnSynapse21States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE21_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE21_L: // Intra-location logic for state l
