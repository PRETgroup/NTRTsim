...
void PositionConnSynapse199Run(PositionConnSynapse199* me) {
    ...
    enum PositionConnSynapse199States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE199_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE199_L: // Intra-location logic for state l
