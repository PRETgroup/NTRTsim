...
void PositionConnSynapse47Run(PositionConnSynapse47* me) {
    ...
    enum PositionConnSynapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE47_L: // Intra-location logic for state l
