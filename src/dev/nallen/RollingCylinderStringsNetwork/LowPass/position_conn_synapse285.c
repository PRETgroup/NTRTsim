...
void PositionConnSynapse285Run(PositionConnSynapse285* me) {
    ...
    enum PositionConnSynapse285States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE285_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE285_L: // Intra-location logic for state l
