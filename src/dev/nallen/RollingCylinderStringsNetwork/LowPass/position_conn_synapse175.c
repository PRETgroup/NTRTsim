...
void PositionConnSynapse175Run(PositionConnSynapse175* me) {
    ...
    enum PositionConnSynapse175States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE175_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE175_L: // Intra-location logic for state l
