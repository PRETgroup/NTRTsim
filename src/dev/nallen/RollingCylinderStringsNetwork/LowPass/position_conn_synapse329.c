...
void PositionConnSynapse329Run(PositionConnSynapse329* me) {
    ...
    enum PositionConnSynapse329States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE329_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE329_L: // Intra-location logic for state l
