...
void PositionConnSynapse229Run(PositionConnSynapse229* me) {
    ...
    enum PositionConnSynapse229States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE229_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE229_L: // Intra-location logic for state l
