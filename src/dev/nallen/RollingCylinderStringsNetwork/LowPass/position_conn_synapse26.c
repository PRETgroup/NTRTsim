...
void PositionConnSynapse26Run(PositionConnSynapse26* me) {
    ...
    enum PositionConnSynapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE26_L: // Intra-location logic for state l
