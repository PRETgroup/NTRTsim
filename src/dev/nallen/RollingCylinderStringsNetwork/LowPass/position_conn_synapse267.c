...
void PositionConnSynapse267Run(PositionConnSynapse267* me) {
    ...
    enum PositionConnSynapse267States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE267_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE267_L: // Intra-location logic for state l
