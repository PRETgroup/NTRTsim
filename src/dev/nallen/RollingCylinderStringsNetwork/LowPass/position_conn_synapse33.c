...
void PositionConnSynapse33Run(PositionConnSynapse33* me) {
    ...
    enum PositionConnSynapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE33_L: // Intra-location logic for state l
