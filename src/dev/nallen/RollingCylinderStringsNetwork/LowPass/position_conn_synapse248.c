...
void PositionConnSynapse248Run(PositionConnSynapse248* me) {
    ...
    enum PositionConnSynapse248States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE248_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE248_L: // Intra-location logic for state l
