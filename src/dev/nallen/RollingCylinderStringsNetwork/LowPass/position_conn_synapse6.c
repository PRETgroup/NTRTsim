...
void PositionConnSynapse6Run(PositionConnSynapse6* me) {
    ...
    enum PositionConnSynapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE6_L: // Intra-location logic for state l
