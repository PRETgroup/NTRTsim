...
void PositionConnSynapse190Run(PositionConnSynapse190* me) {
    ...
    enum PositionConnSynapse190States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE190_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE190_L: // Intra-location logic for state l
