...
void PositionConnSynapse137Run(PositionConnSynapse137* me) {
    ...
    enum PositionConnSynapse137States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE137_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE137_L: // Intra-location logic for state l
