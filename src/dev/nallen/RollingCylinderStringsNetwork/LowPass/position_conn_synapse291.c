...
void PositionConnSynapse291Run(PositionConnSynapse291* me) {
    ...
    enum PositionConnSynapse291States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE291_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE291_L: // Intra-location logic for state l
