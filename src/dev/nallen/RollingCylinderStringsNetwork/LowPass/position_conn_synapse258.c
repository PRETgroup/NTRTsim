...
void PositionConnSynapse258Run(PositionConnSynapse258* me) {
    ...
    enum PositionConnSynapse258States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE258_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE258_L: // Intra-location logic for state l
