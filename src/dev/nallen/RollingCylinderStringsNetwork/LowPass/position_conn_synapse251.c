...
void PositionConnSynapse251Run(PositionConnSynapse251* me) {
    ...
    enum PositionConnSynapse251States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE251_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE251_L: // Intra-location logic for state l
