...
void PositionConnSynapse65Run(PositionConnSynapse65* me) {
    ...
    enum PositionConnSynapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE65_L: // Intra-location logic for state l
