...
void PositionConnSynapse99Run(PositionConnSynapse99* me) {
    ...
    enum PositionConnSynapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE99_L: // Intra-location logic for state l
