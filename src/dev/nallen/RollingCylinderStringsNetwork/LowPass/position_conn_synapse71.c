...
void PositionConnSynapse71Run(PositionConnSynapse71* me) {
    ...
    enum PositionConnSynapse71States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE71_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE71_L: // Intra-location logic for state l
