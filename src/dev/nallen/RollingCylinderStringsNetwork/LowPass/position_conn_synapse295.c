...
void PositionConnSynapse295Run(PositionConnSynapse295* me) {
    ...
    enum PositionConnSynapse295States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE295_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE295_L: // Intra-location logic for state l
