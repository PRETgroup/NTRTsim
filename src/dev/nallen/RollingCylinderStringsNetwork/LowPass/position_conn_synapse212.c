...
void PositionConnSynapse212Run(PositionConnSynapse212* me) {
    ...
    enum PositionConnSynapse212States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE212_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE212_L: // Intra-location logic for state l
