...
void PositionConnSynapse228Run(PositionConnSynapse228* me) {
    ...
    enum PositionConnSynapse228States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE228_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE228_L: // Intra-location logic for state l
