...
void PositionConnSynapse370Run(PositionConnSynapse370* me) {
    ...
    enum PositionConnSynapse370States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE370_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE370_L: // Intra-location logic for state l
