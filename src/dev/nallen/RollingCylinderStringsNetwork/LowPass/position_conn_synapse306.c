...
void PositionConnSynapse306Run(PositionConnSynapse306* me) {
    ...
    enum PositionConnSynapse306States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE306_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE306_L: // Intra-location logic for state l
