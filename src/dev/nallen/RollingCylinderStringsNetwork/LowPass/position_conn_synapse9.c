...
void PositionConnSynapse9Run(PositionConnSynapse9* me) {
    ...
    enum PositionConnSynapse9States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE9_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE9_L: // Intra-location logic for state l
