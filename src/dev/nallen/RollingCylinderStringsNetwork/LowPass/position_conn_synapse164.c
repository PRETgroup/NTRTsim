...
void PositionConnSynapse164Run(PositionConnSynapse164* me) {
    ...
    enum PositionConnSynapse164States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE164_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE164_L: // Intra-location logic for state l
