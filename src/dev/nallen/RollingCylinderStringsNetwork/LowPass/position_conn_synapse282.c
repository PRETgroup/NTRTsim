...
void PositionConnSynapse282Run(PositionConnSynapse282* me) {
    ...
    enum PositionConnSynapse282States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE282_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE282_L: // Intra-location logic for state l
