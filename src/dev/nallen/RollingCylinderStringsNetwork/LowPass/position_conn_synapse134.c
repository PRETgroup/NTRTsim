...
void PositionConnSynapse134Run(PositionConnSynapse134* me) {
    ...
    enum PositionConnSynapse134States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE134_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE134_L: // Intra-location logic for state l
