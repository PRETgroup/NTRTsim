...
void PositionConnSynapse97Run(PositionConnSynapse97* me) {
    ...
    enum PositionConnSynapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE97_L: // Intra-location logic for state l
