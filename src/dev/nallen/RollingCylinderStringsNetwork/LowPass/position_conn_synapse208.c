...
void PositionConnSynapse208Run(PositionConnSynapse208* me) {
    ...
    enum PositionConnSynapse208States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE208_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE208_L: // Intra-location logic for state l
