...
void PositionConnSynapse139Run(PositionConnSynapse139* me) {
    ...
    enum PositionConnSynapse139States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE139_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE139_L: // Intra-location logic for state l
