...
void PositionConnSynapse133Run(PositionConnSynapse133* me) {
    ...
    enum PositionConnSynapse133States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE133_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE133_L: // Intra-location logic for state l
