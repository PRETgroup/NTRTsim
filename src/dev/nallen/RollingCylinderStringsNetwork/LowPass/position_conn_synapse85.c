...
void PositionConnSynapse85Run(PositionConnSynapse85* me) {
    ...
    enum PositionConnSynapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE85_L: // Intra-location logic for state l
