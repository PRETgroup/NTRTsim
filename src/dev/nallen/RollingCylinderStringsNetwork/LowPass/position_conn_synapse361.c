...
void PositionConnSynapse361Run(PositionConnSynapse361* me) {
    ...
    enum PositionConnSynapse361States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE361_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE361_L: // Intra-location logic for state l
