...
void PositionConnSynapse337Run(PositionConnSynapse337* me) {
    ...
    enum PositionConnSynapse337States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE337_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE337_L: // Intra-location logic for state l
