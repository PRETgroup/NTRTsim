...
void PositionConnSynapse384Run(PositionConnSynapse384* me) {
    ...
    enum PositionConnSynapse384States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE384_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE384_L: // Intra-location logic for state l
