...
void PositionConnSynapse264Run(PositionConnSynapse264* me) {
    ...
    enum PositionConnSynapse264States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE264_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE264_L: // Intra-location logic for state l
