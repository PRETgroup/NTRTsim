...
void PositionConnSynapse38Run(PositionConnSynapse38* me) {
    ...
    enum PositionConnSynapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE38_L: // Intra-location logic for state l
