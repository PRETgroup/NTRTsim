...
void PositionConnSynapse347Run(PositionConnSynapse347* me) {
    ...
    enum PositionConnSynapse347States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE347_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE347_L: // Intra-location logic for state l
