...
void PositionConnSynapse64Run(PositionConnSynapse64* me) {
    ...
    enum PositionConnSynapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE64_L: // Intra-location logic for state l
