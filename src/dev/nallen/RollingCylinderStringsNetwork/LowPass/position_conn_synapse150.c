...
void PositionConnSynapse150Run(PositionConnSynapse150* me) {
    ...
    enum PositionConnSynapse150States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE150_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE150_L: // Intra-location logic for state l
