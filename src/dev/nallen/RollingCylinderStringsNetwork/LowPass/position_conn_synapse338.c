...
void PositionConnSynapse338Run(PositionConnSynapse338* me) {
    ...
    enum PositionConnSynapse338States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE338_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE338_L: // Intra-location logic for state l
