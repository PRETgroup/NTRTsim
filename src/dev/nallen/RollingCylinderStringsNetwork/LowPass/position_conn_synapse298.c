...
void PositionConnSynapse298Run(PositionConnSynapse298* me) {
    ...
    enum PositionConnSynapse298States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE298_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE298_L: // Intra-location logic for state l
