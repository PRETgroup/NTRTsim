...
void PositionConnSynapse206Run(PositionConnSynapse206* me) {
    ...
    enum PositionConnSynapse206States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE206_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE206_L: // Intra-location logic for state l
