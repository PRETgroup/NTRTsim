...
void PositionConnSynapse77Run(PositionConnSynapse77* me) {
    ...
    enum PositionConnSynapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE77_L: // Intra-location logic for state l
