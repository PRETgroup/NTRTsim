...
void PositionConnSynapse189Run(PositionConnSynapse189* me) {
    ...
    enum PositionConnSynapse189States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE189_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE189_L: // Intra-location logic for state l
