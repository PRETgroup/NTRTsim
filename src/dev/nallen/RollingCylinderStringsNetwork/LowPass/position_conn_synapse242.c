...
void PositionConnSynapse242Run(PositionConnSynapse242* me) {
    ...
    enum PositionConnSynapse242States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE242_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE242_L: // Intra-location logic for state l
