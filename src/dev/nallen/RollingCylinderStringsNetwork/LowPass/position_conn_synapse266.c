...
void PositionConnSynapse266Run(PositionConnSynapse266* me) {
    ...
    enum PositionConnSynapse266States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE266_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE266_L: // Intra-location logic for state l
