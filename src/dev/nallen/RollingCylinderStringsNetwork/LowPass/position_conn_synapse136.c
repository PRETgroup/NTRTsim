...
void PositionConnSynapse136Run(PositionConnSynapse136* me) {
    ...
    enum PositionConnSynapse136States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE136_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE136_L: // Intra-location logic for state l
