...
void PositionConnSynapse342Run(PositionConnSynapse342* me) {
    ...
    enum PositionConnSynapse342States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE342_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE342_L: // Intra-location logic for state l
