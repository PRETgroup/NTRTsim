...
void PositionConnSynapse3Run(PositionConnSynapse3* me) {
    ...
    enum PositionConnSynapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE3_L: // Intra-location logic for state l
