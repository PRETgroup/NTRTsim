...
void PositionConnSynapse146Run(PositionConnSynapse146* me) {
    ...
    enum PositionConnSynapse146States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE146_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE146_L: // Intra-location logic for state l
