...
void PositionConnSynapse147Run(PositionConnSynapse147* me) {
    ...
    enum PositionConnSynapse147States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE147_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE147_L: // Intra-location logic for state l
