...
void PositionConnSynapse259Run(PositionConnSynapse259* me) {
    ...
    enum PositionConnSynapse259States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE259_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE259_L: // Intra-location logic for state l
