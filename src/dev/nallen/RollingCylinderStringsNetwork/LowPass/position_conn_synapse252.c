...
void PositionConnSynapse252Run(PositionConnSynapse252* me) {
    ...
    enum PositionConnSynapse252States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE252_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE252_L: // Intra-location logic for state l
