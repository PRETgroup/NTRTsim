...
void PositionConnSynapse357Run(PositionConnSynapse357* me) {
    ...
    enum PositionConnSynapse357States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE357_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE357_L: // Intra-location logic for state l
