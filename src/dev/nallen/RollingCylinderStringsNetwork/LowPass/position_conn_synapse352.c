...
void PositionConnSynapse352Run(PositionConnSynapse352* me) {
    ...
    enum PositionConnSynapse352States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE352_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE352_L: // Intra-location logic for state l
