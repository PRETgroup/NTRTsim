...
void PositionConnSynapse284Run(PositionConnSynapse284* me) {
    ...
    enum PositionConnSynapse284States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE284_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE284_L: // Intra-location logic for state l
