...
void PositionConnSynapse328Run(PositionConnSynapse328* me) {
    ...
    enum PositionConnSynapse328States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE328_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE328_L: // Intra-location logic for state l
