...
void PositionConnSynapse310Run(PositionConnSynapse310* me) {
    ...
    enum PositionConnSynapse310States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE310_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE310_L: // Intra-location logic for state l
