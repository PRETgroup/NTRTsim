...
void PositionConnSynapse148Run(PositionConnSynapse148* me) {
    ...
    enum PositionConnSynapse148States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE148_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE148_L: // Intra-location logic for state l
