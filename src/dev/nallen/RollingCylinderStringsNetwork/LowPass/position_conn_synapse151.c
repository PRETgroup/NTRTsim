...
void PositionConnSynapse151Run(PositionConnSynapse151* me) {
    ...
    enum PositionConnSynapse151States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE151_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE151_L: // Intra-location logic for state l
