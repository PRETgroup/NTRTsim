...
void PositionConnSynapse91Run(PositionConnSynapse91* me) {
    ...
    enum PositionConnSynapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE91_L: // Intra-location logic for state l
