...
void PositionConnSynapse39Run(PositionConnSynapse39* me) {
    ...
    enum PositionConnSynapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE39_L: // Intra-location logic for state l
