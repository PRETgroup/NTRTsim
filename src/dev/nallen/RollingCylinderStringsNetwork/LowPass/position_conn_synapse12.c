...
void PositionConnSynapse12Run(PositionConnSynapse12* me) {
    ...
    enum PositionConnSynapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE12_L: // Intra-location logic for state l
