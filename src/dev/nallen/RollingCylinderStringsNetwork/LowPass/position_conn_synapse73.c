...
void PositionConnSynapse73Run(PositionConnSynapse73* me) {
    ...
    enum PositionConnSynapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE73_L: // Intra-location logic for state l
