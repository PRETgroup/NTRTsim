...
void PositionConnSynapse351Run(PositionConnSynapse351* me) {
    ...
    enum PositionConnSynapse351States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE351_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE351_L: // Intra-location logic for state l
