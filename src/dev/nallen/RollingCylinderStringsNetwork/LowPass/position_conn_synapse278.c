...
void PositionConnSynapse278Run(PositionConnSynapse278* me) {
    ...
    enum PositionConnSynapse278States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE278_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE278_L: // Intra-location logic for state l
