...
void PositionConnSynapse320Run(PositionConnSynapse320* me) {
    ...
    enum PositionConnSynapse320States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE320_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE320_L: // Intra-location logic for state l
