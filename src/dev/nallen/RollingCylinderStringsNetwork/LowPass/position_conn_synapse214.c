...
void PositionConnSynapse214Run(PositionConnSynapse214* me) {
    ...
    enum PositionConnSynapse214States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE214_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE214_L: // Intra-location logic for state l
