...
void PositionConnSynapse173Run(PositionConnSynapse173* me) {
    ...
    enum PositionConnSynapse173States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE173_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE173_L: // Intra-location logic for state l
