...
void PositionConnSynapse110Run(PositionConnSynapse110* me) {
    ...
    enum PositionConnSynapse110States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE110_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE110_L: // Intra-location logic for state l
