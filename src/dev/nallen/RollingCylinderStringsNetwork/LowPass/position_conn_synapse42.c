...
void PositionConnSynapse42Run(PositionConnSynapse42* me) {
    ...
    enum PositionConnSynapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE42_L: // Intra-location logic for state l
