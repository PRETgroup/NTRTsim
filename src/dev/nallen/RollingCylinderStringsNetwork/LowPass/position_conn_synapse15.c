...
void PositionConnSynapse15Run(PositionConnSynapse15* me) {
    ...
    enum PositionConnSynapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE15_L: // Intra-location logic for state l
