...
void PositionConnSynapse270Run(PositionConnSynapse270* me) {
    ...
    enum PositionConnSynapse270States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE270_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE270_L: // Intra-location logic for state l
