...
void PositionConnSynapse355Run(PositionConnSynapse355* me) {
    ...
    enum PositionConnSynapse355States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE355_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE355_L: // Intra-location logic for state l
