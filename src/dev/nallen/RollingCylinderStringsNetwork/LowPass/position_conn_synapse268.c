...
void PositionConnSynapse268Run(PositionConnSynapse268* me) {
    ...
    enum PositionConnSynapse268States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE268_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE268_L: // Intra-location logic for state l
