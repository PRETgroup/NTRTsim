...
void PositionConnSynapse377Run(PositionConnSynapse377* me) {
    ...
    enum PositionConnSynapse377States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE377_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE377_L: // Intra-location logic for state l
