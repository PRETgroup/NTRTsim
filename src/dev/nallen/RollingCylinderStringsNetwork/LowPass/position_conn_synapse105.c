...
void PositionConnSynapse105Run(PositionConnSynapse105* me) {
    ...
    enum PositionConnSynapse105States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE105_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE105_L: // Intra-location logic for state l
