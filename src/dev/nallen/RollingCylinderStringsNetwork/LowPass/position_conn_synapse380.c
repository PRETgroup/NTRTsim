...
void PositionConnSynapse380Run(PositionConnSynapse380* me) {
    ...
    enum PositionConnSynapse380States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE380_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE380_L: // Intra-location logic for state l
