...
void PositionConnSynapse269Run(PositionConnSynapse269* me) {
    ...
    enum PositionConnSynapse269States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE269_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE269_L: // Intra-location logic for state l
