...
void PositionConnSynapse340Run(PositionConnSynapse340* me) {
    ...
    enum PositionConnSynapse340States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE340_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE340_L: // Intra-location logic for state l
