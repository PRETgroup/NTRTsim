...
void PositionConnSynapse129Run(PositionConnSynapse129* me) {
    ...
    enum PositionConnSynapse129States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE129_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE129_L: // Intra-location logic for state l
