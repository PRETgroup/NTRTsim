...
void PositionConnSynapse217Run(PositionConnSynapse217* me) {
    ...
    enum PositionConnSynapse217States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE217_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE217_L: // Intra-location logic for state l
