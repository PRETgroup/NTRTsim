...
void PositionConnSynapse314Run(PositionConnSynapse314* me) {
    ...
    enum PositionConnSynapse314States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE314_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE314_L: // Intra-location logic for state l
