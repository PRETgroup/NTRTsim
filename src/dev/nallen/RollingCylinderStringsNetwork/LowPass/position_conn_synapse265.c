...
void PositionConnSynapse265Run(PositionConnSynapse265* me) {
    ...
    enum PositionConnSynapse265States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE265_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE265_L: // Intra-location logic for state l
