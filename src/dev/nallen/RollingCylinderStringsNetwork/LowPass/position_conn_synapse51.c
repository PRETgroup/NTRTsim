...
void PositionConnSynapse51Run(PositionConnSynapse51* me) {
    ...
    enum PositionConnSynapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE51_L: // Intra-location logic for state l
