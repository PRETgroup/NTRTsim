...
void PositionConnSynapse379Run(PositionConnSynapse379* me) {
    ...
    enum PositionConnSynapse379States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE379_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE379_L: // Intra-location logic for state l
