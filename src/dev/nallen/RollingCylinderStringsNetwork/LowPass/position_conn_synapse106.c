...
void PositionConnSynapse106Run(PositionConnSynapse106* me) {
    ...
    enum PositionConnSynapse106States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE106_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE106_L: // Intra-location logic for state l
