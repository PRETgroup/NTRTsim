...
void PositionConnSynapse382Run(PositionConnSynapse382* me) {
    ...
    enum PositionConnSynapse382States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE382_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE382_L: // Intra-location logic for state l
