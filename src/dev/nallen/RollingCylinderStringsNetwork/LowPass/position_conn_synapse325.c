...
void PositionConnSynapse325Run(PositionConnSynapse325* me) {
    ...
    enum PositionConnSynapse325States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE325_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE325_L: // Intra-location logic for state l
