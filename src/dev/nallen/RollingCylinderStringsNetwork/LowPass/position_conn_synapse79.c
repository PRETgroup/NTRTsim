...
void PositionConnSynapse79Run(PositionConnSynapse79* me) {
    ...
    enum PositionConnSynapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE79_L: // Intra-location logic for state l
