...
void PositionConnSynapse396Run(PositionConnSynapse396* me) {
    ...
    enum PositionConnSynapse396States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE396_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE396_L: // Intra-location logic for state l
