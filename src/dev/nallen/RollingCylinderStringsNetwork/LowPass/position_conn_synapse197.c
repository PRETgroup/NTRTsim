...
void PositionConnSynapse197Run(PositionConnSynapse197* me) {
    ...
    enum PositionConnSynapse197States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE197_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE197_L: // Intra-location logic for state l
