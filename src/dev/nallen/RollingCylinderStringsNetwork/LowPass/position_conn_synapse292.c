...
void PositionConnSynapse292Run(PositionConnSynapse292* me) {
    ...
    enum PositionConnSynapse292States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE292_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE292_L: // Intra-location logic for state l
