...
void PositionConnSynapse210Run(PositionConnSynapse210* me) {
    ...
    enum PositionConnSynapse210States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE210_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE210_L: // Intra-location logic for state l
