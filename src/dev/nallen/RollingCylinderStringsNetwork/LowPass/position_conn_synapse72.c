...
void PositionConnSynapse72Run(PositionConnSynapse72* me) {
    ...
    enum PositionConnSynapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE72_L: // Intra-location logic for state l
