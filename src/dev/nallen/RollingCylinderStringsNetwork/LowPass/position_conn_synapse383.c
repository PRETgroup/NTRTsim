...
void PositionConnSynapse383Run(PositionConnSynapse383* me) {
    ...
    enum PositionConnSynapse383States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE383_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE383_L: // Intra-location logic for state l
