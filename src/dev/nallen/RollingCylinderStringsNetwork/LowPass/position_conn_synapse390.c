...
void PositionConnSynapse390Run(PositionConnSynapse390* me) {
    ...
    enum PositionConnSynapse390States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE390_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE390_L: // Intra-location logic for state l
