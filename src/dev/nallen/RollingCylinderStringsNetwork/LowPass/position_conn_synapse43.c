...
void PositionConnSynapse43Run(PositionConnSynapse43* me) {
    ...
    enum PositionConnSynapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE43_L: // Intra-location logic for state l
