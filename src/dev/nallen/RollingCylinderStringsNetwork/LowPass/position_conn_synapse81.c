...
void PositionConnSynapse81Run(PositionConnSynapse81* me) {
    ...
    enum PositionConnSynapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE81_L: // Intra-location logic for state l
