...
void PositionConnSynapse219Run(PositionConnSynapse219* me) {
    ...
    enum PositionConnSynapse219States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE219_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE219_L: // Intra-location logic for state l
