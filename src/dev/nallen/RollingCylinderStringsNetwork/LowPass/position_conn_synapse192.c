...
void PositionConnSynapse192Run(PositionConnSynapse192* me) {
    ...
    enum PositionConnSynapse192States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE192_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE192_L: // Intra-location logic for state l
