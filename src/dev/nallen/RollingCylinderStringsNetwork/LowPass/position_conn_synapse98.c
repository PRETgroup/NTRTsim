...
void PositionConnSynapse98Run(PositionConnSynapse98* me) {
    ...
    enum PositionConnSynapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE98_L: // Intra-location logic for state l
