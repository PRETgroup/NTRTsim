...
void PositionConnSynapse316Run(PositionConnSynapse316* me) {
    ...
    enum PositionConnSynapse316States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE316_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE316_L: // Intra-location logic for state l
