...
void PositionConnSynapse335Run(PositionConnSynapse335* me) {
    ...
    enum PositionConnSynapse335States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE335_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE335_L: // Intra-location logic for state l
