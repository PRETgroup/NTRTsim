...
void PositionConnSynapse371Run(PositionConnSynapse371* me) {
    ...
    enum PositionConnSynapse371States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE371_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE371_L: // Intra-location logic for state l
