...
void PositionConnSynapse272Run(PositionConnSynapse272* me) {
    ...
    enum PositionConnSynapse272States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE272_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE272_L: // Intra-location logic for state l
