...
void PositionConnSynapse82Run(PositionConnSynapse82* me) {
    ...
    enum PositionConnSynapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE82_L: // Intra-location logic for state l
