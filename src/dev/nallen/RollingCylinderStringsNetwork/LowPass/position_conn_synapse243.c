...
void PositionConnSynapse243Run(PositionConnSynapse243* me) {
    ...
    enum PositionConnSynapse243States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE243_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE243_L: // Intra-location logic for state l
