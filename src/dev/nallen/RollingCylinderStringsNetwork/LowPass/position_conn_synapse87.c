...
void PositionConnSynapse87Run(PositionConnSynapse87* me) {
    ...
    enum PositionConnSynapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE87_L: // Intra-location logic for state l
