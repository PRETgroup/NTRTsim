...
void PositionConnSynapse398Run(PositionConnSynapse398* me) {
    ...
    enum PositionConnSynapse398States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE398_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE398_L: // Intra-location logic for state l
