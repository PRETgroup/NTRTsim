...
void PositionConnSynapse240Run(PositionConnSynapse240* me) {
    ...
    enum PositionConnSynapse240States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE240_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE240_L: // Intra-location logic for state l
