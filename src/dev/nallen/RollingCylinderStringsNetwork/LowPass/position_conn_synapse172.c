...
void PositionConnSynapse172Run(PositionConnSynapse172* me) {
    ...
    enum PositionConnSynapse172States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE172_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE172_L: // Intra-location logic for state l
