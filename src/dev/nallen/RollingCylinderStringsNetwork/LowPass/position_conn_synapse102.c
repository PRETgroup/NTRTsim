...
void PositionConnSynapse102Run(PositionConnSynapse102* me) {
    ...
    enum PositionConnSynapse102States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE102_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE102_L: // Intra-location logic for state l
