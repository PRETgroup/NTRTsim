...
void PositionConnSynapse135Run(PositionConnSynapse135* me) {
    ...
    enum PositionConnSynapse135States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE135_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE135_L: // Intra-location logic for state l
