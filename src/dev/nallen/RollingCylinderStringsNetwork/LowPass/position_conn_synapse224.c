...
void PositionConnSynapse224Run(PositionConnSynapse224* me) {
    ...
    enum PositionConnSynapse224States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE224_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE224_L: // Intra-location logic for state l
