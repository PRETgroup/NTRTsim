...
void PositionConnSynapse397Run(PositionConnSynapse397* me) {
    ...
    enum PositionConnSynapse397States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE397_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE397_L: // Intra-location logic for state l
