...
void PositionConnSynapse70Run(PositionConnSynapse70* me) {
    ...
    enum PositionConnSynapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE70_L: // Intra-location logic for state l
