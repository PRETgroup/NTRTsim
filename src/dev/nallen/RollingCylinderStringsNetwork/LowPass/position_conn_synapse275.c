...
void PositionConnSynapse275Run(PositionConnSynapse275* me) {
    ...
    enum PositionConnSynapse275States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE275_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE275_L: // Intra-location logic for state l
