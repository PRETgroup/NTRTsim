...
void PositionConnSynapse222Run(PositionConnSynapse222* me) {
    ...
    enum PositionConnSynapse222States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE222_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE222_L: // Intra-location logic for state l
