...
void PositionConnSynapse165Run(PositionConnSynapse165* me) {
    ...
    enum PositionConnSynapse165States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE165_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE165_L: // Intra-location logic for state l
