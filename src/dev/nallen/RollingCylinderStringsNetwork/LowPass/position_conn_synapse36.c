...
void PositionConnSynapse36Run(PositionConnSynapse36* me) {
    ...
    enum PositionConnSynapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE36_L: // Intra-location logic for state l
