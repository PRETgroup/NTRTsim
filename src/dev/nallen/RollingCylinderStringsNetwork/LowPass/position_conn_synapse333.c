...
void PositionConnSynapse333Run(PositionConnSynapse333* me) {
    ...
    enum PositionConnSynapse333States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE333_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE333_L: // Intra-location logic for state l
