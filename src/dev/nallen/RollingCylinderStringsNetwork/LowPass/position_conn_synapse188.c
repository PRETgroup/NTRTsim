...
void PositionConnSynapse188Run(PositionConnSynapse188* me) {
    ...
    enum PositionConnSynapse188States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE188_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE188_L: // Intra-location logic for state l
