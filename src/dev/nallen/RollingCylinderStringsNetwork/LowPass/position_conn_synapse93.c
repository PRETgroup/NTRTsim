...
void PositionConnSynapse93Run(PositionConnSynapse93* me) {
    ...
    enum PositionConnSynapse93States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE93_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE93_L: // Intra-location logic for state l
