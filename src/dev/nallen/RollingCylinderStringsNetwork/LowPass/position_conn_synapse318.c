...
void PositionConnSynapse318Run(PositionConnSynapse318* me) {
    ...
    enum PositionConnSynapse318States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE318_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE318_L: // Intra-location logic for state l
