...
void PositionConnSynapse162Run(PositionConnSynapse162* me) {
    ...
    enum PositionConnSynapse162States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE162_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE162_L: // Intra-location logic for state l
