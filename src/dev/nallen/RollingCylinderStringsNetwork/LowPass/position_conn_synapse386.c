...
void PositionConnSynapse386Run(PositionConnSynapse386* me) {
    ...
    enum PositionConnSynapse386States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE386_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE386_L: // Intra-location logic for state l
