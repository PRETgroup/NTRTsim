...
void PositionConnSynapse253Run(PositionConnSynapse253* me) {
    ...
    enum PositionConnSynapse253States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE253_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE253_L: // Intra-location logic for state l
