...
void PositionConnSynapse281Run(PositionConnSynapse281* me) {
    ...
    enum PositionConnSynapse281States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE281_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE281_L: // Intra-location logic for state l
