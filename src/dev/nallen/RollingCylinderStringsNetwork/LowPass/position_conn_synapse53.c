...
void PositionConnSynapse53Run(PositionConnSynapse53* me) {
    ...
    enum PositionConnSynapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE53_L: // Intra-location logic for state l
