...
void PositionConnSynapse216Run(PositionConnSynapse216* me) {
    ...
    enum PositionConnSynapse216States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE216_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE216_L: // Intra-location logic for state l
