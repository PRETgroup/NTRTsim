...
void PositionConnSynapse49Run(PositionConnSynapse49* me) {
    ...
    enum PositionConnSynapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE49_L: // Intra-location logic for state l
