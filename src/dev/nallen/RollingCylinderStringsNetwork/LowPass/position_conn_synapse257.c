...
void PositionConnSynapse257Run(PositionConnSynapse257* me) {
    ...
    enum PositionConnSynapse257States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE257_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE257_L: // Intra-location logic for state l
