...
void PositionConnSynapse230Run(PositionConnSynapse230* me) {
    ...
    enum PositionConnSynapse230States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE230_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE230_L: // Intra-location logic for state l
