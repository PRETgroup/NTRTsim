...
void PositionConnSynapse209Run(PositionConnSynapse209* me) {
    ...
    enum PositionConnSynapse209States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE209_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE209_L: // Intra-location logic for state l
