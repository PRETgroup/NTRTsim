...
void PositionConnSynapse41Run(PositionConnSynapse41* me) {
    ...
    enum PositionConnSynapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE41_L: // Intra-location logic for state l
