...
void PositionConnSynapse327Run(PositionConnSynapse327* me) {
    ...
    enum PositionConnSynapse327States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE327_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE327_L: // Intra-location logic for state l
