...
void PositionConnSynapse326Run(PositionConnSynapse326* me) {
    ...
    enum PositionConnSynapse326States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE326_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE326_L: // Intra-location logic for state l
