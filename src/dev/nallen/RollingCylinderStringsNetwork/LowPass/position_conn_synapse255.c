...
void PositionConnSynapse255Run(PositionConnSynapse255* me) {
    ...
    enum PositionConnSynapse255States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE255_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE255_L: // Intra-location logic for state l
