...
void PositionConnSynapse235Run(PositionConnSynapse235* me) {
    ...
    enum PositionConnSynapse235States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE235_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE235_L: // Intra-location logic for state l
