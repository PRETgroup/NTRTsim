...
void PositionConnSynapse279Run(PositionConnSynapse279* me) {
    ...
    enum PositionConnSynapse279States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE279_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE279_L: // Intra-location logic for state l
