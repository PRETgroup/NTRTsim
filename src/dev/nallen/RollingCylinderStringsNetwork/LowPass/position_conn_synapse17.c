...
void PositionConnSynapse17Run(PositionConnSynapse17* me) {
    ...
    enum PositionConnSynapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE17_L: // Intra-location logic for state l
