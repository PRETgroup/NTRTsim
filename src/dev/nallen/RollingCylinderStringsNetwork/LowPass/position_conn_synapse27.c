...
void PositionConnSynapse27Run(PositionConnSynapse27* me) {
    ...
    enum PositionConnSynapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE27_L: // Intra-location logic for state l
