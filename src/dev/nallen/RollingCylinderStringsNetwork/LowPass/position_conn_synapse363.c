...
void PositionConnSynapse363Run(PositionConnSynapse363* me) {
    ...
    enum PositionConnSynapse363States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE363_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE363_L: // Intra-location logic for state l
