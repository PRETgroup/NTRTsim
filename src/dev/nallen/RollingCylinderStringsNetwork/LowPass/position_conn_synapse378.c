...
void PositionConnSynapse378Run(PositionConnSynapse378* me) {
    ...
    enum PositionConnSynapse378States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE378_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE378_L: // Intra-location logic for state l
