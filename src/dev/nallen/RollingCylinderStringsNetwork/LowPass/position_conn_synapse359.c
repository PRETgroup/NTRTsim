...
void PositionConnSynapse359Run(PositionConnSynapse359* me) {
    ...
    enum PositionConnSynapse359States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE359_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE359_L: // Intra-location logic for state l
