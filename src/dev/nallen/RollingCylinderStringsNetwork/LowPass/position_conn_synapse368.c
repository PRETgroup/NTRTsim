...
void PositionConnSynapse368Run(PositionConnSynapse368* me) {
    ...
    enum PositionConnSynapse368States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE368_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE368_L: // Intra-location logic for state l
