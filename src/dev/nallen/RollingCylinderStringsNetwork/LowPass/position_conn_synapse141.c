...
void PositionConnSynapse141Run(PositionConnSynapse141* me) {
    ...
    enum PositionConnSynapse141States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE141_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE141_L: // Intra-location logic for state l
