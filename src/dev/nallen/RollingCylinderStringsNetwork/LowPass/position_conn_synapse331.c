...
void PositionConnSynapse331Run(PositionConnSynapse331* me) {
    ...
    enum PositionConnSynapse331States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE331_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE331_L: // Intra-location logic for state l
