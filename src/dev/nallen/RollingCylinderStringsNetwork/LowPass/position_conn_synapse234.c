...
void PositionConnSynapse234Run(PositionConnSynapse234* me) {
    ...
    enum PositionConnSynapse234States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE234_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE234_L: // Intra-location logic for state l
