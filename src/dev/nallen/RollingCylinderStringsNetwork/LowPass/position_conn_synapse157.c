...
void PositionConnSynapse157Run(PositionConnSynapse157* me) {
    ...
    enum PositionConnSynapse157States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE157_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE157_L: // Intra-location logic for state l
