...
void PositionConnSynapse273Run(PositionConnSynapse273* me) {
    ...
    enum PositionConnSynapse273States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE273_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE273_L: // Intra-location logic for state l
