...
void PositionConnSynapse321Run(PositionConnSynapse321* me) {
    ...
    enum PositionConnSynapse321States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE321_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE321_L: // Intra-location logic for state l
