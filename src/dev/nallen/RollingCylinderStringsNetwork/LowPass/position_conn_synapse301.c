...
void PositionConnSynapse301Run(PositionConnSynapse301* me) {
    ...
    enum PositionConnSynapse301States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE301_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE301_L: // Intra-location logic for state l
