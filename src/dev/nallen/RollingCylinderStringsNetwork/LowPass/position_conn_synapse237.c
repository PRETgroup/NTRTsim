...
void PositionConnSynapse237Run(PositionConnSynapse237* me) {
    ...
    enum PositionConnSynapse237States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE237_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE237_L: // Intra-location logic for state l
