...
void PositionConnSynapse56Run(PositionConnSynapse56* me) {
    ...
    enum PositionConnSynapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE56_L: // Intra-location logic for state l
