...
void PositionConnSynapse127Run(PositionConnSynapse127* me) {
    ...
    enum PositionConnSynapse127States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE127_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE127_L: // Intra-location logic for state l
