...
void PositionConnSynapse303Run(PositionConnSynapse303* me) {
    ...
    enum PositionConnSynapse303States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE303_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE303_L: // Intra-location logic for state l
