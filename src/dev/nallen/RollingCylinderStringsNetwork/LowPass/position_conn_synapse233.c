...
void PositionConnSynapse233Run(PositionConnSynapse233* me) {
    ...
    enum PositionConnSynapse233States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE233_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE233_L: // Intra-location logic for state l
