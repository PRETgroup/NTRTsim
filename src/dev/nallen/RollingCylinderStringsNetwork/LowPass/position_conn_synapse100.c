...
void PositionConnSynapse100Run(PositionConnSynapse100* me) {
    ...
    enum PositionConnSynapse100States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE100_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE100_L: // Intra-location logic for state l
