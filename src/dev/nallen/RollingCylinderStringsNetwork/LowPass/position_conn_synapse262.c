...
void PositionConnSynapse262Run(PositionConnSynapse262* me) {
    ...
    enum PositionConnSynapse262States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE262_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE262_L: // Intra-location logic for state l
