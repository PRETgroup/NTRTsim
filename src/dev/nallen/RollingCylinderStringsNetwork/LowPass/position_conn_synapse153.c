...
void PositionConnSynapse153Run(PositionConnSynapse153* me) {
    ...
    enum PositionConnSynapse153States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE153_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE153_L: // Intra-location logic for state l
