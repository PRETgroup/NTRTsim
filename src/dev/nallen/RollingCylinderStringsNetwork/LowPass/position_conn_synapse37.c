...
void PositionConnSynapse37Run(PositionConnSynapse37* me) {
    ...
    enum PositionConnSynapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE37_L: // Intra-location logic for state l
