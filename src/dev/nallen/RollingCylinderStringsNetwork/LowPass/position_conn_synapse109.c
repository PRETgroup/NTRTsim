...
void PositionConnSynapse109Run(PositionConnSynapse109* me) {
    ...
    enum PositionConnSynapse109States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE109_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE109_L: // Intra-location logic for state l
