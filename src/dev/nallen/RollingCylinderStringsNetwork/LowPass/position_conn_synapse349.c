...
void PositionConnSynapse349Run(PositionConnSynapse349* me) {
    ...
    enum PositionConnSynapse349States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE349_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE349_L: // Intra-location logic for state l
