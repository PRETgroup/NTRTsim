...
void PositionConnSynapse182Run(PositionConnSynapse182* me) {
    ...
    enum PositionConnSynapse182States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE182_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE182_L: // Intra-location logic for state l
