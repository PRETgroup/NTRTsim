...
void PositionConnSynapse108Run(PositionConnSynapse108* me) {
    ...
    enum PositionConnSynapse108States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE108_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE108_L: // Intra-location logic for state l
