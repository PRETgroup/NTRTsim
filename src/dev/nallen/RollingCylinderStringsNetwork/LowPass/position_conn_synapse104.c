...
void PositionConnSynapse104Run(PositionConnSynapse104* me) {
    ...
    enum PositionConnSynapse104States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE104_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE104_L: // Intra-location logic for state l
