...
void PositionConnSynapse168Run(PositionConnSynapse168* me) {
    ...
    enum PositionConnSynapse168States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE168_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE168_L: // Intra-location logic for state l
