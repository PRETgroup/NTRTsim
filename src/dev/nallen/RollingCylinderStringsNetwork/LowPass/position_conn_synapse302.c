...
void PositionConnSynapse302Run(PositionConnSynapse302* me) {
    ...
    enum PositionConnSynapse302States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE302_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE302_L: // Intra-location logic for state l
