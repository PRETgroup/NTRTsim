...
void PositionConnSynapse23Run(PositionConnSynapse23* me) {
    ...
    enum PositionConnSynapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE23_L: // Intra-location logic for state l
