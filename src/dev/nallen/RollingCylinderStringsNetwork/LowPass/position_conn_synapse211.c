...
void PositionConnSynapse211Run(PositionConnSynapse211* me) {
    ...
    enum PositionConnSynapse211States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE211_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE211_L: // Intra-location logic for state l
