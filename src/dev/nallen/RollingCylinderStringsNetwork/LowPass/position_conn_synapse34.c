...
void PositionConnSynapse34Run(PositionConnSynapse34* me) {
    ...
    enum PositionConnSynapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE34_L: // Intra-location logic for state l
