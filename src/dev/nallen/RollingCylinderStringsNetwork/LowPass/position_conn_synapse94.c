...
void PositionConnSynapse94Run(PositionConnSynapse94* me) {
    ...
    enum PositionConnSynapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE94_L: // Intra-location logic for state l
