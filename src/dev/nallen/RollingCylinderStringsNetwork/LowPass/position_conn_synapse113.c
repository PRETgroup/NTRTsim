...
void PositionConnSynapse113Run(PositionConnSynapse113* me) {
    ...
    enum PositionConnSynapse113States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE113_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE113_L: // Intra-location logic for state l
