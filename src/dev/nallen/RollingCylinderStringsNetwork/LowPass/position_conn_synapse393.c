...
void PositionConnSynapse393Run(PositionConnSynapse393* me) {
    ...
    enum PositionConnSynapse393States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE393_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE393_L: // Intra-location logic for state l
