...
void PositionConnSynapse67Run(PositionConnSynapse67* me) {
    ...
    enum PositionConnSynapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE67_L: // Intra-location logic for state l
