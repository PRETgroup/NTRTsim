...
void PositionConnSynapse25Run(PositionConnSynapse25* me) {
    ...
    enum PositionConnSynapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE25_L: // Intra-location logic for state l
