...
void PositionConnSynapse66Run(PositionConnSynapse66* me) {
    ...
    enum PositionConnSynapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE66_L: // Intra-location logic for state l
