...
void PositionConnSynapse287Run(PositionConnSynapse287* me) {
    ...
    enum PositionConnSynapse287States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE287_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE287_L: // Intra-location logic for state l
