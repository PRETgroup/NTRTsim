...
void PositionConnSynapse123Run(PositionConnSynapse123* me) {
    ...
    enum PositionConnSynapse123States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE123_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE123_L: // Intra-location logic for state l
