...
void PositionConnSynapse309Run(PositionConnSynapse309* me) {
    ...
    enum PositionConnSynapse309States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE309_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE309_L: // Intra-location logic for state l
