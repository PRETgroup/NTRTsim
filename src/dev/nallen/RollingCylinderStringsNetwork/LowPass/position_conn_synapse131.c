...
void PositionConnSynapse131Run(PositionConnSynapse131* me) {
    ...
    enum PositionConnSynapse131States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE131_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE131_L: // Intra-location logic for state l
