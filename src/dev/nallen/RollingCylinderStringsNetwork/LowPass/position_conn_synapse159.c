...
void PositionConnSynapse159Run(PositionConnSynapse159* me) {
    ...
    enum PositionConnSynapse159States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE159_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE159_L: // Intra-location logic for state l
