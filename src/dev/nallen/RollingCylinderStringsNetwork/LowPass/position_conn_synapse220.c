...
void PositionConnSynapse220Run(PositionConnSynapse220* me) {
    ...
    enum PositionConnSynapse220States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE220_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE220_L: // Intra-location logic for state l
