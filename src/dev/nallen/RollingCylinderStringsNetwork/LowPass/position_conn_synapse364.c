...
void PositionConnSynapse364Run(PositionConnSynapse364* me) {
    ...
    enum PositionConnSynapse364States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE364_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE364_L: // Intra-location logic for state l
