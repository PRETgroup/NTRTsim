...
void PositionConnSynapse161Run(PositionConnSynapse161* me) {
    ...
    enum PositionConnSynapse161States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE161_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE161_L: // Intra-location logic for state l
