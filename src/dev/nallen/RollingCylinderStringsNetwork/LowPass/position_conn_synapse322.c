...
void PositionConnSynapse322Run(PositionConnSynapse322* me) {
    ...
    enum PositionConnSynapse322States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE322_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE322_L: // Intra-location logic for state l
