...
void PositionConnSynapse289Run(PositionConnSynapse289* me) {
    ...
    enum PositionConnSynapse289States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE289_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE289_L: // Intra-location logic for state l
