...
void PositionConnSynapse315Run(PositionConnSynapse315* me) {
    ...
    enum PositionConnSynapse315States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE315_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE315_L: // Intra-location logic for state l
