...
void PositionConnSynapse183Run(PositionConnSynapse183* me) {
    ...
    enum PositionConnSynapse183States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE183_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE183_L: // Intra-location logic for state l
