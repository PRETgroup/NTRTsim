...
void PositionConnSynapse344Run(PositionConnSynapse344* me) {
    ...
    enum PositionConnSynapse344States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE344_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE344_L: // Intra-location logic for state l
