...
void PositionConnSynapse10Run(PositionConnSynapse10* me) {
    ...
    enum PositionConnSynapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE10_L: // Intra-location logic for state l
