...
void PositionConnSynapse375Run(PositionConnSynapse375* me) {
    ...
    enum PositionConnSynapse375States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE375_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE375_L: // Intra-location logic for state l
