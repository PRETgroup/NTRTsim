...
void PositionConnSynapse215Run(PositionConnSynapse215* me) {
    ...
    enum PositionConnSynapse215States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE215_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE215_L: // Intra-location logic for state l
