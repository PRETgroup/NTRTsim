...
void PositionConnSynapse307Run(PositionConnSynapse307* me) {
    ...
    enum PositionConnSynapse307States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE307_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE307_L: // Intra-location logic for state l
