...
void PositionConnSynapse11Run(PositionConnSynapse11* me) {
    ...
    enum PositionConnSynapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE11_L: // Intra-location logic for state l
