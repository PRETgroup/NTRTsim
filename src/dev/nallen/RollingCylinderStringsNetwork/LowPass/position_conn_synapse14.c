...
void PositionConnSynapse14Run(PositionConnSynapse14* me) {
    ...
    enum PositionConnSynapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE14_L: // Intra-location logic for state l
