...
void PositionConnSynapse90Run(PositionConnSynapse90* me) {
    ...
    enum PositionConnSynapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE90_L: // Intra-location logic for state l
