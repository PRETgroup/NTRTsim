...
void PositionConnSynapse261Run(PositionConnSynapse261* me) {
    ...
    enum PositionConnSynapse261States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE261_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE261_L: // Intra-location logic for state l
