...
void PositionConnSynapse142Run(PositionConnSynapse142* me) {
    ...
    enum PositionConnSynapse142States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE142_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE142_L: // Intra-location logic for state l
