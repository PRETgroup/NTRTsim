...
void PositionConnSynapse75Run(PositionConnSynapse75* me) {
    ...
    enum PositionConnSynapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE75_L: // Intra-location logic for state l
