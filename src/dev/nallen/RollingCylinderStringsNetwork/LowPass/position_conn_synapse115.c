...
void PositionConnSynapse115Run(PositionConnSynapse115* me) {
    ...
    enum PositionConnSynapse115States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE115_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE115_L: // Intra-location logic for state l
