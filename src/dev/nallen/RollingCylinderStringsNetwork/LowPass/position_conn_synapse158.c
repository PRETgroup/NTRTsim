...
void PositionConnSynapse158Run(PositionConnSynapse158* me) {
    ...
    enum PositionConnSynapse158States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE158_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE158_L: // Intra-location logic for state l
