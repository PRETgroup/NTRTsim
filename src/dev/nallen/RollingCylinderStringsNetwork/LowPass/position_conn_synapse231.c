...
void PositionConnSynapse231Run(PositionConnSynapse231* me) {
    ...
    enum PositionConnSynapse231States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE231_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE231_L: // Intra-location logic for state l
