...
void PositionConnSynapse60Run(PositionConnSynapse60* me) {
    ...
    enum PositionConnSynapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE60_L: // Intra-location logic for state l
