...
void PositionConnSynapse119Run(PositionConnSynapse119* me) {
    ...
    enum PositionConnSynapse119States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE119_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE119_L: // Intra-location logic for state l
