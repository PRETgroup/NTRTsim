...
void PositionConnSynapse35Run(PositionConnSynapse35* me) {
    ...
    enum PositionConnSynapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE35_L: // Intra-location logic for state l
