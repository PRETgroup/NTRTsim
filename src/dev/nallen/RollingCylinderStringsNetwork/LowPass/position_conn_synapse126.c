...
void PositionConnSynapse126Run(PositionConnSynapse126* me) {
    ...
    enum PositionConnSynapse126States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE126_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE126_L: // Intra-location logic for state l
