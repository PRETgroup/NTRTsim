...
void PositionConnSynapse312Run(PositionConnSynapse312* me) {
    ...
    enum PositionConnSynapse312States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE312_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE312_L: // Intra-location logic for state l
