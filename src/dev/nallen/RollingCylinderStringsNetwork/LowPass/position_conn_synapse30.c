...
void PositionConnSynapse30Run(PositionConnSynapse30* me) {
    ...
    enum PositionConnSynapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE30_L: // Intra-location logic for state l
