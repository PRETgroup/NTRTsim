...
void PositionConnSynapse45Run(PositionConnSynapse45* me) {
    ...
    enum PositionConnSynapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE45_L: // Intra-location logic for state l
