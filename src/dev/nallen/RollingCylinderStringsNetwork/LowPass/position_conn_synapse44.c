...
void PositionConnSynapse44Run(PositionConnSynapse44* me) {
    ...
    enum PositionConnSynapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE44_L: // Intra-location logic for state l
