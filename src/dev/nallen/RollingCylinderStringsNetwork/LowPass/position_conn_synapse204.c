...
void PositionConnSynapse204Run(PositionConnSynapse204* me) {
    ...
    enum PositionConnSynapse204States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE204_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE204_L: // Intra-location logic for state l
