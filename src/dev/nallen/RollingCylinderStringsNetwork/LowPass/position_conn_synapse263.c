...
void PositionConnSynapse263Run(PositionConnSynapse263* me) {
    ...
    enum PositionConnSynapse263States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE263_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE263_L: // Intra-location logic for state l
