...
void PositionConnSynapse353Run(PositionConnSynapse353* me) {
    ...
    enum PositionConnSynapse353States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE353_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE353_L: // Intra-location logic for state l
