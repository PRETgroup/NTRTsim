...
void PositionConnSynapse394Run(PositionConnSynapse394* me) {
    ...
    enum PositionConnSynapse394States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE394_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE394_L: // Intra-location logic for state l
