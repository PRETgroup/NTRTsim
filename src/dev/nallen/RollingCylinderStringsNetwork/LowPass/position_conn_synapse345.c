...
void PositionConnSynapse345Run(PositionConnSynapse345* me) {
    ...
    enum PositionConnSynapse345States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE345_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE345_L: // Intra-location logic for state l
