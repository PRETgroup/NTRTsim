...
void PositionConnSynapse7Run(PositionConnSynapse7* me) {
    ...
    enum PositionConnSynapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE7_L: // Intra-location logic for state l
