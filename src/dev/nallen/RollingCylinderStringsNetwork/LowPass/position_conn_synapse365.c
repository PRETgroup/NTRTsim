...
void PositionConnSynapse365Run(PositionConnSynapse365* me) {
    ...
    enum PositionConnSynapse365States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE365_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE365_L: // Intra-location logic for state l
