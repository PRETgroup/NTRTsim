...
void PositionConnSynapse111Run(PositionConnSynapse111* me) {
    ...
    enum PositionConnSynapse111States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE111_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE111_L: // Intra-location logic for state l
