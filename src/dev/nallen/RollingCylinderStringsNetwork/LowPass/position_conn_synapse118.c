...
void PositionConnSynapse118Run(PositionConnSynapse118* me) {
    ...
    enum PositionConnSynapse118States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE118_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE118_L: // Intra-location logic for state l
