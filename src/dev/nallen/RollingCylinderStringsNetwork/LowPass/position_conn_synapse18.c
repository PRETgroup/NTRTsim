...
void PositionConnSynapse18Run(PositionConnSynapse18* me) {
    ...
    enum PositionConnSynapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE18_L: // Intra-location logic for state l
