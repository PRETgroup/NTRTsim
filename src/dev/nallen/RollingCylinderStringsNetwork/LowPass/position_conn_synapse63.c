...
void PositionConnSynapse63Run(PositionConnSynapse63* me) {
    ...
    enum PositionConnSynapse63States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE63_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE63_L: // Intra-location logic for state l
