...
void PositionConnSynapse362Run(PositionConnSynapse362* me) {
    ...
    enum PositionConnSynapse362States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE362_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE362_L: // Intra-location logic for state l
