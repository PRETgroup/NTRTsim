...
void PositionConnSynapse4Run(PositionConnSynapse4* me) {
    ...
    enum PositionConnSynapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE4_L: // Intra-location logic for state l
