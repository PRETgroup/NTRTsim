...
void PositionConnSynapse277Run(PositionConnSynapse277* me) {
    ...
    enum PositionConnSynapse277States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE277_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE277_L: // Intra-location logic for state l
