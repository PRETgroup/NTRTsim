...
void PositionConnSynapse202Run(PositionConnSynapse202* me) {
    ...
    enum PositionConnSynapse202States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE202_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE202_L: // Intra-location logic for state l
