...
void PositionConnSynapse385Run(PositionConnSynapse385* me) {
    ...
    enum PositionConnSynapse385States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE385_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE385_L: // Intra-location logic for state l
