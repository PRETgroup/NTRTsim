...
void PositionConnSynapse83Run(PositionConnSynapse83* me) {
    ...
    enum PositionConnSynapse83States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE83_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE83_L: // Intra-location logic for state l
