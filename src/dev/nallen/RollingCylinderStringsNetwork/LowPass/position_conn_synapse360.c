...
void PositionConnSynapse360Run(PositionConnSynapse360* me) {
    ...
    enum PositionConnSynapse360States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE360_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE360_L: // Intra-location logic for state l
