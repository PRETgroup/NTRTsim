...
void PositionConnSynapse232Run(PositionConnSynapse232* me) {
    ...
    enum PositionConnSynapse232States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE232_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE232_L: // Intra-location logic for state l
