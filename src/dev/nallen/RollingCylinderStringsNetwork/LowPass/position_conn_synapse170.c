...
void PositionConnSynapse170Run(PositionConnSynapse170* me) {
    ...
    enum PositionConnSynapse170States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE170_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE170_L: // Intra-location logic for state l
