...
void PositionConnSynapse395Run(PositionConnSynapse395* me) {
    ...
    enum PositionConnSynapse395States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE395_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE395_L: // Intra-location logic for state l
