...
void PositionConnSynapse223Run(PositionConnSynapse223* me) {
    ...
    enum PositionConnSynapse223States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE223_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE223_L: // Intra-location logic for state l
