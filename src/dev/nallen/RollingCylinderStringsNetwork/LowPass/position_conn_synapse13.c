...
void PositionConnSynapse13Run(PositionConnSynapse13* me) {
    ...
    enum PositionConnSynapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE13_L: // Intra-location logic for state l
