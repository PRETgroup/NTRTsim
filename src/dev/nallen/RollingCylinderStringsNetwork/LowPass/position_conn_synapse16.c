...
void PositionConnSynapse16Run(PositionConnSynapse16* me) {
    ...
    enum PositionConnSynapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE16_L: // Intra-location logic for state l
