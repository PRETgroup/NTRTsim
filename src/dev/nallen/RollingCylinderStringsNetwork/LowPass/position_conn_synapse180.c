...
void PositionConnSynapse180Run(PositionConnSynapse180* me) {
    ...
    enum PositionConnSynapse180States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE180_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE180_L: // Intra-location logic for state l
