...
void PositionConnSynapse313Run(PositionConnSynapse313* me) {
    ...
    enum PositionConnSynapse313States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE313_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE313_L: // Intra-location logic for state l
