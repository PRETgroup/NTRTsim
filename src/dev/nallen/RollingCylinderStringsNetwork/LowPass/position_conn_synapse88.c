...
void PositionConnSynapse88Run(PositionConnSynapse88* me) {
    ...
    enum PositionConnSynapse88States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE88_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE88_L: // Intra-location logic for state l
