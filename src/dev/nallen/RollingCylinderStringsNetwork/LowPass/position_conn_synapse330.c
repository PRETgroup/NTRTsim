...
void PositionConnSynapse330Run(PositionConnSynapse330* me) {
    ...
    enum PositionConnSynapse330States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE330_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE330_L: // Intra-location logic for state l
