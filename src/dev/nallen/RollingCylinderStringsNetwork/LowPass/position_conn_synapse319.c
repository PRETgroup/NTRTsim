...
void PositionConnSynapse319Run(PositionConnSynapse319* me) {
    ...
    enum PositionConnSynapse319States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE319_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE319_L: // Intra-location logic for state l
