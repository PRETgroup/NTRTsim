...
void PositionConnSynapse154Run(PositionConnSynapse154* me) {
    ...
    enum PositionConnSynapse154States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE154_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE154_L: // Intra-location logic for state l
