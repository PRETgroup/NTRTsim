...
void PositionConnSynapse186Run(PositionConnSynapse186* me) {
    ...
    enum PositionConnSynapse186States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE186_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE186_L: // Intra-location logic for state l
