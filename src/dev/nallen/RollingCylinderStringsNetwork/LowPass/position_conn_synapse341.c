...
void PositionConnSynapse341Run(PositionConnSynapse341* me) {
    ...
    enum PositionConnSynapse341States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE341_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE341_L: // Intra-location logic for state l
