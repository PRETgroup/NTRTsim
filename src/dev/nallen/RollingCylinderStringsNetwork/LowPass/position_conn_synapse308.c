...
void PositionConnSynapse308Run(PositionConnSynapse308* me) {
    ...
    enum PositionConnSynapse308States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE308_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE308_L: // Intra-location logic for state l
