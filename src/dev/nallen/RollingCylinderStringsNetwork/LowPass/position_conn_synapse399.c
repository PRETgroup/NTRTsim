...
void PositionConnSynapse399Run(PositionConnSynapse399* me) {
    ...
    enum PositionConnSynapse399States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE399_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE399_L: // Intra-location logic for state l
