...
void PositionConnSynapse138Run(PositionConnSynapse138* me) {
    ...
    enum PositionConnSynapse138States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE138_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE138_L: // Intra-location logic for state l
