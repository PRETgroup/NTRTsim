...
void PositionConnSynapse191Run(PositionConnSynapse191* me) {
    ...
    enum PositionConnSynapse191States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE191_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE191_L: // Intra-location logic for state l
