...
void PositionConnSynapse95Run(PositionConnSynapse95* me) {
    ...
    enum PositionConnSynapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE95_L: // Intra-location logic for state l
