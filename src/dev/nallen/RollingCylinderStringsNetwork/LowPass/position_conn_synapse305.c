...
void PositionConnSynapse305Run(PositionConnSynapse305* me) {
    ...
    enum PositionConnSynapse305States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE305_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE305_L: // Intra-location logic for state l
