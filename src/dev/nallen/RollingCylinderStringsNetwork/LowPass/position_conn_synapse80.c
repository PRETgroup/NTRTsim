...
void PositionConnSynapse80Run(PositionConnSynapse80* me) {
    ...
    enum PositionConnSynapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE80_L: // Intra-location logic for state l
