...
void PositionConnSynapse28Run(PositionConnSynapse28* me) {
    ...
    enum PositionConnSynapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE28_L: // Intra-location logic for state l
