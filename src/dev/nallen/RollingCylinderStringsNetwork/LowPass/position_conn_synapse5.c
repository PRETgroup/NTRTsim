...
void PositionConnSynapse5Run(PositionConnSynapse5* me) {
    ...
    enum PositionConnSynapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE5_L: // Intra-location logic for state l
