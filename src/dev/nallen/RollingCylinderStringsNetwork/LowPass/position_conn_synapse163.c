...
void PositionConnSynapse163Run(PositionConnSynapse163* me) {
    ...
    enum PositionConnSynapse163States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE163_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE163_L: // Intra-location logic for state l
