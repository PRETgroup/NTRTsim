...
void PositionConnSynapse241Run(PositionConnSynapse241* me) {
    ...
    enum PositionConnSynapse241States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE241_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE241_L: // Intra-location logic for state l
