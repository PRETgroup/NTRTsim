...
void PositionConnSynapse227Run(PositionConnSynapse227* me) {
    ...
    enum PositionConnSynapse227States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE227_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE227_L: // Intra-location logic for state l
