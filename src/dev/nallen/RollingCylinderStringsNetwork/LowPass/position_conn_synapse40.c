...
void PositionConnSynapse40Run(PositionConnSynapse40* me) {
    ...
    enum PositionConnSynapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE40_L: // Intra-location logic for state l
