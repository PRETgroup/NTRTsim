...
void PositionConnSynapse96Run(PositionConnSynapse96* me) {
    ...
    enum PositionConnSynapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE96_L: // Intra-location logic for state l
