...
void PositionConnSynapse31Run(PositionConnSynapse31* me) {
    ...
    enum PositionConnSynapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE31_L: // Intra-location logic for state l
