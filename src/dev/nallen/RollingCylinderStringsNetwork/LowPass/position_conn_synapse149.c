...
void PositionConnSynapse149Run(PositionConnSynapse149* me) {
    ...
    enum PositionConnSynapse149States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE149_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE149_L: // Intra-location logic for state l
