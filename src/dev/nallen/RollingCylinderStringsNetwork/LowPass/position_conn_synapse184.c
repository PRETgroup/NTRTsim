...
void PositionConnSynapse184Run(PositionConnSynapse184* me) {
    ...
    enum PositionConnSynapse184States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE184_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE184_L: // Intra-location logic for state l
