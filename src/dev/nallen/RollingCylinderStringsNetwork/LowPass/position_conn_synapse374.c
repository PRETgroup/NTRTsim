...
void PositionConnSynapse374Run(PositionConnSynapse374* me) {
    ...
    enum PositionConnSynapse374States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE374_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE374_L: // Intra-location logic for state l
