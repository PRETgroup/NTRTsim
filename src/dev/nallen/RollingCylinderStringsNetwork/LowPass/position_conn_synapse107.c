...
void PositionConnSynapse107Run(PositionConnSynapse107* me) {
    ...
    enum PositionConnSynapse107States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE107_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE107_L: // Intra-location logic for state l
