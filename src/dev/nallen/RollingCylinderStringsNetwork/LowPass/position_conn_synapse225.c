...
void PositionConnSynapse225Run(PositionConnSynapse225* me) {
    ...
    enum PositionConnSynapse225States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE225_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE225_L: // Intra-location logic for state l
