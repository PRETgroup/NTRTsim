...
void PositionConnSynapse260Run(PositionConnSynapse260* me) {
    ...
    enum PositionConnSynapse260States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE260_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE260_L: // Intra-location logic for state l
