...
void PositionConnSynapse122Run(PositionConnSynapse122* me) {
    ...
    enum PositionConnSynapse122States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE122_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE122_L: // Intra-location logic for state l
