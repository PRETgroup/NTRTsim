...
void PositionConnSynapse20Run(PositionConnSynapse20* me) {
    ...
    enum PositionConnSynapse20States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE20_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE20_L: // Intra-location logic for state l
