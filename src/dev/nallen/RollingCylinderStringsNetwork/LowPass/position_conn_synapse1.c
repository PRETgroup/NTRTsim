...
void PositionConnSynapse1Run(PositionConnSynapse1* me) {
    ...
    enum PositionConnSynapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE1_L: // Intra-location logic for state l
