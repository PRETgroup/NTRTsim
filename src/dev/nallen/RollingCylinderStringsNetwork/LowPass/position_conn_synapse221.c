...
void PositionConnSynapse221Run(PositionConnSynapse221* me) {
    ...
    enum PositionConnSynapse221States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE221_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE221_L: // Intra-location logic for state l
