...
void PositionConnSynapse112Run(PositionConnSynapse112* me) {
    ...
    enum PositionConnSynapse112States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE112_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE112_L: // Intra-location logic for state l
