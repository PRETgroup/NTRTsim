...
void PositionConnSynapse196Run(PositionConnSynapse196* me) {
    ...
    enum PositionConnSynapse196States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE196_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE196_L: // Intra-location logic for state l
