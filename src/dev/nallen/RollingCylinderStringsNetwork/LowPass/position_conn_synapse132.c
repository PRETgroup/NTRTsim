...
void PositionConnSynapse132Run(PositionConnSynapse132* me) {
    ...
    enum PositionConnSynapse132States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE132_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE132_L: // Intra-location logic for state l
