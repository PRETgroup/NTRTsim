...
void PositionConnSynapse22Run(PositionConnSynapse22* me) {
    ...
    enum PositionConnSynapse22States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE22_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE22_L: // Intra-location logic for state l
