...
void PositionConnSynapse128Run(PositionConnSynapse128* me) {
    ...
    enum PositionConnSynapse128States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE128_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE128_L: // Intra-location logic for state l
