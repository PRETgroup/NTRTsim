...
void PositionConnSynapse250Run(PositionConnSynapse250* me) {
    ...
    enum PositionConnSynapse250States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE250_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE250_L: // Intra-location logic for state l
