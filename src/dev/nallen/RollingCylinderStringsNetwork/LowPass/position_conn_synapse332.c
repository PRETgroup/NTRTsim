...
void PositionConnSynapse332Run(PositionConnSynapse332* me) {
    ...
    enum PositionConnSynapse332States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE332_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE332_L: // Intra-location logic for state l
