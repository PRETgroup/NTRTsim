...
void PositionConnSynapse125Run(PositionConnSynapse125* me) {
    ...
    enum PositionConnSynapse125States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE125_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE125_L: // Intra-location logic for state l
