...
void PositionConnSynapse288Run(PositionConnSynapse288* me) {
    ...
    enum PositionConnSynapse288States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE288_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE288_L: // Intra-location logic for state l
