...
void PositionConnSynapse177Run(PositionConnSynapse177* me) {
    ...
    enum PositionConnSynapse177States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE177_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE177_L: // Intra-location logic for state l
