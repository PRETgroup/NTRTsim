...
void PositionConnSynapse256Run(PositionConnSynapse256* me) {
    ...
    enum PositionConnSynapse256States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE256_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE256_L: // Intra-location logic for state l
