...
void PositionConnSynapse381Run(PositionConnSynapse381* me) {
    ...
    enum PositionConnSynapse381States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE381_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE381_L: // Intra-location logic for state l
