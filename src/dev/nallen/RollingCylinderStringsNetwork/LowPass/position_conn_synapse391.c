...
void PositionConnSynapse391Run(PositionConnSynapse391* me) {
    ...
    enum PositionConnSynapse391States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE391_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE391_L: // Intra-location logic for state l
