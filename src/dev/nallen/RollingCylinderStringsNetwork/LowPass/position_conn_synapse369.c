...
void PositionConnSynapse369Run(PositionConnSynapse369* me) {
    ...
    enum PositionConnSynapse369States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE369_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE369_L: // Intra-location logic for state l
