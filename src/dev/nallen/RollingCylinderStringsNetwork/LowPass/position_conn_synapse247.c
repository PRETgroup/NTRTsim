...
void PositionConnSynapse247Run(PositionConnSynapse247* me) {
    ...
    enum PositionConnSynapse247States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE247_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE247_L: // Intra-location logic for state l
