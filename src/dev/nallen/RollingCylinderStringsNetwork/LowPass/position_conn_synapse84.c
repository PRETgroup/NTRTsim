...
void PositionConnSynapse84Run(PositionConnSynapse84* me) {
    ...
    enum PositionConnSynapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE84_L: // Intra-location logic for state l
