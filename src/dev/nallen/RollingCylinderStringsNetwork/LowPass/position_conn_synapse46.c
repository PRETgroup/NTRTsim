...
void PositionConnSynapse46Run(PositionConnSynapse46* me) {
    ...
    enum PositionConnSynapse46States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE46_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE46_L: // Intra-location logic for state l
