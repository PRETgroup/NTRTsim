...
void PositionConnSynapse205Run(PositionConnSynapse205* me) {
    ...
    enum PositionConnSynapse205States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE205_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE205_L: // Intra-location logic for state l
