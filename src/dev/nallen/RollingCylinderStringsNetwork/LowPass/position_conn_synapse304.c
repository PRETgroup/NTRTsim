...
void PositionConnSynapse304Run(PositionConnSynapse304* me) {
    ...
    enum PositionConnSynapse304States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE304_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE304_L: // Intra-location logic for state l
