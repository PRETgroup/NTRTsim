...
void PositionConnSynapse213Run(PositionConnSynapse213* me) {
    ...
    enum PositionConnSynapse213States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE213_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE213_L: // Intra-location logic for state l
