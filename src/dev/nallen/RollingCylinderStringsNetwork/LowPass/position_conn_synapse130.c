...
void PositionConnSynapse130Run(PositionConnSynapse130* me) {
    ...
    enum PositionConnSynapse130States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE130_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE130_L: // Intra-location logic for state l
