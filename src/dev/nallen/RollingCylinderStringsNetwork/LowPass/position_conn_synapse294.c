...
void PositionConnSynapse294Run(PositionConnSynapse294* me) {
    ...
    enum PositionConnSynapse294States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE294_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE294_L: // Intra-location logic for state l
