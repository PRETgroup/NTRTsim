...
void PositionConnSynapse334Run(PositionConnSynapse334* me) {
    ...
    enum PositionConnSynapse334States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE334_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE334_L: // Intra-location logic for state l
