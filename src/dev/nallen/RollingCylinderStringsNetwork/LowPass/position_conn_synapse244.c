...
void PositionConnSynapse244Run(PositionConnSynapse244* me) {
    ...
    enum PositionConnSynapse244States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE244_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE244_L: // Intra-location logic for state l
