...
void PositionConnSynapse167Run(PositionConnSynapse167* me) {
    ...
    enum PositionConnSynapse167States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE167_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE167_L: // Intra-location logic for state l
