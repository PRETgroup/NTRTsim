...
void PositionConnSynapse336Run(PositionConnSynapse336* me) {
    ...
    enum PositionConnSynapse336States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE336_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE336_L: // Intra-location logic for state l
