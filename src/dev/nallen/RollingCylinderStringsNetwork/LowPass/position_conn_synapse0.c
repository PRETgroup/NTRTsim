...
void PositionConnSynapse0Run(PositionConnSynapse0* me) {
    ...
    enum PositionConnSynapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE0_L: // Intra-location logic for state l
