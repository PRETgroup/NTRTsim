...
void PositionConnSynapse366Run(PositionConnSynapse366* me) {
    ...
    enum PositionConnSynapse366States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE366_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE366_L: // Intra-location logic for state l
