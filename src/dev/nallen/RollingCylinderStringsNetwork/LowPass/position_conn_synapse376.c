...
void PositionConnSynapse376Run(PositionConnSynapse376* me) {
    ...
    enum PositionConnSynapse376States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE376_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE376_L: // Intra-location logic for state l
