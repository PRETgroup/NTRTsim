...
void PositionConnSynapse317Run(PositionConnSynapse317* me) {
    ...
    enum PositionConnSynapse317States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE317_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE317_L: // Intra-location logic for state l
