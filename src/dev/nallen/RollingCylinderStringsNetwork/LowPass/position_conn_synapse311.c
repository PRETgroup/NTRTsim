...
void PositionConnSynapse311Run(PositionConnSynapse311* me) {
    ...
    enum PositionConnSynapse311States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE311_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE311_L: // Intra-location logic for state l
