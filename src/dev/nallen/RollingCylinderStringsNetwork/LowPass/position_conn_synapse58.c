...
void PositionConnSynapse58Run(PositionConnSynapse58* me) {
    ...
    enum PositionConnSynapse58States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE58_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE58_L: // Intra-location logic for state l
