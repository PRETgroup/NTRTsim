...
void PositionConnSynapse198Run(PositionConnSynapse198* me) {
    ...
    enum PositionConnSynapse198States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE198_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE198_L: // Intra-location logic for state l
