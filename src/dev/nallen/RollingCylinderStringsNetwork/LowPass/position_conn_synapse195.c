...
void PositionConnSynapse195Run(PositionConnSynapse195* me) {
    ...
    enum PositionConnSynapse195States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE195_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE195_L: // Intra-location logic for state l
