...
void PositionConnSynapse367Run(PositionConnSynapse367* me) {
    ...
    enum PositionConnSynapse367States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE367_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE367_L: // Intra-location logic for state l
