...
void PositionConnSynapse24Run(PositionConnSynapse24* me) {
    ...
    enum PositionConnSynapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE24_L: // Intra-location logic for state l
