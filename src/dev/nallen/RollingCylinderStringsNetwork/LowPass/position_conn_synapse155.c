...
void PositionConnSynapse155Run(PositionConnSynapse155* me) {
    ...
    enum PositionConnSynapse155States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE155_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE155_L: // Intra-location logic for state l
