...
void PositionConnSynapse299Run(PositionConnSynapse299* me) {
    ...
    enum PositionConnSynapse299States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE299_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE299_L: // Intra-location logic for state l
