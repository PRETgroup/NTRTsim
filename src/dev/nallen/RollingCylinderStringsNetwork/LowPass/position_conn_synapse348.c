...
void PositionConnSynapse348Run(PositionConnSynapse348* me) {
    ...
    enum PositionConnSynapse348States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE348_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE348_L: // Intra-location logic for state l
