...
void PositionConnSynapse103Run(PositionConnSynapse103* me) {
    ...
    enum PositionConnSynapse103States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE103_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE103_L: // Intra-location logic for state l
