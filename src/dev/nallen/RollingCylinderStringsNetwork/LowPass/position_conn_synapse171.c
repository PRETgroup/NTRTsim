...
void PositionConnSynapse171Run(PositionConnSynapse171* me) {
    ...
    enum PositionConnSynapse171States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE171_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE171_L: // Intra-location logic for state l
