...
void PositionConnSynapse283Run(PositionConnSynapse283* me) {
    ...
    enum PositionConnSynapse283States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE283_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE283_L: // Intra-location logic for state l
