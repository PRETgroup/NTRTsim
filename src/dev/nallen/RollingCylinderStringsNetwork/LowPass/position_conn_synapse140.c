...
void PositionConnSynapse140Run(PositionConnSynapse140* me) {
    ...
    enum PositionConnSynapse140States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE140_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE140_L: // Intra-location logic for state l
