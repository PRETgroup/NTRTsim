...
void PositionConnSynapse323Run(PositionConnSynapse323* me) {
    ...
    enum PositionConnSynapse323States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE323_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE323_L: // Intra-location logic for state l
