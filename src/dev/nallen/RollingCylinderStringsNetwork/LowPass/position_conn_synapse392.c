...
void PositionConnSynapse392Run(PositionConnSynapse392* me) {
    ...
    enum PositionConnSynapse392States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE392_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE392_L: // Intra-location logic for state l
