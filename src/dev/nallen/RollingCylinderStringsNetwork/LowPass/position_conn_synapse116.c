...
void PositionConnSynapse116Run(PositionConnSynapse116* me) {
    ...
    enum PositionConnSynapse116States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE116_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE116_L: // Intra-location logic for state l
