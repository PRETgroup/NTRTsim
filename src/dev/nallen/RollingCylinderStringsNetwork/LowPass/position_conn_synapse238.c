...
void PositionConnSynapse238Run(PositionConnSynapse238* me) {
    ...
    enum PositionConnSynapse238States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE238_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE238_L: // Intra-location logic for state l
