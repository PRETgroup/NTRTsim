...
void PositionConnSynapse117Run(PositionConnSynapse117* me) {
    ...
    enum PositionConnSynapse117States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE117_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE117_L: // Intra-location logic for state l
