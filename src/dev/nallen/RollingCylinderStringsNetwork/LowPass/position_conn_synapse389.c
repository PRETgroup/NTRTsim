...
void PositionConnSynapse389Run(PositionConnSynapse389* me) {
    ...
    enum PositionConnSynapse389States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE389_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE389_L: // Intra-location logic for state l
