...
void PositionConnSynapse358Run(PositionConnSynapse358* me) {
    ...
    enum PositionConnSynapse358States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE358_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE358_L: // Intra-location logic for state l
