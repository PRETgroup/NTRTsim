...
void PositionConnSynapse121Run(PositionConnSynapse121* me) {
    ...
    enum PositionConnSynapse121States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE121_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE121_L: // Intra-location logic for state l
