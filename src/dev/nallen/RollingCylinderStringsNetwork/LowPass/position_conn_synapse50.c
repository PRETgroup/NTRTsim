...
void PositionConnSynapse50Run(PositionConnSynapse50* me) {
    ...
    enum PositionConnSynapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case POSITION_CONN_SYNAPSE50_L: // Intra-location logic for state l
