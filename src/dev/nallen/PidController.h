...
#ifndef HANGER_PID_CONTROLLER_H
#define HANGER_PID_CONTROLLER_H
...
#define MARKER_HANGER_LEFT 0
#define MARKER_HANGER_RIGHT 1
#define MARKER_TOP_BAR_LEFT 2
#define MARKER_TOP_BAR_RIGHT 3

#define P_CONSTANT 10
#define I_CONSTANT 0
#define D_CONSTANT 0.1
 ...
 */
class PidController : public tgObserver<TensegrityModel>, public tgSubject<PidController>
{
public:
   ...
   */
  PidController(double rate, double minLength, double maxLength);
