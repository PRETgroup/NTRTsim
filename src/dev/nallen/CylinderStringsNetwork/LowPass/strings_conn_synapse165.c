...
void StringsConnSynapse165Run(StringsConnSynapse165* me) {
    ...
    enum StringsConnSynapse165States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE165_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE165_L: // Intra-location logic for state l
