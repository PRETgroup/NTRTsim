...
void StringsConnSynapse173Run(StringsConnSynapse173* me) {
    ...
    enum StringsConnSynapse173States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE173_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE173_L: // Intra-location logic for state l
