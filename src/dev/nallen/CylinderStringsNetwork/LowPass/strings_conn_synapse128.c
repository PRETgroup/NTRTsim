...
void StringsConnSynapse128Run(StringsConnSynapse128* me) {
    ...
    enum StringsConnSynapse128States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE128_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE128_L: // Intra-location logic for state l
