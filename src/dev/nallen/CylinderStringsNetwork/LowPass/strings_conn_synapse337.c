...
void StringsConnSynapse337Run(StringsConnSynapse337* me) {
    ...
    enum StringsConnSynapse337States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE337_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE337_L: // Intra-location logic for state l
