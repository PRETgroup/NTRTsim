...
void StringsConnSynapse312Run(StringsConnSynapse312* me) {
    ...
    enum StringsConnSynapse312States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE312_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE312_L: // Intra-location logic for state l
