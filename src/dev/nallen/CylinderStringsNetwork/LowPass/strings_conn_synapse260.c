...
void StringsConnSynapse260Run(StringsConnSynapse260* me) {
    ...
    enum StringsConnSynapse260States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE260_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE260_L: // Intra-location logic for state l
