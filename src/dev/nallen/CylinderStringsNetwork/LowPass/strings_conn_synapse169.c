...
void StringsConnSynapse169Run(StringsConnSynapse169* me) {
    ...
    enum StringsConnSynapse169States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE169_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE169_L: // Intra-location logic for state l
