...
void StringsConnSynapse49Run(StringsConnSynapse49* me) {
    ...
    enum StringsConnSynapse49States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE49_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE49_L: // Intra-location logic for state l
