...
void StringsConnSynapse170Run(StringsConnSynapse170* me) {
    ...
    enum StringsConnSynapse170States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE170_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE170_L: // Intra-location logic for state l
