...
void StringsConnSynapse66Run(StringsConnSynapse66* me) {
    ...
    enum StringsConnSynapse66States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE66_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE66_L: // Intra-location logic for state l
