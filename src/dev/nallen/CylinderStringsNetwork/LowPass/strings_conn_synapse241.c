...
void StringsConnSynapse241Run(StringsConnSynapse241* me) {
    ...
    enum StringsConnSynapse241States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE241_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE241_L: // Intra-location logic for state l
