...
void StringsConnSynapse80Run(StringsConnSynapse80* me) {
    ...
    enum StringsConnSynapse80States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE80_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE80_L: // Intra-location logic for state l
