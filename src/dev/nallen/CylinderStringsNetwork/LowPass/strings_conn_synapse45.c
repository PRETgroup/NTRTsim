...
void StringsConnSynapse45Run(StringsConnSynapse45* me) {
    ...
    enum StringsConnSynapse45States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE45_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE45_L: // Intra-location logic for state l
