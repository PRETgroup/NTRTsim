...
void StringsConnSynapse204Run(StringsConnSynapse204* me) {
    ...
    enum StringsConnSynapse204States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE204_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE204_L: // Intra-location logic for state l
