...
void StringsConnSynapse112Run(StringsConnSynapse112* me) {
    ...
    enum StringsConnSynapse112States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE112_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE112_L: // Intra-location logic for state l
