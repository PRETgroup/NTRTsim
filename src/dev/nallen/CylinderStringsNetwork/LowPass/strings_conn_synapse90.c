...
void StringsConnSynapse90Run(StringsConnSynapse90* me) {
    ...
    enum StringsConnSynapse90States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE90_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE90_L: // Intra-location logic for state l
