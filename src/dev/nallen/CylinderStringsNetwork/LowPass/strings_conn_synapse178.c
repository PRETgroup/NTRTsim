...
void StringsConnSynapse178Run(StringsConnSynapse178* me) {
    ...
    enum StringsConnSynapse178States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE178_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE178_L: // Intra-location logic for state l
