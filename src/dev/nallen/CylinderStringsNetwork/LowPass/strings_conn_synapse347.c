...
void StringsConnSynapse347Run(StringsConnSynapse347* me) {
    ...
    enum StringsConnSynapse347States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE347_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE347_L: // Intra-location logic for state l
