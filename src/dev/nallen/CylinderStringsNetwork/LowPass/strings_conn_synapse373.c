...
void StringsConnSynapse373Run(StringsConnSynapse373* me) {
    ...
    enum StringsConnSynapse373States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE373_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE373_L: // Intra-location logic for state l
