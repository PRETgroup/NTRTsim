...
void StringsConnSynapse341Run(StringsConnSynapse341* me) {
    ...
    enum StringsConnSynapse341States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE341_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE341_L: // Intra-location logic for state l
