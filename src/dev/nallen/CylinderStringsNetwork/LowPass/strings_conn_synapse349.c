...
void StringsConnSynapse349Run(StringsConnSynapse349* me) {
    ...
    enum StringsConnSynapse349States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE349_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE349_L: // Intra-location logic for state l
