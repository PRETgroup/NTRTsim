...
void StringsConnSynapse271Run(StringsConnSynapse271* me) {
    ...
    enum StringsConnSynapse271States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE271_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE271_L: // Intra-location logic for state l
