...
void StringsConnSynapse277Run(StringsConnSynapse277* me) {
    ...
    enum StringsConnSynapse277States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE277_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE277_L: // Intra-location logic for state l
