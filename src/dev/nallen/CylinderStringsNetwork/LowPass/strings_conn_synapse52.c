...
void StringsConnSynapse52Run(StringsConnSynapse52* me) {
    ...
    enum StringsConnSynapse52States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE52_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE52_L: // Intra-location logic for state l
