...
void StringsConnSynapse346Run(StringsConnSynapse346* me) {
    ...
    enum StringsConnSynapse346States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE346_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE346_L: // Intra-location logic for state l
