...
void StringsConnSynapse180Run(StringsConnSynapse180* me) {
    ...
    enum StringsConnSynapse180States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE180_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE180_L: // Intra-location logic for state l
