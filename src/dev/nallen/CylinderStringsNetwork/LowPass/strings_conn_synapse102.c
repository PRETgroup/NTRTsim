...
void StringsConnSynapse102Run(StringsConnSynapse102* me) {
    ...
    enum StringsConnSynapse102States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE102_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE102_L: // Intra-location logic for state l
