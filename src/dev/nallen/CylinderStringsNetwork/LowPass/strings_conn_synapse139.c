...
void StringsConnSynapse139Run(StringsConnSynapse139* me) {
    ...
    enum StringsConnSynapse139States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE139_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE139_L: // Intra-location logic for state l
