...
void StringsConnSynapse270Run(StringsConnSynapse270* me) {
    ...
    enum StringsConnSynapse270States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE270_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE270_L: // Intra-location logic for state l
