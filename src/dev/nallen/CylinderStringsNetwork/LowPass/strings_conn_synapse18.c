...
void StringsConnSynapse18Run(StringsConnSynapse18* me) {
    ...
    enum StringsConnSynapse18States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE18_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE18_L: // Intra-location logic for state l
