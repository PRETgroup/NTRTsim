...
void StringsConnSynapse27Run(StringsConnSynapse27* me) {
    ...
    enum StringsConnSynapse27States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE27_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE27_L: // Intra-location logic for state l
