...
void StringsConnSynapse59Run(StringsConnSynapse59* me) {
    ...
    enum StringsConnSynapse59States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE59_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE59_L: // Intra-location logic for state l
