...
void StringsConnSynapse39Run(StringsConnSynapse39* me) {
    ...
    enum StringsConnSynapse39States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE39_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE39_L: // Intra-location logic for state l
