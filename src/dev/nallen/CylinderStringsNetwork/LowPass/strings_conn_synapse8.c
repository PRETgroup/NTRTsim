...
void StringsConnSynapse8Run(StringsConnSynapse8* me) {
    ...
    enum StringsConnSynapse8States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE8_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE8_L: // Intra-location logic for state l
