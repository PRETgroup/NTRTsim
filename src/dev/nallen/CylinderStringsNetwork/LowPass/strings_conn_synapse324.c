...
void StringsConnSynapse324Run(StringsConnSynapse324* me) {
    ...
    enum StringsConnSynapse324States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE324_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE324_L: // Intra-location logic for state l
