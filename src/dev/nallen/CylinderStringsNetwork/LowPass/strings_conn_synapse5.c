...
void StringsConnSynapse5Run(StringsConnSynapse5* me) {
    ...
    enum StringsConnSynapse5States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE5_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE5_L: // Intra-location logic for state l
