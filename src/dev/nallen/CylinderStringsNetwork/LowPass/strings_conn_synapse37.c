...
void StringsConnSynapse37Run(StringsConnSynapse37* me) {
    ...
    enum StringsConnSynapse37States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE37_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE37_L: // Intra-location logic for state l
