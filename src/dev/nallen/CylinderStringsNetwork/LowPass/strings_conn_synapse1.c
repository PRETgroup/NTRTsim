...
void StringsConnSynapse1Run(StringsConnSynapse1* me) {
    ...
    enum StringsConnSynapse1States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE1_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE1_L: // Intra-location logic for state l
