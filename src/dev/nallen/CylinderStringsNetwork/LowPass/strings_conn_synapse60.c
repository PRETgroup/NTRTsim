...
void StringsConnSynapse60Run(StringsConnSynapse60* me) {
    ...
    enum StringsConnSynapse60States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE60_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE60_L: // Intra-location logic for state l
