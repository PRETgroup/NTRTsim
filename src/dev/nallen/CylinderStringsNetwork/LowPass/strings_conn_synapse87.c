...
void StringsConnSynapse87Run(StringsConnSynapse87* me) {
    ...
    enum StringsConnSynapse87States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE87_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE87_L: // Intra-location logic for state l
