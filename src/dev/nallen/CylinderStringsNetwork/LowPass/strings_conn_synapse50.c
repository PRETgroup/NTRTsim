...
void StringsConnSynapse50Run(StringsConnSynapse50* me) {
    ...
    enum StringsConnSynapse50States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE50_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE50_L: // Intra-location logic for state l
