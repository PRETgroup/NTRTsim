...
void StringsConnSynapse108Run(StringsConnSynapse108* me) {
    ...
    enum StringsConnSynapse108States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE108_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE108_L: // Intra-location logic for state l
