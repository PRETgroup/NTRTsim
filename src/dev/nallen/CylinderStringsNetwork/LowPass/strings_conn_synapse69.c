...
void StringsConnSynapse69Run(StringsConnSynapse69* me) {
    ...
    enum StringsConnSynapse69States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE69_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE69_L: // Intra-location logic for state l
