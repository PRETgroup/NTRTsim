...
void StringsConnSynapse366Run(StringsConnSynapse366* me) {
    ...
    enum StringsConnSynapse366States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE366_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE366_L: // Intra-location logic for state l
