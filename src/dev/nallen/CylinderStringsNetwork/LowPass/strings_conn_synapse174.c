...
void StringsConnSynapse174Run(StringsConnSynapse174* me) {
    ...
    enum StringsConnSynapse174States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE174_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE174_L: // Intra-location logic for state l
