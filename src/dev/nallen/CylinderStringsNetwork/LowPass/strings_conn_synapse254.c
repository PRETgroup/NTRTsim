...
void StringsConnSynapse254Run(StringsConnSynapse254* me) {
    ...
    enum StringsConnSynapse254States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE254_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE254_L: // Intra-location logic for state l
