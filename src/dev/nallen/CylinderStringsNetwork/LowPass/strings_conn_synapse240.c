...
void StringsConnSynapse240Run(StringsConnSynapse240* me) {
    ...
    enum StringsConnSynapse240States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE240_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE240_L: // Intra-location logic for state l
