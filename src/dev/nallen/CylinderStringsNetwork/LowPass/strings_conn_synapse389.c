...
void StringsConnSynapse389Run(StringsConnSynapse389* me) {
    ...
    enum StringsConnSynapse389States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE389_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE389_L: // Intra-location logic for state l
