...
void StringsConnSynapse288Run(StringsConnSynapse288* me) {
    ...
    enum StringsConnSynapse288States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE288_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE288_L: // Intra-location logic for state l
