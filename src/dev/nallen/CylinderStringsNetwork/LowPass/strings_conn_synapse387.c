...
void StringsConnSynapse387Run(StringsConnSynapse387* me) {
    ...
    enum StringsConnSynapse387States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE387_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE387_L: // Intra-location logic for state l
