...
void StringsConnSynapse328Run(StringsConnSynapse328* me) {
    ...
    enum StringsConnSynapse328States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE328_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE328_L: // Intra-location logic for state l
