...
void StringsConnSynapse34Run(StringsConnSynapse34* me) {
    ...
    enum StringsConnSynapse34States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE34_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE34_L: // Intra-location logic for state l
