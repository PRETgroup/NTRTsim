...
void StringsConnSynapse249Run(StringsConnSynapse249* me) {
    ...
    enum StringsConnSynapse249States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE249_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE249_L: // Intra-location logic for state l
