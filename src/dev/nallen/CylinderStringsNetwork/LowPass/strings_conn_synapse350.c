...
void StringsConnSynapse350Run(StringsConnSynapse350* me) {
    ...
    enum StringsConnSynapse350States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE350_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE350_L: // Intra-location logic for state l
