...
void StringsConnSynapse202Run(StringsConnSynapse202* me) {
    ...
    enum StringsConnSynapse202States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE202_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE202_L: // Intra-location logic for state l
