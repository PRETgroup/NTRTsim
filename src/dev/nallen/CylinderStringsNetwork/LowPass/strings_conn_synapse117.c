...
void StringsConnSynapse117Run(StringsConnSynapse117* me) {
    ...
    enum StringsConnSynapse117States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE117_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE117_L: // Intra-location logic for state l
