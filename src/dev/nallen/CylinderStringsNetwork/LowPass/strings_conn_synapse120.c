...
void StringsConnSynapse120Run(StringsConnSynapse120* me) {
    ...
    enum StringsConnSynapse120States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE120_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE120_L: // Intra-location logic for state l
