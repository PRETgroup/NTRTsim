...
void StringsConnSynapse244Run(StringsConnSynapse244* me) {
    ...
    enum StringsConnSynapse244States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE244_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE244_L: // Intra-location logic for state l
