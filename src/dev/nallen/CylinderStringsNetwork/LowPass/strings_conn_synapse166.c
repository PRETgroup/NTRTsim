...
void StringsConnSynapse166Run(StringsConnSynapse166* me) {
    ...
    enum StringsConnSynapse166States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE166_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE166_L: // Intra-location logic for state l
