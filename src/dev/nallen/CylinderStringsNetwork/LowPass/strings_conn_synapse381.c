...
void StringsConnSynapse381Run(StringsConnSynapse381* me) {
    ...
    enum StringsConnSynapse381States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE381_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE381_L: // Intra-location logic for state l
