...
void StringsConnSynapse344Run(StringsConnSynapse344* me) {
    ...
    enum StringsConnSynapse344States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE344_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE344_L: // Intra-location logic for state l
