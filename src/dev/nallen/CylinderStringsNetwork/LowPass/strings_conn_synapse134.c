...
void StringsConnSynapse134Run(StringsConnSynapse134* me) {
    ...
    enum StringsConnSynapse134States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE134_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE134_L: // Intra-location logic for state l
