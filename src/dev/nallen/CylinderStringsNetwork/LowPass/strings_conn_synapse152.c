...
void StringsConnSynapse152Run(StringsConnSynapse152* me) {
    ...
    enum StringsConnSynapse152States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE152_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE152_L: // Intra-location logic for state l
