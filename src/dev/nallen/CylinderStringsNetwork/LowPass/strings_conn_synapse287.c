...
void StringsConnSynapse287Run(StringsConnSynapse287* me) {
    ...
    enum StringsConnSynapse287States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE287_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE287_L: // Intra-location logic for state l
