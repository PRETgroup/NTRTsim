...
void StringsConnSynapse300Run(StringsConnSynapse300* me) {
    ...
    enum StringsConnSynapse300States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE300_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE300_L: // Intra-location logic for state l
