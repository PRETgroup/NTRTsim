...
void StringsConnSynapse122Run(StringsConnSynapse122* me) {
    ...
    enum StringsConnSynapse122States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE122_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE122_L: // Intra-location logic for state l
