...
void StringsConnSynapse179Run(StringsConnSynapse179* me) {
    ...
    enum StringsConnSynapse179States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE179_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE179_L: // Intra-location logic for state l
