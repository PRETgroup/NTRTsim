...
void StringsConnSynapse121Run(StringsConnSynapse121* me) {
    ...
    enum StringsConnSynapse121States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE121_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE121_L: // Intra-location logic for state l
