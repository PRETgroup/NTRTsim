...
void StringsConnSynapse40Run(StringsConnSynapse40* me) {
    ...
    enum StringsConnSynapse40States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE40_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE40_L: // Intra-location logic for state l
