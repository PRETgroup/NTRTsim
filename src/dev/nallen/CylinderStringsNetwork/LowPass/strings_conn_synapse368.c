...
void StringsConnSynapse368Run(StringsConnSynapse368* me) {
    ...
    enum StringsConnSynapse368States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE368_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE368_L: // Intra-location logic for state l
