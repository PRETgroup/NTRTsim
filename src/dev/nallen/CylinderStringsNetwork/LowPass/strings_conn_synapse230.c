...
void StringsConnSynapse230Run(StringsConnSynapse230* me) {
    ...
    enum StringsConnSynapse230States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE230_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE230_L: // Intra-location logic for state l
