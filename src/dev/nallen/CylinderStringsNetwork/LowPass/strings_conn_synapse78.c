...
void StringsConnSynapse78Run(StringsConnSynapse78* me) {
    ...
    enum StringsConnSynapse78States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE78_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE78_L: // Intra-location logic for state l
