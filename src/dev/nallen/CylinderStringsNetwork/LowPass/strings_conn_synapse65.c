...
void StringsConnSynapse65Run(StringsConnSynapse65* me) {
    ...
    enum StringsConnSynapse65States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE65_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE65_L: // Intra-location logic for state l
