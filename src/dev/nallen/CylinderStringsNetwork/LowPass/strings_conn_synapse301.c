...
void StringsConnSynapse301Run(StringsConnSynapse301* me) {
    ...
    enum StringsConnSynapse301States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE301_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE301_L: // Intra-location logic for state l
