...
void StringsConnSynapse57Run(StringsConnSynapse57* me) {
    ...
    enum StringsConnSynapse57States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE57_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE57_L: // Intra-location logic for state l
