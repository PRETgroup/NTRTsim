...
void StringsConnSynapse125Run(StringsConnSynapse125* me) {
    ...
    enum StringsConnSynapse125States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE125_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE125_L: // Intra-location logic for state l
