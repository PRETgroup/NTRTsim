...
void StringsConnSynapse264Run(StringsConnSynapse264* me) {
    ...
    enum StringsConnSynapse264States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE264_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE264_L: // Intra-location logic for state l
