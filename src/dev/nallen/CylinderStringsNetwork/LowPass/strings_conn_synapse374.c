...
void StringsConnSynapse374Run(StringsConnSynapse374* me) {
    ...
    enum StringsConnSynapse374States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE374_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE374_L: // Intra-location logic for state l
