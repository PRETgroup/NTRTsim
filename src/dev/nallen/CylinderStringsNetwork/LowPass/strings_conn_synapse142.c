...
void StringsConnSynapse142Run(StringsConnSynapse142* me) {
    ...
    enum StringsConnSynapse142States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE142_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE142_L: // Intra-location logic for state l
