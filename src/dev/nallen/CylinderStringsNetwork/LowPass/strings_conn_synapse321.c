...
void StringsConnSynapse321Run(StringsConnSynapse321* me) {
    ...
    enum StringsConnSynapse321States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE321_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE321_L: // Intra-location logic for state l
