...
void StringsConnSynapse255Run(StringsConnSynapse255* me) {
    ...
    enum StringsConnSynapse255States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE255_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE255_L: // Intra-location logic for state l
