...
void StringsConnSynapse56Run(StringsConnSynapse56* me) {
    ...
    enum StringsConnSynapse56States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE56_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE56_L: // Intra-location logic for state l
