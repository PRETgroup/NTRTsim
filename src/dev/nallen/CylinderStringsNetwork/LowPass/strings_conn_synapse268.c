...
void StringsConnSynapse268Run(StringsConnSynapse268* me) {
    ...
    enum StringsConnSynapse268States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE268_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE268_L: // Intra-location logic for state l
