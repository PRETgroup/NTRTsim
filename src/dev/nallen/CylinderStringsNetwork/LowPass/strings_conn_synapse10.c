...
void StringsConnSynapse10Run(StringsConnSynapse10* me) {
    ...
    enum StringsConnSynapse10States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE10_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE10_L: // Intra-location logic for state l
