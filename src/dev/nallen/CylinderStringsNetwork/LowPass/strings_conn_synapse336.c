...
void StringsConnSynapse336Run(StringsConnSynapse336* me) {
    ...
    enum StringsConnSynapse336States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE336_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE336_L: // Intra-location logic for state l
