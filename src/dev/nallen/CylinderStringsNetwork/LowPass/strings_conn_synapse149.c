...
void StringsConnSynapse149Run(StringsConnSynapse149* me) {
    ...
    enum StringsConnSynapse149States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE149_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE149_L: // Intra-location logic for state l
