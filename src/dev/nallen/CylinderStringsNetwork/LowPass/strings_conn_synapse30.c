...
void StringsConnSynapse30Run(StringsConnSynapse30* me) {
    ...
    enum StringsConnSynapse30States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE30_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE30_L: // Intra-location logic for state l
