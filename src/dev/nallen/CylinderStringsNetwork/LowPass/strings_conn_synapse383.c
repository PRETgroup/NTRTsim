...
void StringsConnSynapse383Run(StringsConnSynapse383* me) {
    ...
    enum StringsConnSynapse383States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE383_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE383_L: // Intra-location logic for state l
