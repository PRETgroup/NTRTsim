...
void StringsConnSynapse225Run(StringsConnSynapse225* me) {
    ...
    enum StringsConnSynapse225States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE225_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE225_L: // Intra-location logic for state l
