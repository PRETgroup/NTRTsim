...
void StringsConnSynapse208Run(StringsConnSynapse208* me) {
    ...
    enum StringsConnSynapse208States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE208_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE208_L: // Intra-location logic for state l
