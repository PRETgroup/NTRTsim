...
void StringsConnSynapse327Run(StringsConnSynapse327* me) {
    ...
    enum StringsConnSynapse327States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE327_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE327_L: // Intra-location logic for state l
