...
void StringsConnSynapse322Run(StringsConnSynapse322* me) {
    ...
    enum StringsConnSynapse322States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE322_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE322_L: // Intra-location logic for state l
