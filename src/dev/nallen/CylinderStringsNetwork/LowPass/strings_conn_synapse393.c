...
void StringsConnSynapse393Run(StringsConnSynapse393* me) {
    ...
    enum StringsConnSynapse393States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE393_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE393_L: // Intra-location logic for state l
