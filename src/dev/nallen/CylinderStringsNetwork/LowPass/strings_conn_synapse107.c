...
void StringsConnSynapse107Run(StringsConnSynapse107* me) {
    ...
    enum StringsConnSynapse107States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE107_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE107_L: // Intra-location logic for state l
