...
void StringsConnSynapse126Run(StringsConnSynapse126* me) {
    ...
    enum StringsConnSynapse126States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE126_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE126_L: // Intra-location logic for state l
