...
void StringsConnSynapse72Run(StringsConnSynapse72* me) {
    ...
    enum StringsConnSynapse72States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE72_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE72_L: // Intra-location logic for state l
