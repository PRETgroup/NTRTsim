...
void StringsConnSynapse197Run(StringsConnSynapse197* me) {
    ...
    enum StringsConnSynapse197States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE197_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE197_L: // Intra-location logic for state l
