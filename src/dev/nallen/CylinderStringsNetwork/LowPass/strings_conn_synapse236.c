...
void StringsConnSynapse236Run(StringsConnSynapse236* me) {
    ...
    enum StringsConnSynapse236States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE236_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE236_L: // Intra-location logic for state l
