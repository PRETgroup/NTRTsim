...
void StringsConnSynapse95Run(StringsConnSynapse95* me) {
    ...
    enum StringsConnSynapse95States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE95_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE95_L: // Intra-location logic for state l
