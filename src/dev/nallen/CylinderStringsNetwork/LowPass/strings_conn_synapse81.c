...
void StringsConnSynapse81Run(StringsConnSynapse81* me) {
    ...
    enum StringsConnSynapse81States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE81_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE81_L: // Intra-location logic for state l
