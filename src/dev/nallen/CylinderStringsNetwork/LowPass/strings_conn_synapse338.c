...
void StringsConnSynapse338Run(StringsConnSynapse338* me) {
    ...
    enum StringsConnSynapse338States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE338_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE338_L: // Intra-location logic for state l
