...
void StringsConnSynapse188Run(StringsConnSynapse188* me) {
    ...
    enum StringsConnSynapse188States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE188_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE188_L: // Intra-location logic for state l
