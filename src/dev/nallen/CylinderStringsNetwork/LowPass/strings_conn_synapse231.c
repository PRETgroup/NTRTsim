...
void StringsConnSynapse231Run(StringsConnSynapse231* me) {
    ...
    enum StringsConnSynapse231States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE231_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE231_L: // Intra-location logic for state l
