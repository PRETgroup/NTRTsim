...
void StringsConnSynapse181Run(StringsConnSynapse181* me) {
    ...
    enum StringsConnSynapse181States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE181_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE181_L: // Intra-location logic for state l
