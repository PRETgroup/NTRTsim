...
void StringsConnSynapse224Run(StringsConnSynapse224* me) {
    ...
    enum StringsConnSynapse224States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE224_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE224_L: // Intra-location logic for state l
