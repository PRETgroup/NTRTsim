...
void StringsConnSynapse358Run(StringsConnSynapse358* me) {
    ...
    enum StringsConnSynapse358States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE358_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE358_L: // Intra-location logic for state l
