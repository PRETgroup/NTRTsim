...
void StringsConnSynapse325Run(StringsConnSynapse325* me) {
    ...
    enum StringsConnSynapse325States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE325_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE325_L: // Intra-location logic for state l
