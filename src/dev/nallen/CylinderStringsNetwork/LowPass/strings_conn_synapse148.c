...
void StringsConnSynapse148Run(StringsConnSynapse148* me) {
    ...
    enum StringsConnSynapse148States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE148_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE148_L: // Intra-location logic for state l
