...
void StringsConnSynapse388Run(StringsConnSynapse388* me) {
    ...
    enum StringsConnSynapse388States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE388_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE388_L: // Intra-location logic for state l
