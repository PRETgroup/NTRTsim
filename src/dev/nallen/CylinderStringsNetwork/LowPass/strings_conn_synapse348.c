...
void StringsConnSynapse348Run(StringsConnSynapse348* me) {
    ...
    enum StringsConnSynapse348States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE348_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE348_L: // Intra-location logic for state l
