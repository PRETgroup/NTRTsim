...
void StringsConnSynapse395Run(StringsConnSynapse395* me) {
    ...
    enum StringsConnSynapse395States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE395_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE395_L: // Intra-location logic for state l
