...
void StringsConnSynapse73Run(StringsConnSynapse73* me) {
    ...
    enum StringsConnSynapse73States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE73_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE73_L: // Intra-location logic for state l
