...
void StringsConnSynapse187Run(StringsConnSynapse187* me) {
    ...
    enum StringsConnSynapse187States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE187_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE187_L: // Intra-location logic for state l
