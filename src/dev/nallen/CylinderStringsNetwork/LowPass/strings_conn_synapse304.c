...
void StringsConnSynapse304Run(StringsConnSynapse304* me) {
    ...
    enum StringsConnSynapse304States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE304_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE304_L: // Intra-location logic for state l
