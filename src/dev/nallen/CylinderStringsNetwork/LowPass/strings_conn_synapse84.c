...
void StringsConnSynapse84Run(StringsConnSynapse84* me) {
    ...
    enum StringsConnSynapse84States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE84_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE84_L: // Intra-location logic for state l
