...
void StringsConnSynapse118Run(StringsConnSynapse118* me) {
    ...
    enum StringsConnSynapse118States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE118_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE118_L: // Intra-location logic for state l
