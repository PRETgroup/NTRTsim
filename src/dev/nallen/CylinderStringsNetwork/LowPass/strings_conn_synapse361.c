...
void StringsConnSynapse361Run(StringsConnSynapse361* me) {
    ...
    enum StringsConnSynapse361States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE361_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE361_L: // Intra-location logic for state l
