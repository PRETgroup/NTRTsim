...
void StringsConnSynapse97Run(StringsConnSynapse97* me) {
    ...
    enum StringsConnSynapse97States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE97_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE97_L: // Intra-location logic for state l
