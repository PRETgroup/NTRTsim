...
void StringsConnSynapse29Run(StringsConnSynapse29* me) {
    ...
    enum StringsConnSynapse29States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE29_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE29_L: // Intra-location logic for state l
