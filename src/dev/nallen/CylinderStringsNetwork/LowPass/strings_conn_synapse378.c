...
void StringsConnSynapse378Run(StringsConnSynapse378* me) {
    ...
    enum StringsConnSynapse378States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE378_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE378_L: // Intra-location logic for state l
