...
void StringsConnSynapse193Run(StringsConnSynapse193* me) {
    ...
    enum StringsConnSynapse193States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE193_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE193_L: // Intra-location logic for state l
