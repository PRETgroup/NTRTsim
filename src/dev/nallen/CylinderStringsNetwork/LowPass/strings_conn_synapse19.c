...
void StringsConnSynapse19Run(StringsConnSynapse19* me) {
    ...
    enum StringsConnSynapse19States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE19_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE19_L: // Intra-location logic for state l
