...
void StringsConnSynapse370Run(StringsConnSynapse370* me) {
    ...
    enum StringsConnSynapse370States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE370_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE370_L: // Intra-location logic for state l
