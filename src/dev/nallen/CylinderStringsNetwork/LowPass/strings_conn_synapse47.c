...
void StringsConnSynapse47Run(StringsConnSynapse47* me) {
    ...
    enum StringsConnSynapse47States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE47_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE47_L: // Intra-location logic for state l
