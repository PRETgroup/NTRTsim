...
void StringsConnSynapse160Run(StringsConnSynapse160* me) {
    ...
    enum StringsConnSynapse160States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE160_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE160_L: // Intra-location logic for state l
