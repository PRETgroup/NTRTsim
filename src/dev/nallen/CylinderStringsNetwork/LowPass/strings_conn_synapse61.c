...
void StringsConnSynapse61Run(StringsConnSynapse61* me) {
    ...
    enum StringsConnSynapse61States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE61_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE61_L: // Intra-location logic for state l
