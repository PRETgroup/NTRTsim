...
void StringsConnSynapse191Run(StringsConnSynapse191* me) {
    ...
    enum StringsConnSynapse191States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE191_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE191_L: // Intra-location logic for state l
