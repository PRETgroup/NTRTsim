...
void StringsConnSynapse13Run(StringsConnSynapse13* me) {
    ...
    enum StringsConnSynapse13States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE13_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE13_L: // Intra-location logic for state l
