...
void StringsConnSynapse242Run(StringsConnSynapse242* me) {
    ...
    enum StringsConnSynapse242States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE242_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE242_L: // Intra-location logic for state l
