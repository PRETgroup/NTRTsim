...
void StringsConnSynapse145Run(StringsConnSynapse145* me) {
    ...
    enum StringsConnSynapse145States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE145_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE145_L: // Intra-location logic for state l
