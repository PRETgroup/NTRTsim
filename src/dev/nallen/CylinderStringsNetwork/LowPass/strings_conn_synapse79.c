...
void StringsConnSynapse79Run(StringsConnSynapse79* me) {
    ...
    enum StringsConnSynapse79States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE79_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE79_L: // Intra-location logic for state l
