...
void StringsConnSynapse352Run(StringsConnSynapse352* me) {
    ...
    enum StringsConnSynapse352States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE352_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE352_L: // Intra-location logic for state l
