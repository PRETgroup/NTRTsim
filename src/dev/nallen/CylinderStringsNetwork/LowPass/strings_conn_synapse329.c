...
void StringsConnSynapse329Run(StringsConnSynapse329* me) {
    ...
    enum StringsConnSynapse329States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE329_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE329_L: // Intra-location logic for state l
