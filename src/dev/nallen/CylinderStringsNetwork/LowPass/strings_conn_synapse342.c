...
void StringsConnSynapse342Run(StringsConnSynapse342* me) {
    ...
    enum StringsConnSynapse342States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE342_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE342_L: // Intra-location logic for state l
