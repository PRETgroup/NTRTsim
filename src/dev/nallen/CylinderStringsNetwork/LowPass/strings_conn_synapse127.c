...
void StringsConnSynapse127Run(StringsConnSynapse127* me) {
    ...
    enum StringsConnSynapse127States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE127_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE127_L: // Intra-location logic for state l
