...
void StringsConnSynapse278Run(StringsConnSynapse278* me) {
    ...
    enum StringsConnSynapse278States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE278_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE278_L: // Intra-location logic for state l
