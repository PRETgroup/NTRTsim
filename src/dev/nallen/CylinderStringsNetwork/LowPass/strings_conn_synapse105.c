...
void StringsConnSynapse105Run(StringsConnSynapse105* me) {
    ...
    enum StringsConnSynapse105States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE105_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE105_L: // Intra-location logic for state l
