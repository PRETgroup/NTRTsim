...
void StringsConnSynapse12Run(StringsConnSynapse12* me) {
    ...
    enum StringsConnSynapse12States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE12_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE12_L: // Intra-location logic for state l
