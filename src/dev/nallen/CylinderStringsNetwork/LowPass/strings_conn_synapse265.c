...
void StringsConnSynapse265Run(StringsConnSynapse265* me) {
    ...
    enum StringsConnSynapse265States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE265_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE265_L: // Intra-location logic for state l
