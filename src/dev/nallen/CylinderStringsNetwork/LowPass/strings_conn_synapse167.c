...
void StringsConnSynapse167Run(StringsConnSynapse167* me) {
    ...
    enum StringsConnSynapse167States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE167_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE167_L: // Intra-location logic for state l
