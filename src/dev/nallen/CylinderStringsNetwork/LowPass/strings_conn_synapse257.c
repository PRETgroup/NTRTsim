...
void StringsConnSynapse257Run(StringsConnSynapse257* me) {
    ...
    enum StringsConnSynapse257States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE257_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE257_L: // Intra-location logic for state l
