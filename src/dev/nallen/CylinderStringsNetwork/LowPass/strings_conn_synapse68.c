...
void StringsConnSynapse68Run(StringsConnSynapse68* me) {
    ...
    enum StringsConnSynapse68States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE68_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE68_L: // Intra-location logic for state l
