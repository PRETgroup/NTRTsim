...
void StringsConnSynapse276Run(StringsConnSynapse276* me) {
    ...
    enum StringsConnSynapse276States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE276_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE276_L: // Intra-location logic for state l
