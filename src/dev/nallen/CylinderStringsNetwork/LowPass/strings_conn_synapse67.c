...
void StringsConnSynapse67Run(StringsConnSynapse67* me) {
    ...
    enum StringsConnSynapse67States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE67_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE67_L: // Intra-location logic for state l
