...
void StringsConnSynapse101Run(StringsConnSynapse101* me) {
    ...
    enum StringsConnSynapse101States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE101_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE101_L: // Intra-location logic for state l
