...
void StringsConnSynapse190Run(StringsConnSynapse190* me) {
    ...
    enum StringsConnSynapse190States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE190_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE190_L: // Intra-location logic for state l
