...
void StringsConnSynapse220Run(StringsConnSynapse220* me) {
    ...
    enum StringsConnSynapse220States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE220_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE220_L: // Intra-location logic for state l
