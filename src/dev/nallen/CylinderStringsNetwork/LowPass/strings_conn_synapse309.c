...
void StringsConnSynapse309Run(StringsConnSynapse309* me) {
    ...
    enum StringsConnSynapse309States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE309_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE309_L: // Intra-location logic for state l
