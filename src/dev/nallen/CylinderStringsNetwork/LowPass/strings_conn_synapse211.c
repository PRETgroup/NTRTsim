...
void StringsConnSynapse211Run(StringsConnSynapse211* me) {
    ...
    enum StringsConnSynapse211States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE211_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE211_L: // Intra-location logic for state l
