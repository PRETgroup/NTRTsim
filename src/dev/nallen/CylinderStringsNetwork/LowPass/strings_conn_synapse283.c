...
void StringsConnSynapse283Run(StringsConnSynapse283* me) {
    ...
    enum StringsConnSynapse283States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE283_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE283_L: // Intra-location logic for state l
