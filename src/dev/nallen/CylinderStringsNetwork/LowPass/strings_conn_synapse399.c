...
void StringsConnSynapse399Run(StringsConnSynapse399* me) {
    ...
    enum StringsConnSynapse399States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE399_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE399_L: // Intra-location logic for state l
