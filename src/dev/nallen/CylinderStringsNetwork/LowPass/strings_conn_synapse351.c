...
void StringsConnSynapse351Run(StringsConnSynapse351* me) {
    ...
    enum StringsConnSynapse351States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE351_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE351_L: // Intra-location logic for state l
