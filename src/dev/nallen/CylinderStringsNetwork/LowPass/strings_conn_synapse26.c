...
void StringsConnSynapse26Run(StringsConnSynapse26* me) {
    ...
    enum StringsConnSynapse26States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE26_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE26_L: // Intra-location logic for state l
