...
void StringsConnSynapse156Run(StringsConnSynapse156* me) {
    ...
    enum StringsConnSynapse156States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE156_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE156_L: // Intra-location logic for state l
