...
void StringsConnSynapse159Run(StringsConnSynapse159* me) {
    ...
    enum StringsConnSynapse159States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE159_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE159_L: // Intra-location logic for state l
