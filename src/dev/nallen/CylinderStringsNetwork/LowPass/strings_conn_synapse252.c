...
void StringsConnSynapse252Run(StringsConnSynapse252* me) {
    ...
    enum StringsConnSynapse252States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE252_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE252_L: // Intra-location logic for state l
