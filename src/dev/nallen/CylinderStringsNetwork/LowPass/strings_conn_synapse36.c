...
void StringsConnSynapse36Run(StringsConnSynapse36* me) {
    ...
    enum StringsConnSynapse36States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE36_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE36_L: // Intra-location logic for state l
