...
void StringsConnSynapse356Run(StringsConnSynapse356* me) {
    ...
    enum StringsConnSynapse356States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE356_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE356_L: // Intra-location logic for state l
