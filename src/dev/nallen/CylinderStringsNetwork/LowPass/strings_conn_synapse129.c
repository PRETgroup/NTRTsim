...
void StringsConnSynapse129Run(StringsConnSynapse129* me) {
    ...
    enum StringsConnSynapse129States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE129_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE129_L: // Intra-location logic for state l
