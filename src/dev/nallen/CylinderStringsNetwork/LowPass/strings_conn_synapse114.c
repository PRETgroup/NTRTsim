...
void StringsConnSynapse114Run(StringsConnSynapse114* me) {
    ...
    enum StringsConnSynapse114States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE114_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE114_L: // Intra-location logic for state l
