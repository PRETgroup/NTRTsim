...
void StringsConnSynapse124Run(StringsConnSynapse124* me) {
    ...
    enum StringsConnSynapse124States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE124_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE124_L: // Intra-location logic for state l
