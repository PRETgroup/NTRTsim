...
void StringsConnSynapse259Run(StringsConnSynapse259* me) {
    ...
    enum StringsConnSynapse259States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE259_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE259_L: // Intra-location logic for state l
