...
void StringsConnSynapse138Run(StringsConnSynapse138* me) {
    ...
    enum StringsConnSynapse138States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE138_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE138_L: // Intra-location logic for state l
