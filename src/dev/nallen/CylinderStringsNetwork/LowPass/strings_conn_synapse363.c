...
void StringsConnSynapse363Run(StringsConnSynapse363* me) {
    ...
    enum StringsConnSynapse363States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE363_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE363_L: // Intra-location logic for state l
