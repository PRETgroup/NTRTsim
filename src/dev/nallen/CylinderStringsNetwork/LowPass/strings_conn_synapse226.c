...
void StringsConnSynapse226Run(StringsConnSynapse226* me) {
    ...
    enum StringsConnSynapse226States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE226_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE226_L: // Intra-location logic for state l
