...
void StringsConnSynapse62Run(StringsConnSynapse62* me) {
    ...
    enum StringsConnSynapse62States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE62_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE62_L: // Intra-location logic for state l
