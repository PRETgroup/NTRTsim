...
void StringsConnSynapse247Run(StringsConnSynapse247* me) {
    ...
    enum StringsConnSynapse247States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE247_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE247_L: // Intra-location logic for state l
