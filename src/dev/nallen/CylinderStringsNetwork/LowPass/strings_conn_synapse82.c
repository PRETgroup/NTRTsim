...
void StringsConnSynapse82Run(StringsConnSynapse82* me) {
    ...
    enum StringsConnSynapse82States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE82_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE82_L: // Intra-location logic for state l
