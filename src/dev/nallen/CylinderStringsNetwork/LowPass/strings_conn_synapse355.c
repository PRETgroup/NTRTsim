...
void StringsConnSynapse355Run(StringsConnSynapse355* me) {
    ...
    enum StringsConnSynapse355States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE355_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE355_L: // Intra-location logic for state l
