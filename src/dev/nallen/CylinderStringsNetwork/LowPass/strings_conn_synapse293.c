...
void StringsConnSynapse293Run(StringsConnSynapse293* me) {
    ...
    enum StringsConnSynapse293States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE293_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE293_L: // Intra-location logic for state l
