...
void StringsConnSynapse54Run(StringsConnSynapse54* me) {
    ...
    enum StringsConnSynapse54States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE54_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE54_L: // Intra-location logic for state l
