...
void StringsConnSynapse286Run(StringsConnSynapse286* me) {
    ...
    enum StringsConnSynapse286States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE286_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE286_L: // Intra-location logic for state l
