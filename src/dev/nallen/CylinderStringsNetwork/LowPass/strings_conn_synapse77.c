...
void StringsConnSynapse77Run(StringsConnSynapse77* me) {
    ...
    enum StringsConnSynapse77States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE77_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE77_L: // Intra-location logic for state l
