...
void StringsConnSynapse51Run(StringsConnSynapse51* me) {
    ...
    enum StringsConnSynapse51States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE51_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE51_L: // Intra-location logic for state l
