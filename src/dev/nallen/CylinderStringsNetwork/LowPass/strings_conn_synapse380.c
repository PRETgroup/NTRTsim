...
void StringsConnSynapse380Run(StringsConnSynapse380* me) {
    ...
    enum StringsConnSynapse380States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE380_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE380_L: // Intra-location logic for state l
