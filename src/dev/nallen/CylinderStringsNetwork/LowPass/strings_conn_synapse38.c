...
void StringsConnSynapse38Run(StringsConnSynapse38* me) {
    ...
    enum StringsConnSynapse38States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE38_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE38_L: // Intra-location logic for state l
