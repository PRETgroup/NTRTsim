...
void StringsConnSynapse157Run(StringsConnSynapse157* me) {
    ...
    enum StringsConnSynapse157States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE157_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE157_L: // Intra-location logic for state l
