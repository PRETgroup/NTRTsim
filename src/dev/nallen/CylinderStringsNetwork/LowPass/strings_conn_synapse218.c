...
void StringsConnSynapse218Run(StringsConnSynapse218* me) {
    ...
    enum StringsConnSynapse218States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE218_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE218_L: // Intra-location logic for state l
