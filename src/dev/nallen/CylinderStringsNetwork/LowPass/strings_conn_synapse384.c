...
void StringsConnSynapse384Run(StringsConnSynapse384* me) {
    ...
    enum StringsConnSynapse384States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE384_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE384_L: // Intra-location logic for state l
