...
void StringsConnSynapse175Run(StringsConnSynapse175* me) {
    ...
    enum StringsConnSynapse175States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE175_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE175_L: // Intra-location logic for state l
