...
void StringsConnSynapse91Run(StringsConnSynapse91* me) {
    ...
    enum StringsConnSynapse91States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE91_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE91_L: // Intra-location logic for state l
