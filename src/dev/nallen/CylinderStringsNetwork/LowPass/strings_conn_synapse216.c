...
void StringsConnSynapse216Run(StringsConnSynapse216* me) {
    ...
    enum StringsConnSynapse216States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE216_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE216_L: // Intra-location logic for state l
