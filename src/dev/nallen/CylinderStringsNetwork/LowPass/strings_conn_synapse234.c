...
void StringsConnSynapse234Run(StringsConnSynapse234* me) {
    ...
    enum StringsConnSynapse234States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE234_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE234_L: // Intra-location logic for state l
