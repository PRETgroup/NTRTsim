...
void StringsConnSynapse308Run(StringsConnSynapse308* me) {
    ...
    enum StringsConnSynapse308States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE308_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE308_L: // Intra-location logic for state l
