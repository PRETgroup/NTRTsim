...
void StringsConnSynapse299Run(StringsConnSynapse299* me) {
    ...
    enum StringsConnSynapse299States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE299_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE299_L: // Intra-location logic for state l
