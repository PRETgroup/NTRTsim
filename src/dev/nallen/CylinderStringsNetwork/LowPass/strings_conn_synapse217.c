...
void StringsConnSynapse217Run(StringsConnSynapse217* me) {
    ...
    enum StringsConnSynapse217States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE217_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE217_L: // Intra-location logic for state l
