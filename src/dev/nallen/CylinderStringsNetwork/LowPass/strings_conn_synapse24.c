...
void StringsConnSynapse24Run(StringsConnSynapse24* me) {
    ...
    enum StringsConnSynapse24States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE24_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE24_L: // Intra-location logic for state l
