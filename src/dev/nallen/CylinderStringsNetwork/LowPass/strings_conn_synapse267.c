...
void StringsConnSynapse267Run(StringsConnSynapse267* me) {
    ...
    enum StringsConnSynapse267States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE267_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE267_L: // Intra-location logic for state l
