...
void StringsConnSynapse372Run(StringsConnSynapse372* me) {
    ...
    enum StringsConnSynapse372States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE372_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE372_L: // Intra-location logic for state l
