...
void StringsConnSynapse25Run(StringsConnSynapse25* me) {
    ...
    enum StringsConnSynapse25States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE25_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE25_L: // Intra-location logic for state l
