...
void StringsConnSynapse28Run(StringsConnSynapse28* me) {
    ...
    enum StringsConnSynapse28States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE28_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE28_L: // Intra-location logic for state l
