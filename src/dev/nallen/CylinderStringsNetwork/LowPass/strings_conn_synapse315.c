...
void StringsConnSynapse315Run(StringsConnSynapse315* me) {
    ...
    enum StringsConnSynapse315States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE315_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE315_L: // Intra-location logic for state l
