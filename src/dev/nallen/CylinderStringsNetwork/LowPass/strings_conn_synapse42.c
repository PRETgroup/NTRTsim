...
void StringsConnSynapse42Run(StringsConnSynapse42* me) {
    ...
    enum StringsConnSynapse42States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE42_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE42_L: // Intra-location logic for state l
