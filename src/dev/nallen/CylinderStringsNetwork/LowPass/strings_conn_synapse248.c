...
void StringsConnSynapse248Run(StringsConnSynapse248* me) {
    ...
    enum StringsConnSynapse248States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE248_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE248_L: // Intra-location logic for state l
