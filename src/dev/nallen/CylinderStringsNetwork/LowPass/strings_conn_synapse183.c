...
void StringsConnSynapse183Run(StringsConnSynapse183* me) {
    ...
    enum StringsConnSynapse183States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE183_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE183_L: // Intra-location logic for state l
