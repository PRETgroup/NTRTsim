...
void StringsConnSynapse0Run(StringsConnSynapse0* me) {
    ...
    enum StringsConnSynapse0States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE0_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE0_L: // Intra-location logic for state l
