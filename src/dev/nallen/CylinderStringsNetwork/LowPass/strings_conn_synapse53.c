...
void StringsConnSynapse53Run(StringsConnSynapse53* me) {
    ...
    enum StringsConnSynapse53States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE53_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE53_L: // Intra-location logic for state l
