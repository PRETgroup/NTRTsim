...
void StringsConnSynapse333Run(StringsConnSynapse333* me) {
    ...
    enum StringsConnSynapse333States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE333_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE333_L: // Intra-location logic for state l
