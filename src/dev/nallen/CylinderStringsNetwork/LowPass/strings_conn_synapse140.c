...
void StringsConnSynapse140Run(StringsConnSynapse140* me) {
    ...
    enum StringsConnSynapse140States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE140_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE140_L: // Intra-location logic for state l
