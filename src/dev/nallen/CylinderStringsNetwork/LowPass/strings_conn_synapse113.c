...
void StringsConnSynapse113Run(StringsConnSynapse113* me) {
    ...
    enum StringsConnSynapse113States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE113_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE113_L: // Intra-location logic for state l
