...
void StringsConnSynapse269Run(StringsConnSynapse269* me) {
    ...
    enum StringsConnSynapse269States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE269_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE269_L: // Intra-location logic for state l
