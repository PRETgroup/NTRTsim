...
void StringsConnSynapse103Run(StringsConnSynapse103* me) {
    ...
    enum StringsConnSynapse103States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE103_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE103_L: // Intra-location logic for state l
