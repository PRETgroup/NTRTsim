...
void StringsConnSynapse210Run(StringsConnSynapse210* me) {
    ...
    enum StringsConnSynapse210States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE210_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE210_L: // Intra-location logic for state l
