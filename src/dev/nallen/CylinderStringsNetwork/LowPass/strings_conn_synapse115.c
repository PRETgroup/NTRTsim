...
void StringsConnSynapse115Run(StringsConnSynapse115* me) {
    ...
    enum StringsConnSynapse115States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE115_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE115_L: // Intra-location logic for state l
