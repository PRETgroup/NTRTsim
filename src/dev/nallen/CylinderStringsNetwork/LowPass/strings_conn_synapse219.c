...
void StringsConnSynapse219Run(StringsConnSynapse219* me) {
    ...
    enum StringsConnSynapse219States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE219_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE219_L: // Intra-location logic for state l
