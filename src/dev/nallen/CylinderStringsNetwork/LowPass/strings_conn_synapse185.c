...
void StringsConnSynapse185Run(StringsConnSynapse185* me) {
    ...
    enum StringsConnSynapse185States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE185_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE185_L: // Intra-location logic for state l
