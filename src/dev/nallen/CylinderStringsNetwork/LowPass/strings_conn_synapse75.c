...
void StringsConnSynapse75Run(StringsConnSynapse75* me) {
    ...
    enum StringsConnSynapse75States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE75_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE75_L: // Intra-location logic for state l
