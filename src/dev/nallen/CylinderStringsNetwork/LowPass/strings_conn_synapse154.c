...
void StringsConnSynapse154Run(StringsConnSynapse154* me) {
    ...
    enum StringsConnSynapse154States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE154_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE154_L: // Intra-location logic for state l
