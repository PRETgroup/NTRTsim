...
void StringsConnSynapse32Run(StringsConnSynapse32* me) {
    ...
    enum StringsConnSynapse32States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE32_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE32_L: // Intra-location logic for state l
