...
void StringsConnSynapse391Run(StringsConnSynapse391* me) {
    ...
    enum StringsConnSynapse391States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE391_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE391_L: // Intra-location logic for state l
