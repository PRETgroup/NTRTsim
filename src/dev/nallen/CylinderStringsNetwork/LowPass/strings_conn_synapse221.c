...
void StringsConnSynapse221Run(StringsConnSynapse221* me) {
    ...
    enum StringsConnSynapse221States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE221_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE221_L: // Intra-location logic for state l
