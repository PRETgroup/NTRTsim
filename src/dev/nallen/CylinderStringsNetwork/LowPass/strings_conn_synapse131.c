...
void StringsConnSynapse131Run(StringsConnSynapse131* me) {
    ...
    enum StringsConnSynapse131States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE131_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE131_L: // Intra-location logic for state l
