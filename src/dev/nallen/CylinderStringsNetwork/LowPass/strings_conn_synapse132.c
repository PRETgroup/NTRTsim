...
void StringsConnSynapse132Run(StringsConnSynapse132* me) {
    ...
    enum StringsConnSynapse132States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE132_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE132_L: // Intra-location logic for state l
