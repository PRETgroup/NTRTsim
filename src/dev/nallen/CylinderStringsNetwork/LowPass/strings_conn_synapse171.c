...
void StringsConnSynapse171Run(StringsConnSynapse171* me) {
    ...
    enum StringsConnSynapse171States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE171_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE171_L: // Intra-location logic for state l
