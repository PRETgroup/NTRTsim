...
void StringsConnSynapse186Run(StringsConnSynapse186* me) {
    ...
    enum StringsConnSynapse186States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE186_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE186_L: // Intra-location logic for state l
