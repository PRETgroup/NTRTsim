...
void StringsConnSynapse44Run(StringsConnSynapse44* me) {
    ...
    enum StringsConnSynapse44States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE44_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE44_L: // Intra-location logic for state l
