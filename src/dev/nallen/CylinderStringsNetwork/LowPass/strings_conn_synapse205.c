...
void StringsConnSynapse205Run(StringsConnSynapse205* me) {
    ...
    enum StringsConnSynapse205States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE205_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE205_L: // Intra-location logic for state l
