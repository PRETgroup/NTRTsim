...
void StringsConnSynapse376Run(StringsConnSynapse376* me) {
    ...
    enum StringsConnSynapse376States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE376_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE376_L: // Intra-location logic for state l
