...
void StringsConnSynapse96Run(StringsConnSynapse96* me) {
    ...
    enum StringsConnSynapse96States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE96_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE96_L: // Intra-location logic for state l
