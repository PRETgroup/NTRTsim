...
void StringsConnSynapse272Run(StringsConnSynapse272* me) {
    ...
    enum StringsConnSynapse272States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE272_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE272_L: // Intra-location logic for state l
