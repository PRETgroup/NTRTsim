...
void StringsConnSynapse251Run(StringsConnSynapse251* me) {
    ...
    enum StringsConnSynapse251States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE251_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE251_L: // Intra-location logic for state l
