...
void StringsConnSynapse215Run(StringsConnSynapse215* me) {
    ...
    enum StringsConnSynapse215States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE215_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE215_L: // Intra-location logic for state l
