...
void StringsConnSynapse161Run(StringsConnSynapse161* me) {
    ...
    enum StringsConnSynapse161States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE161_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE161_L: // Intra-location logic for state l
