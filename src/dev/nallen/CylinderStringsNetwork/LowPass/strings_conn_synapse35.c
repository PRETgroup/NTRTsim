...
void StringsConnSynapse35Run(StringsConnSynapse35* me) {
    ...
    enum StringsConnSynapse35States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE35_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE35_L: // Intra-location logic for state l
