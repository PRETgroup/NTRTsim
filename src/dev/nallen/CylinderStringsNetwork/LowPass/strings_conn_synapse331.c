...
void StringsConnSynapse331Run(StringsConnSynapse331* me) {
    ...
    enum StringsConnSynapse331States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE331_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE331_L: // Intra-location logic for state l
