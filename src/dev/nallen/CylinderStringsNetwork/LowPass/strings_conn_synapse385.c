...
void StringsConnSynapse385Run(StringsConnSynapse385* me) {
    ...
    enum StringsConnSynapse385States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE385_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE385_L: // Intra-location logic for state l
