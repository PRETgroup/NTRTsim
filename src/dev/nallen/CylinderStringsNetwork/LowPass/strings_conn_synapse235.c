...
void StringsConnSynapse235Run(StringsConnSynapse235* me) {
    ...
    enum StringsConnSynapse235States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE235_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE235_L: // Intra-location logic for state l
