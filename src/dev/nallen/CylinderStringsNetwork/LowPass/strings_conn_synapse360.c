...
void StringsConnSynapse360Run(StringsConnSynapse360* me) {
    ...
    enum StringsConnSynapse360States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE360_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE360_L: // Intra-location logic for state l
