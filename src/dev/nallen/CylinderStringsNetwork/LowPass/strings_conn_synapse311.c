...
void StringsConnSynapse311Run(StringsConnSynapse311* me) {
    ...
    enum StringsConnSynapse311States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE311_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE311_L: // Intra-location logic for state l
