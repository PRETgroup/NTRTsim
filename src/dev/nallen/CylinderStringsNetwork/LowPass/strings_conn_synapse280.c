...
void StringsConnSynapse280Run(StringsConnSynapse280* me) {
    ...
    enum StringsConnSynapse280States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE280_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE280_L: // Intra-location logic for state l
