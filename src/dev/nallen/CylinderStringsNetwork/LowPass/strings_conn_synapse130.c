...
void StringsConnSynapse130Run(StringsConnSynapse130* me) {
    ...
    enum StringsConnSynapse130States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE130_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE130_L: // Intra-location logic for state l
