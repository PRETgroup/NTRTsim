...
void StringsConnSynapse302Run(StringsConnSynapse302* me) {
    ...
    enum StringsConnSynapse302States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE302_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE302_L: // Intra-location logic for state l
