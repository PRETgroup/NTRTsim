...
void StringsConnSynapse70Run(StringsConnSynapse70* me) {
    ...
    enum StringsConnSynapse70States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE70_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE70_L: // Intra-location logic for state l
