...
void StringsConnSynapse335Run(StringsConnSynapse335* me) {
    ...
    enum StringsConnSynapse335States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE335_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE335_L: // Intra-location logic for state l
