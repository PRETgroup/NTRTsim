...
void StringsConnSynapse375Run(StringsConnSynapse375* me) {
    ...
    enum StringsConnSynapse375States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE375_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE375_L: // Intra-location logic for state l
