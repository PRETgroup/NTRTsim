...
void StringsConnSynapse238Run(StringsConnSynapse238* me) {
    ...
    enum StringsConnSynapse238States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE238_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE238_L: // Intra-location logic for state l
