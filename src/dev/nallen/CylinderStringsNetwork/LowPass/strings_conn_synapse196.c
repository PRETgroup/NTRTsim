...
void StringsConnSynapse196Run(StringsConnSynapse196* me) {
    ...
    enum StringsConnSynapse196States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE196_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE196_L: // Intra-location logic for state l
