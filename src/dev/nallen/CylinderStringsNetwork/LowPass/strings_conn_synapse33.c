...
void StringsConnSynapse33Run(StringsConnSynapse33* me) {
    ...
    enum StringsConnSynapse33States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE33_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE33_L: // Intra-location logic for state l
