...
void StringsConnSynapse382Run(StringsConnSynapse382* me) {
    ...
    enum StringsConnSynapse382States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE382_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE382_L: // Intra-location logic for state l
