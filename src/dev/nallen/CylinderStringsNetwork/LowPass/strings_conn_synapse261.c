...
void StringsConnSynapse261Run(StringsConnSynapse261* me) {
    ...
    enum StringsConnSynapse261States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE261_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE261_L: // Intra-location logic for state l
