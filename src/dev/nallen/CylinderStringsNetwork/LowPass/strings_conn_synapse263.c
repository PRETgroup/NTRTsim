...
void StringsConnSynapse263Run(StringsConnSynapse263* me) {
    ...
    enum StringsConnSynapse263States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE263_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE263_L: // Intra-location logic for state l
