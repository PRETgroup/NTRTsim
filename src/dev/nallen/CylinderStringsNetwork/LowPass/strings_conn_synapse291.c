...
void StringsConnSynapse291Run(StringsConnSynapse291* me) {
    ...
    enum StringsConnSynapse291States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE291_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE291_L: // Intra-location logic for state l
