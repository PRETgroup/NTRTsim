...
void StringsConnSynapse282Run(StringsConnSynapse282* me) {
    ...
    enum StringsConnSynapse282States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE282_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE282_L: // Intra-location logic for state l
