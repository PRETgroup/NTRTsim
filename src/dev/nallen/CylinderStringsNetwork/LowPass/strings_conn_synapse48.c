...
void StringsConnSynapse48Run(StringsConnSynapse48* me) {
    ...
    enum StringsConnSynapse48States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE48_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE48_L: // Intra-location logic for state l
