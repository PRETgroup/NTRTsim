...
void StringsConnSynapse390Run(StringsConnSynapse390* me) {
    ...
    enum StringsConnSynapse390States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE390_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE390_L: // Intra-location logic for state l
