...
void StringsConnSynapse23Run(StringsConnSynapse23* me) {
    ...
    enum StringsConnSynapse23States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE23_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE23_L: // Intra-location logic for state l
