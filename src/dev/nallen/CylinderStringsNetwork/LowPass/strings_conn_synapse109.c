...
void StringsConnSynapse109Run(StringsConnSynapse109* me) {
    ...
    enum StringsConnSynapse109States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE109_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE109_L: // Intra-location logic for state l
