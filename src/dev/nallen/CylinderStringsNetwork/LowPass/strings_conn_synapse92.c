...
void StringsConnSynapse92Run(StringsConnSynapse92* me) {
    ...
    enum StringsConnSynapse92States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE92_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE92_L: // Intra-location logic for state l
