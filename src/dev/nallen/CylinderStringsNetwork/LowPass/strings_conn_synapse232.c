...
void StringsConnSynapse232Run(StringsConnSynapse232* me) {
    ...
    enum StringsConnSynapse232States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE232_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE232_L: // Intra-location logic for state l
