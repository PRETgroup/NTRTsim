...
void StringsConnSynapse182Run(StringsConnSynapse182* me) {
    ...
    enum StringsConnSynapse182States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE182_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE182_L: // Intra-location logic for state l
