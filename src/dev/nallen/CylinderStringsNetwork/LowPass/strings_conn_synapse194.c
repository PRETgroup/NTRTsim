...
void StringsConnSynapse194Run(StringsConnSynapse194* me) {
    ...
    enum StringsConnSynapse194States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE194_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE194_L: // Intra-location logic for state l
