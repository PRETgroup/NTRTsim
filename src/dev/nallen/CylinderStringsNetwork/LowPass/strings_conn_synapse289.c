...
void StringsConnSynapse289Run(StringsConnSynapse289* me) {
    ...
    enum StringsConnSynapse289States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE289_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE289_L: // Intra-location logic for state l
