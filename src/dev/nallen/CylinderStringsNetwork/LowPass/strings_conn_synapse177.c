...
void StringsConnSynapse177Run(StringsConnSynapse177* me) {
    ...
    enum StringsConnSynapse177States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE177_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE177_L: // Intra-location logic for state l
