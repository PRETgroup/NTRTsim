...
void StringsConnSynapse396Run(StringsConnSynapse396* me) {
    ...
    enum StringsConnSynapse396States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE396_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE396_L: // Intra-location logic for state l
