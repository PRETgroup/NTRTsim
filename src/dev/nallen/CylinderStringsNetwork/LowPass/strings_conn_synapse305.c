...
void StringsConnSynapse305Run(StringsConnSynapse305* me) {
    ...
    enum StringsConnSynapse305States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE305_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE305_L: // Intra-location logic for state l
