...
void StringsConnSynapse2Run(StringsConnSynapse2* me) {
    ...
    enum StringsConnSynapse2States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE2_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE2_L: // Intra-location logic for state l
