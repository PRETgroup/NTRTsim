...
void StringsConnSynapse377Run(StringsConnSynapse377* me) {
    ...
    enum StringsConnSynapse377States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE377_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE377_L: // Intra-location logic for state l
