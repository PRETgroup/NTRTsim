...
void StringsConnSynapse16Run(StringsConnSynapse16* me) {
    ...
    enum StringsConnSynapse16States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE16_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE16_L: // Intra-location logic for state l
