...
void StringsConnSynapse303Run(StringsConnSynapse303* me) {
    ...
    enum StringsConnSynapse303States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE303_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE303_L: // Intra-location logic for state l
