...
void StringsConnSynapse394Run(StringsConnSynapse394* me) {
    ...
    enum StringsConnSynapse394States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE394_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE394_L: // Intra-location logic for state l
