...
void StringsConnSynapse89Run(StringsConnSynapse89* me) {
    ...
    enum StringsConnSynapse89States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE89_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE89_L: // Intra-location logic for state l
