...
void StringsConnSynapse104Run(StringsConnSynapse104* me) {
    ...
    enum StringsConnSynapse104States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE104_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE104_L: // Intra-location logic for state l
