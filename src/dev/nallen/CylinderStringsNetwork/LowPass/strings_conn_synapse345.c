...
void StringsConnSynapse345Run(StringsConnSynapse345* me) {
    ...
    enum StringsConnSynapse345States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE345_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE345_L: // Intra-location logic for state l
