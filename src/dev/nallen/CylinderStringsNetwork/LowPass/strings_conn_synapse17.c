...
void StringsConnSynapse17Run(StringsConnSynapse17* me) {
    ...
    enum StringsConnSynapse17States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE17_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE17_L: // Intra-location logic for state l
