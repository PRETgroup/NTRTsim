...
void StringsConnSynapse3Run(StringsConnSynapse3* me) {
    ...
    enum StringsConnSynapse3States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE3_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE3_L: // Intra-location logic for state l
