...
void StringsConnSynapse137Run(StringsConnSynapse137* me) {
    ...
    enum StringsConnSynapse137States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE137_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE137_L: // Intra-location logic for state l
