...
void StringsConnSynapse7Run(StringsConnSynapse7* me) {
    ...
    enum StringsConnSynapse7States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE7_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE7_L: // Intra-location logic for state l
