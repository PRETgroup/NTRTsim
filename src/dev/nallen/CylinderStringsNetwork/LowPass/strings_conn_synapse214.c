...
void StringsConnSynapse214Run(StringsConnSynapse214* me) {
    ...
    enum StringsConnSynapse214States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE214_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE214_L: // Intra-location logic for state l
