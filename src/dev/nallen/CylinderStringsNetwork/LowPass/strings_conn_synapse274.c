...
void StringsConnSynapse274Run(StringsConnSynapse274* me) {
    ...
    enum StringsConnSynapse274States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE274_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE274_L: // Intra-location logic for state l
