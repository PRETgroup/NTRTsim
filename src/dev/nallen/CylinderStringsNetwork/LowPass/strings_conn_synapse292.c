...
void StringsConnSynapse292Run(StringsConnSynapse292* me) {
    ...
    enum StringsConnSynapse292States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE292_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE292_L: // Intra-location logic for state l
