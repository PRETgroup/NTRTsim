...
void StringsConnSynapse100Run(StringsConnSynapse100* me) {
    ...
    enum StringsConnSynapse100States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE100_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE100_L: // Intra-location logic for state l
