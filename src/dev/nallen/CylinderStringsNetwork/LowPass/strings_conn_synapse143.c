...
void StringsConnSynapse143Run(StringsConnSynapse143* me) {
    ...
    enum StringsConnSynapse143States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE143_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE143_L: // Intra-location logic for state l
