...
void StringsConnSynapse339Run(StringsConnSynapse339* me) {
    ...
    enum StringsConnSynapse339States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE339_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE339_L: // Intra-location logic for state l
