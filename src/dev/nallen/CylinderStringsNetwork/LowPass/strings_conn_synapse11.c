...
void StringsConnSynapse11Run(StringsConnSynapse11* me) {
    ...
    enum StringsConnSynapse11States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE11_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE11_L: // Intra-location logic for state l
