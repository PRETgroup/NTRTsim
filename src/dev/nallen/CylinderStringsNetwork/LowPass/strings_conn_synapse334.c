...
void StringsConnSynapse334Run(StringsConnSynapse334* me) {
    ...
    enum StringsConnSynapse334States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE334_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE334_L: // Intra-location logic for state l
