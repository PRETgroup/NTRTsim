...
void StringsConnSynapse106Run(StringsConnSynapse106* me) {
    ...
    enum StringsConnSynapse106States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE106_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE106_L: // Intra-location logic for state l
