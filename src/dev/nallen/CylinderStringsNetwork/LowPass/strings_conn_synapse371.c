...
void StringsConnSynapse371Run(StringsConnSynapse371* me) {
    ...
    enum StringsConnSynapse371States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE371_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE371_L: // Intra-location logic for state l
