...
void StringsConnSynapse362Run(StringsConnSynapse362* me) {
    ...
    enum StringsConnSynapse362States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE362_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE362_L: // Intra-location logic for state l
