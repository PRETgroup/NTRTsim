...
void StringsConnSynapse258Run(StringsConnSynapse258* me) {
    ...
    enum StringsConnSynapse258States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE258_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE258_L: // Intra-location logic for state l
