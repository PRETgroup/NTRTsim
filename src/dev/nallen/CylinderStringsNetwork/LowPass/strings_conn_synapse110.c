...
void StringsConnSynapse110Run(StringsConnSynapse110* me) {
    ...
    enum StringsConnSynapse110States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE110_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE110_L: // Intra-location logic for state l
