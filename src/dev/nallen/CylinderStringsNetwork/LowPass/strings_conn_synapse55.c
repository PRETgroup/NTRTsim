...
void StringsConnSynapse55Run(StringsConnSynapse55* me) {
    ...
    enum StringsConnSynapse55States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE55_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE55_L: // Intra-location logic for state l
