...
void StringsConnSynapse273Run(StringsConnSynapse273* me) {
    ...
    enum StringsConnSynapse273States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE273_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE273_L: // Intra-location logic for state l
