...
void StringsConnSynapse14Run(StringsConnSynapse14* me) {
    ...
    enum StringsConnSynapse14States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE14_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE14_L: // Intra-location logic for state l
