...
void StringsConnSynapse123Run(StringsConnSynapse123* me) {
    ...
    enum StringsConnSynapse123States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE123_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE123_L: // Intra-location logic for state l
