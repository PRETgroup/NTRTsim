...
void StringsConnSynapse295Run(StringsConnSynapse295* me) {
    ...
    enum StringsConnSynapse295States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE295_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE295_L: // Intra-location logic for state l
