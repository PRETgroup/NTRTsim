...
void StringsConnSynapse365Run(StringsConnSynapse365* me) {
    ...
    enum StringsConnSynapse365States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE365_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE365_L: // Intra-location logic for state l
