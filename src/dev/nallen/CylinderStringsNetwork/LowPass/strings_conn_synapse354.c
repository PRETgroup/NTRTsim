...
void StringsConnSynapse354Run(StringsConnSynapse354* me) {
    ...
    enum StringsConnSynapse354States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE354_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE354_L: // Intra-location logic for state l
