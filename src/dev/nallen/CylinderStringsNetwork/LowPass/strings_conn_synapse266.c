...
void StringsConnSynapse266Run(StringsConnSynapse266* me) {
    ...
    enum StringsConnSynapse266States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE266_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE266_L: // Intra-location logic for state l
