...
void StringsConnSynapse98Run(StringsConnSynapse98* me) {
    ...
    enum StringsConnSynapse98States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE98_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE98_L: // Intra-location logic for state l
