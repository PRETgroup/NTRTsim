...
void StringsConnSynapse94Run(StringsConnSynapse94* me) {
    ...
    enum StringsConnSynapse94States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE94_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE94_L: // Intra-location logic for state l
