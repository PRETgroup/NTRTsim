...
void StringsConnSynapse172Run(StringsConnSynapse172* me) {
    ...
    enum StringsConnSynapse172States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE172_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE172_L: // Intra-location logic for state l
