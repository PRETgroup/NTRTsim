...
void StringsConnSynapse317Run(StringsConnSynapse317* me) {
    ...
    enum StringsConnSynapse317States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE317_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE317_L: // Intra-location logic for state l
