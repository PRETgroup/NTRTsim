...
void StringsConnSynapse290Run(StringsConnSynapse290* me) {
    ...
    enum StringsConnSynapse290States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE290_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE290_L: // Intra-location logic for state l
