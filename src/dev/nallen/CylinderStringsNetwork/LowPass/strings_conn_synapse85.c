...
void StringsConnSynapse85Run(StringsConnSynapse85* me) {
    ...
    enum StringsConnSynapse85States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE85_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE85_L: // Intra-location logic for state l
