...
void StringsConnSynapse189Run(StringsConnSynapse189* me) {
    ...
    enum StringsConnSynapse189States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE189_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE189_L: // Intra-location logic for state l
