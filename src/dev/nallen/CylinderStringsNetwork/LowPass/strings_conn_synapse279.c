...
void StringsConnSynapse279Run(StringsConnSynapse279* me) {
    ...
    enum StringsConnSynapse279States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE279_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE279_L: // Intra-location logic for state l
