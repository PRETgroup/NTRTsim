...
void StringsConnSynapse200Run(StringsConnSynapse200* me) {
    ...
    enum StringsConnSynapse200States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE200_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE200_L: // Intra-location logic for state l
