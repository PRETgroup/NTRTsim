...
void StringsConnSynapse201Run(StringsConnSynapse201* me) {
    ...
    enum StringsConnSynapse201States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE201_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE201_L: // Intra-location logic for state l
