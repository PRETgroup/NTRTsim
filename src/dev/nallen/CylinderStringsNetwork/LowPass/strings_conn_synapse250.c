...
void StringsConnSynapse250Run(StringsConnSynapse250* me) {
    ...
    enum StringsConnSynapse250States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE250_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE250_L: // Intra-location logic for state l
