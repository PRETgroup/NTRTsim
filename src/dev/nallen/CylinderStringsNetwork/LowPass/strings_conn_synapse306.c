...
void StringsConnSynapse306Run(StringsConnSynapse306* me) {
    ...
    enum StringsConnSynapse306States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE306_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE306_L: // Intra-location logic for state l
