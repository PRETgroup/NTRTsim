...
void StringsConnSynapse233Run(StringsConnSynapse233* me) {
    ...
    enum StringsConnSynapse233States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE233_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE233_L: // Intra-location logic for state l
