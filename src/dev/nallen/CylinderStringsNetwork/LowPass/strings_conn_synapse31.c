...
void StringsConnSynapse31Run(StringsConnSynapse31* me) {
    ...
    enum StringsConnSynapse31States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE31_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE31_L: // Intra-location logic for state l
