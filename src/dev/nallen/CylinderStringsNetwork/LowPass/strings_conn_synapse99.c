...
void StringsConnSynapse99Run(StringsConnSynapse99* me) {
    ...
    enum StringsConnSynapse99States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE99_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE99_L: // Intra-location logic for state l
