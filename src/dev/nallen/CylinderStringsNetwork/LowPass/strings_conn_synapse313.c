...
void StringsConnSynapse313Run(StringsConnSynapse313* me) {
    ...
    enum StringsConnSynapse313States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE313_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE313_L: // Intra-location logic for state l
