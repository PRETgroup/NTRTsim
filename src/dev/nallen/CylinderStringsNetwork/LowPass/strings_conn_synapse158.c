...
void StringsConnSynapse158Run(StringsConnSynapse158* me) {
    ...
    enum StringsConnSynapse158States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE158_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE158_L: // Intra-location logic for state l
