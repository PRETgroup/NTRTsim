...
void StringsConnSynapse4Run(StringsConnSynapse4* me) {
    ...
    enum StringsConnSynapse4States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE4_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE4_L: // Intra-location logic for state l
