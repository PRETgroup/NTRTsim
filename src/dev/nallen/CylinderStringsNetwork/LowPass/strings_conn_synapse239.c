...
void StringsConnSynapse239Run(StringsConnSynapse239* me) {
    ...
    enum StringsConnSynapse239States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE239_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE239_L: // Intra-location logic for state l
