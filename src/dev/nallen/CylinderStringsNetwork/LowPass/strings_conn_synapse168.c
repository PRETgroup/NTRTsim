...
void StringsConnSynapse168Run(StringsConnSynapse168* me) {
    ...
    enum StringsConnSynapse168States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE168_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE168_L: // Intra-location logic for state l
