...
void StringsConnSynapse386Run(StringsConnSynapse386* me) {
    ...
    enum StringsConnSynapse386States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE386_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE386_L: // Intra-location logic for state l
