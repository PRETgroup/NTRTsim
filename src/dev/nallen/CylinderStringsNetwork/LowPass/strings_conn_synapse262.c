...
void StringsConnSynapse262Run(StringsConnSynapse262* me) {
    ...
    enum StringsConnSynapse262States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE262_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE262_L: // Intra-location logic for state l
