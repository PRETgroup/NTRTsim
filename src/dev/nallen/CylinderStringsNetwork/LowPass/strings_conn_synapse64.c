...
void StringsConnSynapse64Run(StringsConnSynapse64* me) {
    ...
    enum StringsConnSynapse64States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE64_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE64_L: // Intra-location logic for state l
