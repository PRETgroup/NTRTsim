...
void StringsConnSynapse298Run(StringsConnSynapse298* me) {
    ...
    enum StringsConnSynapse298States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE298_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE298_L: // Intra-location logic for state l
