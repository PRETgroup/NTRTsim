...
void StringsConnSynapse86Run(StringsConnSynapse86* me) {
    ...
    enum StringsConnSynapse86States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE86_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE86_L: // Intra-location logic for state l
