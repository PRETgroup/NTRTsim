...
void StringsConnSynapse15Run(StringsConnSynapse15* me) {
    ...
    enum StringsConnSynapse15States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE15_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE15_L: // Intra-location logic for state l
