...
void StringsConnSynapse184Run(StringsConnSynapse184* me) {
    ...
    enum StringsConnSynapse184States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE184_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE184_L: // Intra-location logic for state l
