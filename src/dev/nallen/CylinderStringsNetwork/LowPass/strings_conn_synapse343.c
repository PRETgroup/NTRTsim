...
void StringsConnSynapse343Run(StringsConnSynapse343* me) {
    ...
    enum StringsConnSynapse343States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE343_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE343_L: // Intra-location logic for state l
