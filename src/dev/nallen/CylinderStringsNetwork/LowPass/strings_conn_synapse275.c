...
void StringsConnSynapse275Run(StringsConnSynapse275* me) {
    ...
    enum StringsConnSynapse275States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE275_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE275_L: // Intra-location logic for state l
