...
void StringsConnSynapse246Run(StringsConnSynapse246* me) {
    ...
    enum StringsConnSynapse246States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE246_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE246_L: // Intra-location logic for state l
