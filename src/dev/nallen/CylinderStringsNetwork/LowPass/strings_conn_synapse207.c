...
void StringsConnSynapse207Run(StringsConnSynapse207* me) {
    ...
    enum StringsConnSynapse207States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE207_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE207_L: // Intra-location logic for state l
