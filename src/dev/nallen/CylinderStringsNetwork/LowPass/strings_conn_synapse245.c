...
void StringsConnSynapse245Run(StringsConnSynapse245* me) {
    ...
    enum StringsConnSynapse245States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE245_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE245_L: // Intra-location logic for state l
