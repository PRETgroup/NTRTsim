...
void StringsConnSynapse6Run(StringsConnSynapse6* me) {
    ...
    enum StringsConnSynapse6States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE6_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE6_L: // Intra-location logic for state l
