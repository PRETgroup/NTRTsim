...
void StringsConnSynapse41Run(StringsConnSynapse41* me) {
    ...
    enum StringsConnSynapse41States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE41_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE41_L: // Intra-location logic for state l
