...
void StringsConnSynapse364Run(StringsConnSynapse364* me) {
    ...
    enum StringsConnSynapse364States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE364_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE364_L: // Intra-location logic for state l
