...
void StringsConnSynapse353Run(StringsConnSynapse353* me) {
    ...
    enum StringsConnSynapse353States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE353_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE353_L: // Intra-location logic for state l
