...
void StringsConnSynapse76Run(StringsConnSynapse76* me) {
    ...
    enum StringsConnSynapse76States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE76_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE76_L: // Intra-location logic for state l
