...
void StringsConnSynapse43Run(StringsConnSynapse43* me) {
    ...
    enum StringsConnSynapse43States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE43_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE43_L: // Intra-location logic for state l
