...
void StringsConnSynapse74Run(StringsConnSynapse74* me) {
    ...
    enum StringsConnSynapse74States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE74_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE74_L: // Intra-location logic for state l
