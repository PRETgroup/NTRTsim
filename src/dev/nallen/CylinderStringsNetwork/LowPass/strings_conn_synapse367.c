...
void StringsConnSynapse367Run(StringsConnSynapse367* me) {
    ...
    enum StringsConnSynapse367States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE367_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE367_L: // Intra-location logic for state l
