...
void StringsConnSynapse284Run(StringsConnSynapse284* me) {
    ...
    enum StringsConnSynapse284States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE284_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE284_L: // Intra-location logic for state l
