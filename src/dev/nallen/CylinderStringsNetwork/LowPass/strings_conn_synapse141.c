...
void StringsConnSynapse141Run(StringsConnSynapse141* me) {
    ...
    enum StringsConnSynapse141States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE141_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE141_L: // Intra-location logic for state l
