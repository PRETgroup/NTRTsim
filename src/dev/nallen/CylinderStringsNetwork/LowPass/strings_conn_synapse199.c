...
void StringsConnSynapse199Run(StringsConnSynapse199* me) {
    ...
    enum StringsConnSynapse199States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE199_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE199_L: // Intra-location logic for state l
