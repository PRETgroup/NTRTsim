...
void StringsConnSynapse222Run(StringsConnSynapse222* me) {
    ...
    enum StringsConnSynapse222States state_u = me->state;
    double out_u = me->out;
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE222_L: // Logic for state l
            break;
    }
    ...
    switch(me->state) {
        case STRINGS_CONN_SYNAPSE222_L: // Intra-location logic for state l
